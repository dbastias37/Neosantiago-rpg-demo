...
**Bocetos A/B antes del bloque 2:** se añaden dos propuestas funcionales aisladas en `labs/encargos-ab/`: A, registro de operaciones con bandas y ficha modal; B, índice de contactos y expediente visible. Comparten tres encargos reales como muestra y los mismos retratos, textos y pagos. Incluyen filtros, rutas, confirmación de prueba y vista móvil. No leen ni escriben partidas. La elección del usuario sigue pendiente; todavía no se integra el bloque 2.
