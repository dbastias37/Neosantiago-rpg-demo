...
var branchDialogueDefs={
  ...
  trackerCredential:{npc:"tracker",kicker:"Control de identidad",start:"start",nodes:{
    ...
    break:{lines:["El lector termina de comparar al grupo, pero no se apaga. Una cuarta firma late dentro del guante de Vega y proyecta su propio rostro bajo un registro de fallecimiento.","Vega corta la transmisión con una mano temblorosa. «Ese pulso es mío. El expediente está debajo del cruce. Si la Red UNO reutilizó mi nombre, necesito saber cuántos más siguen caminando como muertos.»"],options:[
      {label:"Seguir la cuarta firma hasta el registro",hint:"Abre un desvío para descubrir cómo la Red UNO reutiliza las identidades de muertos y exiliados.",fx:{morale:2,threat:2},archive:["names","sonar"],psy:{empathy:1,resolve:1},flags:{vegaFourthSignatureFound:true},routeScene:"vegaDeadNames"},
...
var routeNarrativeDefs={
  ...
  unit7LastOrder:{title:"Desvío de S-7",endLoc:"Archivo Auxiliar Siete",combatResult:"La Red UNO intenta recuperar a S-7 antes de que su orden original vuelva a quedar fuera de control.",defaultChoice:0,scenes:[
    {kicker:"Desvío de ruta · Túnel de servicio",title:"El dron que no se va",image:"narrative/unit7/unit7-01-dron-no-se-va.webp",timeLimit:17000,lines:[
      ...
      "Bajo el chasis, el núcleo cian late con una irregularidad que Elías no reconoce como daño. «La orden actual exige entregar sus firmas. La orden anterior exige protegerlas. Ambas órdenes declaran continuidad». Una compuerta lateral se abre lentamente. S-7 proyecta una ruta hacia una subestación enterrada bajo República. «Solicitud: acompañamiento antes de ser corregida»."
    ],options:[
      {label:"Ocultar a S-7 con la frecuencia de la señal",hint:"Elías disfraza su firma como una transmisión dañada y evita la orden de retorno.",fx:{threat:-3,morale:1},archive:["sonar"],psy:{empathy:1,pragmatism:1},flags:{unit7SignalHidden:true},nextScene:1},
      ...
      {label:"Avanzar antes de la orden de retorno",hint:"La red puede enviar unidades para recuperar al dron desobediente.",cost:"Combate",fx:{morale:1,threat:3},psy:{resolve:1,stress:1},flags:{unit7RouteRushed:true},combat:{title:"Protocolo de recuperación",brief:"Dos firmas mecánicas descienden por el pozo mientras S-7 intenta mantener abierta la compuerta lateral.",encounters:[["drone"],["drone","drone"]],xp:36,canFlee:true},victory:{title:"Unidad no recuperada",result:"El grupo derriba las unidades antes de que transmitan la posición de S-7. El dron observa los cuerpos mecánicos y registra que tres humanos arriesgaron sus vidas para impedir que fuera corregido.",fx:{threat:4,morale:2},archive:["sonar"],flags:{unit7RecoveryCombatWon:true}},nextScene:1}
    ]},
  ...
  unit12InvisibleMap:{title:"Desvío de H-12",endLoc:"Nido de vigilancia",combatResult:"El rastreo aéreo detecta la manipulación y obliga al grupo a sostener la mentira antes de alcanzar el repetidor.",defaultChoice:0,scenes:[
    {kicker:"Desvío de ruta · Alameda hundida",title:"La voz sobre la Alameda",image:"narrative/unit12/unit12-01-voz-alameda.webp",timeLimit:17000,lines:[
      "La firma falsa avanza por la avenida, pero H-12 no se retira. El dron gira sobre los edificios hundidos y vuelve a medir el agua, el calor y las tres respiraciones que intentan desaparecer bajo su barrido.",
      ...
      {label:"Anclar una firma falsa al autobús",hint:"Elías deja un pulso mecánico caminando por ellos mientras el grupo abandona la avenida.",cost:"Electrónica −1",reqItems:["electronics"],fx:{electronics:-1,threat:-4,morale:1},archive:["sonar"],psy:{pragmatism:2},flags:{h12GhostBus:true},nextScene:1},
      ...
      {label:"Obligar a H-12 a descender",hint:"La provocación abre la ruta, pero despierta su escolta mecánica.",cost:"Combate",fx:{threat:4,morale:1},psy:{resolve:1,stress:2},flags:{h12ForcedDescent:true},combat:{title:"El cielo responde",brief:"H-12 sostiene el rastreo sobre la avenida mientras unidades menores bajan para fijar las tres firmas humanas.",encounters:[["drone"],["drone","drone"],["agent3","drone"]],xp:48,canFlee:true},victory:{title:"Una abertura en el barrido",result:"La escolta cae antes de cerrar la avenida. H-12 se repliega hacia el repetidor y deja tras de sí una secuencia que Elías puede seguir.",fx:{threat:5,morale:2},archive:["sonar"],flags:{h12EscortBroken:true}},nextScene:1}
    ]},
    {kicker:"Desvío de ruta · Repetidor aéreo",title:"El archivo de calor",image:"narrative/unit12/unit12-02-archivo-calor.webp",timeLimit:19000,lines:[
      ...
      "No son objetivos militares. Son refugios, cazadores, exiliados y familias clasificadas como inconsistencias civiles. Junto a cada grupo aparece la misma instrucción: visible, útil o corregible. Sara reconoce que borrar una firma puede salvar una vida; copiar el archivo también puede entregar todas las demás."
    ],options:[
      {label:"Copiar las ubicaciones para advertirlos",hint:"Conserva nombres y refugios, pero la descarga deja una firma que la Red UNO puede seguir.",cost:"Amenaza +3",fx:{threat:3,morale:4},archive:["names","sonar"],psy:{empathy:2,resolve:1},flags:{h12CommunitiesCopied:true},nextScene:2},
      {label:"Separar Línea 1 del resto del mapa",hint:"Prepara un borrado preciso para proteger el refugio sin intervenir todavía las otras firmas.",cost:"Moral −2",fx:{threat:-3,morale:-2},archive:["sonar"],psy:{pragmatism:2,empathy:-1},flags:{h12Line1Isolated:true},nextScene:2},
  ...
  vegaDeadNames:{title:"Desvío de Vega",endLoc:"Archivo de Identidad Civil",combatResult:"La Red UNO detecta la cuarta firma y obliga al grupo a defender el acceso antes de alcanzar el registro subterráneo.",defaultChoice:0,scenes:[
    {kicker:"Desvío de ruta · Cruce Dieciocho",title:"La cuarta firma",image:"narrative/vega/vega-01-cuarta-firma.webp",timeLimit:18000,lines:[
      "El lector termina de revisar a Sara, Elías y Noa, pero continúa contando. Una cuarta firma aparece sobre el cruce y nace dentro del guante de Vega. El sistema proyecta su rostro, cruza el expediente con una marca roja y confirma que el rastreador murió oficialmente años atrás.",
      ...
      {label:"Interrumpir la transmisión desde el lector",hint:"Elías quema una placa electrónica para impedir que la cuarta firma llegue a la Red UNO.",cost:"Electrónica −1",reqItems:["electronics"],fx:{electronics:-1,threat:-4,morale:1},archive:["names","sonar"],psy:{pragmatism:2},flags:{vegaSignalJammed:true},nextScene:1},
    ...
    {kicker:"Desvío de ruta · Registro subterráneo",title:"El registro de los cuerpos",image:"narrative/vega/vega-02-registro-cuerpos.webp",timeLimit:20000,lines:[
      ...
      {label:"Copiar todos los nombres borrados",hint:"Conserva pruebas para devolver identidades, pero la descarga deja una firma difícil de ocultar.",cost:"Amenaza +4",fx:{threat:4,morale:4},archive:["names","protocol"],psy:{empathy:2,resolve:1},flags:{vegaErasedNamesCopied:true},nextScene:2},
...
function signalPrimaryAction(){
  if(!signalGameState)return;if(signalGameState.screen==="tutorial"||signalGameState.screen==="ready"){startSignalChallenge();return}if(signalGameState.screen==="success"){closeSignalHack(false);toast("Firma oculta · reloj del inhibidor activo");return}if(signalGameState.screen==="failed"){closeSignalHack(true);startTrackingCombat("hack")}
}
...
function eventDisplay(ev,index){
  ...
  if(ev.title==="La mesa para cuatro"&&(state.flags.rosaSafeHouseMarked||state.flags.h12RouteCompleted)){
    ...
    else if(state.flags.h12Line1Hidden){houseText+=" Un pulso de H-12 cruza la ventana y corrige todas las firmas salvo la de Línea 1. La casa sigue apareciendo en el mapa: el precio exacto de proteger un solo hogar.";houseTime="11:20"}
  ...
  if(ev.title==="El nido de vigilancia"&&state.flags.h12CommuneBlind)return Object.assign({},ev,{text:"El nido debería despertar cuando el grupo pisa la azotea, pero todos los drones permanecen suspendidos en una oscuridad mecánica. El apagón de H-12 alcanzó el relé: pueden aprovechar sus restos, preservar el vacío o convertirlo en advertencia para las comunidades borradas.",choices:[
    ...
    {label:"Preservar el apagón",hint:"Renuncia al núcleo para que media comuna siga fuera del mapa.",cost:"Renuncia al núcleo",title:"El valor de no tocar nada",result:"El grupo cruza sin encender una sola óptica. Detrás de ellos, la azotea continúa muda y cientos de firmas siguen sin existir para la Red UNO.",fx:{threat:-7,morale:2},flags:{droneNestBypassed:true,h12BlackoutPreserved:true}},
  ...
  if(ev.title==="El nido de vigilancia"&&state.flags.h12Controlled)return Object.assign({},ev,{text:"Los drones del nido giran hacia el grupo y después bajan las armas. H-12 conserva el control que recibió en el repetidor, pero el enlace central todavía comunica con la Red UNO. Mantener ese poder exige decidir qué orden merece sobrevivir.",choices:[
    {label:"Dispersar el enjambre",hint:"H-12 reparte las unidades por rutas falsas y despeja el camino.",cost:"Control de H-12",title:"Cientos de calles vacías",result:"Los drones abandonan el nido siguiendo firmas inexistentes. La Red UNO ve movimiento en todas partes salvo donde realmente avanza el grupo.",fx:{threat:-8,morale:2},archive:["sonar"],flags:{droneNestBypassed:true,h12NestDispersed:true}},
  ...
  if(ev.title==="La puerta de continuidad"&&state.flags.ortegaRouteCompleted){
    ...
    else if(state.flags.ortegaLine1Protected){ortegaDoorText="El sello privado de Ortega reconoce al grupo como enlace exclusivo de Línea 1. La puerta puede abrirse sin alarma, pero cada confirmación fortalece el pacto secreto que dejó a las otras comunidades fuera de la protección.";ortegaDoorChoices[1]={label:"Usar el salvoconducto de Línea 1",hint:"Entra por la ruta protegida y conserva el acuerdo con Ortega.",cost:"Moral −2",title:"Seguridad escrita en singular",result:"La puerta confirma tres firmas y bloquea todas las demás. El grupo alcanza la torre por un corredor impecable que ningún otro refugio podrá utilizar.",fx:{threat:-6,morale:-2},archive:["purpleHelmets"],flags:{towerEntered:true,safeExit:true,ortegaPrivateDoorUsed:true}}}
...
var introPages=[
  ...
  {chapter:"Mara «La Rielera» · Economato",title:"Nada sale de la nada",image:"characters/mara-trader.webp",speaker:true,alt:"Mara La Rielera, recuperadora del Andén 4",location:"Andén 4 · El almacén de Mara",text:"«Antes de subir, vengan al almacén. Tengo un lote inicial para ustedes: recíbanlo primero, les dará suministros y fichas para prepararse.\n\n»Aquí pueden vender lo que traigan: elijan un objeto de sus rescates y pulsen Entregar para recibir fichas. Para comprar, elijan algo de mis reservas y pulsen Recibir; cuesta las fichas indicadas y necesita espacio en una mochila. Cada intercambio mueve una unidad.\n\n»Miren qué les falta. Afuera, una venda guardada puede valer más que una mochila llena.»",action:"Abrir almacén"}
];
...
var gameHelpPages=[
  ...
  {title:"Recuperar y preparar",text:"Después de vencer, elige quién recoge el botín. Cada unidad necesita espacio en su mochila: reparte objetos entre los aliados para poder llevar lo que te sirva.\n\nDesde sus fichas puedes equipar, transferir y fabricar. Sara prepara medicina, Elías trabaja con piezas y Noa fabrica granadas y EMP. Las recetas indican qué materiales consumen.",tip:"Mara compra tus rescates a cambio de fichas y vende suministros. El Armero ofrece armas; equípalas desde la ficha del aliado."},
