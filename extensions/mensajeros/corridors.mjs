import {contextualAna} from './rosa-bridge.mjs';
...
export function assignment(data,w,id){
 ...
 return contextualAna(contextualAdasme(payment?{...m,reward:payment.reward,late_step_minutes:payment.late_step_minutes,late_penalty:payment.late_penalty}:m,w),w);
}
