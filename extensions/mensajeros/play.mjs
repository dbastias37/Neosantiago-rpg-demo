import {communityNetwork,conversation,placeHeader,contactCard,knownCommunityContacts} from './community.mjs?v=1';
...
function contact(id){
 ...
 if(!c||!m)return;if(id==='beatriz'&&E.beatrizMemory(world,'libertadores').length){openBeatriz();return;}if(id==='adasme'&&E.returnStatus(world)){openReturn();return;}
