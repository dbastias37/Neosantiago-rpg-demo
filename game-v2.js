...
function openRefuge(reason,restoring){
  ...
  closeGameHelp(false);clearIntroTyping();
...
function completeIntro(){
  ...
  clearIntroTyping();state.introCompleted=true;openRefuge("start");$("starterKit").focus({preventScroll:true})
}
