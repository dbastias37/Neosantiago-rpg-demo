...
|---|---|---|---:|---|---|
| `audio/ambience/archive-static.mp3` | Falta | P2 | 0 | ambience-archive | `neosantiago-demo.html:1121` (literal) |
| `audio/ambience/battle-loop.mp3` | Existe | P2 | 1513480 | ambience-battle | `neosantiago-demo.html:1119` (literal) |
| `audio/ambience/battle-victory.mp3` | Existe | P0 | 1205026 | ambience-battle-victory | `neosantiago-demo.html:1120` (literal) |
| `audio/ambience/title-enter.mp3` | Existe | P1 | 243252 | start-title-enter | `neosantiago-demo.html:1049` (literal) |
| `audio/ambience/title-rain-tunnel.mp3` | Existe | P2 | 1992960 | ambience-title | `neosantiago-demo.html:1118` (literal) |
| `audio/archive/dossier-switch.mp3` | Falta | P0 | 0 | archive-switch | `neosantiago-demo.html:1063` (literal) |
| `audio/archive/file-close.mp3` | Existe | P0 | 4438 | archive-close | `neosantiago-demo.html:1062` (literal) |
| `audio/archive/file-open.mp3` | Existe | P0 | 13842 | archive-open | `neosantiago-demo.html:1061` (literal) |
| `audio/combat/critical-hit.mp3` | Existe | P0 | 18231 | combat-critical | `neosantiago-demo.html:1094` (literal) |
| `audio/combat/defend-cover.mp3` | Falta | P0 | 0 | combat-defend | `neosantiago-demo.html:1095` (literal) |
| `audio/combat/emp-pulse.mp3` | Existe | P0 | 40801 | combat-emp | `neosantiago-demo.html:1098` (literal) |
| `audio/combat/enemy-hit-normal-1.mp3` | Existe | P0 | 7573 | combat-enemy-hit-normal | `neosantiago-demo.html:1089` (literal) |
| `audio/combat/enemy-hit-normal-2.mp3` | Existe | P0 | 4438 | combat-enemy-hit-normal | `neosantiago-demo.html:1089` (literal) |
| `audio/combat/enemy-hit-normal-3.mp3` | Existe | P0 | 8200 | combat-enemy-hit-normal | `neosantiago-demo.html:1089` (literal) |
| `audio/combat/enemy-hit-normal-4.mp3` | Existe | P0 | 8200 | combat-enemy-hit-normal | `neosantiago-demo.html:1089` (literal) |
| `audio/combat/flee.mp3` | Falta | P0 | 0 | combat-flee | `neosantiago-demo.html:1096` (literal) |
| `audio/combat/grenade.mp3` | Existe | P0 | 65878 | combat-grenade | `neosantiago-demo.html:1097` (literal) |
| `audio/combat/hit-normal-1.mp3` | Existe | P0 | 5692 | combat-hit-normal | `neosantiago-demo.html:1088` (literal) |
| `audio/combat/hit-normal-2.mp3` | Existe | P0 | 4438 | combat-hit-normal | `neosantiago-demo.html:1088` (literal) |
| `audio/combat/hit-normal-3.mp3` | Existe | P0 | 7573 | combat-hit-normal | `neosantiago-demo.html:1088` (literal) |
| `audio/combat/hit-normal-4.mp3` | Existe | P0 | 7573 | combat-hit-normal | `neosantiago-demo.html:1088` (literal) |
| `audio/combat/hit-normal.mp3` | Falta | P0 | 0 | combat-hit-normal | `neosantiago-demo.html:1088` (literal) |
| `audio/combat/melee-hit.mp3` | Falta | P0 | 0 | combat-melee | `neosantiago-demo.html:1087` (literal) |
| `audio/combat/miss.mp3` | Existe | P0 | 7573 | combat-miss | `neosantiago-demo.html:1093` (literal) |
| `audio/combat/shot-9mm.mp3` | Falta | P0 | 0 | combat-shot-9mm | `neosantiago-demo.html:1090` (literal) |
| `audio/combat/shot-rifle.mp3` | Falta | P0 | 0 | combat-shot-rifle | `neosantiago-demo.html:1091` (literal) |
| `audio/combat/shot-shotgun.mp3` | Falta | P0 | 0 | combat-shot-shotgun | `neosantiago-demo.html:1092` (literal) |
| `audio/combat/skill-elias.mp3` | Falta | P0 | 0 | combat-skill-elias | `neosantiago-demo.html:1085` (literal) |
| `audio/combat/skill-noa.mp3` | Falta | P0 | 0 | combat-skill-noa | `neosantiago-demo.html:1086` (literal) |
| `audio/combat/target-hover.mp3` | Falta | P0 | 0 | combat-target-hover | `neosantiago-demo.html:1083` (literal) |
| `audio/combat/target-select.mp3` | Existe | P0 | 3811 | combat-target | `neosantiago-demo.html:1084` (literal) |
| `audio/crafting/craft-basic.mp3` | Falta | P0 | 0 | craft-basic | `neosantiago-demo.html:1079` (literal) |
| `audio/crafting/craft-medical.mp3` | Falta | P0 | 0 | craft-medical | `neosantiago-demo.html:1080` (literal) |
| `audio/crafting/craft-tech.mp3` | Falta | P0 | 0 | craft-tech | `neosantiago-demo.html:1081` (literal) |
| `audio/decision/choice-confirm.mp3` | Falta | P0 | 0 | decision-confirm | `neosantiago-demo.html:1057` (literal) |
| `audio/decision/choice-hover.mp3` | Falta | P0 | 0 | decision-hover | `neosantiago-demo.html:1056` (literal) |
| `audio/decision/combat-trigger.mp3` | Falta | P0 | 0 | decision-combat | `neosantiago-demo.html:1059` (literal) |
| `audio/decision/danger-choice.mp3` | Falta | P0 | 0 | decision-danger | `neosantiago-demo.html:1058` (literal) |
| `audio/decision/result-reveal.mp3` | Falta | P0 | 0 | decision-result | `neosantiago-demo.html:1060` (literal) |
| `audio/ending/bad-ending.mp3` | Falta | P1 | 0 | ending-bad | `neosantiago-demo.html:1116` (literal) |
| `audio/ending/good-ending.mp3` | Falta | P1 | 0 | ending-good | `neosantiago-demo.html:1114` (literal) |
| `audio/ending/neutral-ending.mp3` | Falta | P1 | 0 | ending-neutral | `neosantiago-demo.html:1115` (literal) |
| `audio/ending/summary-open.mp3` | Falta | P1 | 0 | ending-summary | `neosantiago-demo.html:1117` (literal) |
| `audio/hp/ally-damage.mp3` | Falta | P0 | 0 | combat-enemy-hit-normal, hp-ally-damage | `neosantiago-demo.html:1089` (literal)<br>`neosantiago-demo.html:1099` (literal) |
| `audio/hp/ally-down.mp3` | Falta | P0 | 0 | hp-ally-down | `neosantiago-demo.html:1103` (literal) |
| `audio/hp/enemy-damage.mp3` | Falta | P0 | 0 | combat-hit-normal, hp-enemy-damage | `neosantiago-demo.html:1088` (literal)<br>`neosantiago-demo.html:1100` (literal) |
| `audio/hp/enemy-down.mp3` | Falta | P0 | 0 | hp-enemy-down | `neosantiago-demo.html:1104` (literal) |
| `audio/hp/heal.mp3` | Falta | P0 | 0 | hp-heal, hp-medical-use | `neosantiago-demo.html:1101` (literal)<br>`neosantiago-demo.html:1102` (literal) |
| `audio/hp/medical-use.mp3` | Falta | P0 | 0 | hp-medical-use | `neosantiago-demo.html:1102` (literal) |
| `audio/hp/revive-pulse.mp3` | Falta | P0 | 0 | hp-revive | `neosantiago-demo.html:1105` (literal) |
| `audio/loadout/equip-item.mp3` | Falta | P0 | 0 | loadout-equip | `neosantiago-demo.html:1073` (literal) |
| `audio/loadout/item-tray-open.mp3` | Falta | P0 | 0 | loadout-tray | `neosantiago-demo.html:1077` (literal) |
| `audio/loadout/profile-open.mp3` | Existe | P0 | 11334 | loadout-open | `neosantiago-demo.html:1072` (literal) |
| `audio/loadout/repair-gear.mp3` | Existe | P0 | 16350 | loadout-repair | `neosantiago-demo.html:1076` (literal) |
| `audio/loadout/transfer-item.mp3` | Falta | P0 | 0 | loadout-transfer | `neosantiago-demo.html:1075` (literal) |
| `audio/loadout/use-food.mp3` | Falta | P0 | 0 | loadout-food | `neosantiago-demo.html:1078` (literal) |
| `audio/loadout/use-item.mp3` | Falta | P0 | 0 | loadout-use | `neosantiago-demo.html:1074` (literal) |
| `audio/loot/corpse-hover.mp3` | Falta | P0 | 0 | loot-hover | `neosantiago-demo.html:1106` (literal) |
| `audio/loot/discard-item.mp3` | Existe | P0 | 11334 | loot-discard | `neosantiago-demo.html:1111` (literal) |
| `audio/loot/loot-exit.mp3` | Existe | P0 | 11334 | loot-exit | `neosantiago-demo.html:1113` (literal) |
| `audio/loot/loot-found.mp3` | Existe | P0 | 16350 | loot-found | `neosantiago-demo.html:1109` (literal) |
| `audio/loot/search-loop-1.mp3` | Existe | P0 | 121049 | loot-loop | `neosantiago-demo.html:1108` (literal) |
| `audio/loot/search-loop-2.mp3` | Existe | P0 | 140484 | loot-loop | `neosantiago-demo.html:1108` (literal) |
| `audio/loot/search-loop-3.mp3` | Existe | P0 | 145499 | loot-loop | `neosantiago-demo.html:1108` (literal) |
| `audio/loot/search-loop.mp3` | Falta | P0 | 0 | loot-loop | `neosantiago-demo.html:1108` (literal) |
| `audio/loot/search-start.mp3` | Falta | P0 | 0 | loot-search | `neosantiago-demo.html:1107` (literal) |
| `audio/loot/take-all.mp3` | Falta | P0 | 0 | loot-take-all | `neosantiago-demo.html:1112` (literal) |
| `audio/loot/take-item-1.mp3` | Existe | P0 | 9454 | refuge-supply, loot-take | `neosantiago-demo.html:1066` (literal)<br>`neosantiago-demo.html:1110` (literal) |
| `audio/loot/take-item-2.mp3` | Existe | P0 | 7573 | loot-take | `neosantiago-demo.html:1110` (literal) |
| `audio/loot/take-item-3.mp3` | Existe | P0 | 11334 | loot-take | `neosantiago-demo.html:1110` (literal) |
| `audio/loot/take-item.mp3` | Falta | P0 | 0 | loot-take | `neosantiago-demo.html:1110` (literal) |
| `audio/lore/archive-open.mp3` | Falta | P0 | 0 | lore-open | `neosantiago-demo.html:1053` (literal) |
| `audio/lore/tab-switch.mp3` | Existe | P0 | 2557 | lore-page, lore-tab | `neosantiago-demo.html:1054` (literal)<br>`neosantiago-demo.html:1055` (literal) |
...
| `audio/refuge/group-ready.mp3` | Falta | P0 | 0 | refuge-ready | `neosantiago-demo.html:1068` (literal) |
| `audio/refuge/npc-switch.mp3` | Falta | P0 | 0 | refuge-npc | `neosantiago-demo.html:1065` (literal) |
| `audio/refuge/refuge-enter.mp3` | Falta | P0 | 0 | refuge-enter | `neosantiago-demo.html:1064` (literal) |
| `audio/refuge/rest-soft.mp3` | Falta | P0 | 0 | refuge-rest | `neosantiago-demo.html:1067` (literal) |
| `audio/skills/skill-unlock.mp3` | Falta | P0 | 0 | skill-unlock | `neosantiago-demo.html:1082` (literal) |
| `audio/start/expedition-start.mp3` | Falta | P1 | 0 | start-expedition | `neosantiago-demo.html:1052` (literal) |
| `audio/start/title-enter.mp3` | Existe | P1 | 243252 | start-title-enter, start-new-game | `neosantiago-demo.html:1049` (literal)<br>`neosantiago-demo.html:1050` (literal) |
| `audio/trade/item-buy.mp3` | Falta | P0 | 0 | trade-buy | `neosantiago-demo.html:1070` (literal) |
| `audio/trade/item-sell.mp3` | Falta | P0 | 0 | trade-sell | `neosantiago-demo.html:1069` (literal) |
| `audio/trade/weapon-buy.mp3` | Falta | P0 | 0 | trade-weapon | `neosantiago-demo.html:1071` (literal) |
| `audio/ui/click-metal.mp3` | Existe | P0 | 4438 | ui-click | `extensions/mensajeros/play.mjs:251` (sound-call)<br>`neosantiago-demo.html:1042` (literal) |
| `audio/ui/close-panel.mp3` | Falta | P0 | 0 | ui-close-panel, loot-exit | `neosantiago-demo.html:1045` (literal)<br>`neosantiago-demo.html:1113` (literal) |
| `audio/ui/disabled-low.mp3` | Falta | P0 | 0 | ui-disabled | `neosantiago-demo.html:1043` (literal) |
| `audio/ui/download.mp3` | Falta | P0 | 0 | ui-download | `neosantiago-demo.html:1048` (literal) |
| `audio/ui/error-low.mp3` | Falta | P0 | 0 | ui-error | `neosantiago-demo.html:1046` (literal) |
| `audio/ui/hover-soft.mp3` | Existe | P0 | 2557 | ui-hover | `neosantiago-demo.html:1041` (literal) |
| `audio/ui/open-panel.mp3` | Existe | P0 | 11334 | ui-open-panel, start-load-game | `neosantiago-demo.html:1044` (literal)<br>`neosantiago-demo.html:1051` (literal) |
| `audio/ui/tab-switch.mp3` | Falta | P0 | 0 | ui-tab | `neosantiago-demo.html:1047` (literal) |
