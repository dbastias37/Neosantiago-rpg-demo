...
La actualización hacia 0.2 comienza con una entrega específica de entrada, voz y contexto. Su alcance, fuentes, criterios de personajes y pendientes están en [docs/narrativa-0.2.md](docs/narrativa-0.2.md). La [segunda entrega](docs/continuidad-0.2-entrega-2.md) conecta una entrega de Los Mensajeros con el conocimiento y la preparación de la expedición. La [tercera entrega](docs/progresion-0.2-entrega-3.md) incorpora un primer encargo breve, apertura gradual de rutas y descanso abastecido tras reparar Plaza de Armas. La [cuarta entrega](docs/regreso-0.2-entrega-4.md) mantiene al operativo rescatado en la historia, con una conversación de llegada y una respuesta posterior según la decisión del equipo. La [quinta entrega](docs/traslados-0.2-entrega-5.md) integra los traslados físicos a los encargos, separa viaje y aceptación y añade preparación de la extracción en Tobalaba. La [sexta entrega](docs/descanso-0.2-entrega-6.md) permite decidir el uso de reservas por la noche, conserva la escena al recargar y conecta preparación y consecuencias de la jornada. La [séptima entrega](docs/recorridos-0.2-entrega-7.md) diferencia los sectores de Los Mensajeros con encuentros persistentes, añade viaje ágil y un bloqueo armado puntual, e incorpora conversaciones nocturnas con memoria para Sara, Elías y Noa. La [octava entrega](docs/acuerdos-0.2-entrega-8.md) conecta el acuerdo nocturno de Sara con las reservas y decisiones ante Lira, guarda su consecuencia y la retoma durante la segunda noche. La [novena entrega](docs/rutas-noa-0.2-entrega-9.md) conecta el acuerdo de Noa con el motivo de la salida, el riesgo real de la Alameda y el recuerdo de cómo resolvieron el cruce, incluidos los intentos que terminaron en el refugio. Las etapas anteriores de este documento se conservan como historial.
