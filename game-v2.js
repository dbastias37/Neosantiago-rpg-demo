...
function newGame(){state=fresh();pending=null;battleState=null;transferDraft=null;discardDraft=null;disassemblyState=null;npcDialogueState=null;routeNarrativeState=null;archiveOpener=null;audioClueOpener=null;worldLoreOpener=null;clearInterval(lootInterval);clearInterval(disassemblyTimer);clearInterval(npcDialogueTimer);clearRouteNarrativeTimers();resetAudioCluePlayer();["titleScreen","start","gameIntro","worldLoreModal","battle","final","summary","refuge","profileModal","transferModal","discardModal","disassemblyModal","lootModal","logisticsModal","archiveModal","audioClueModal","npcDialogueModal","routeNarrativeModal"].forEach(function(id){$(id).classList.add("hidden")});render();save();showGameIntro(0)}
