...
function progressHTML(){return `<section class="network-progress" aria-label="Progreso de la red"><span class="eyebrow">LA RED QUE VAS ABRIENDO</span><p><strong>${world.paid.length} entregas</strong> · ${E.knownMissions(data,world).length} encargos conocidos · ${world.progression.visited.length} lugares visitados</p><p>${esc(E.nextLead(data,world))}</p></section>`;}
function fitMap(){
