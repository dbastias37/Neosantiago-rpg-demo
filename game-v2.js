...
function completeChoice(choice,out,roll,check,extra){
  ...
  if(typeof prepareCrate==="function")prepareCrate(choice,out);
...
function eventDisplay(ev,index){var result=legacyEventDisplay(ev,index);result=typeof narrativeEvent==="function"?narrativeEvent(result):result;result=typeof narrativeRememberedEvent==="function"?narrativeRememberedEvent(result,index):result;result=typeof companionCareEvent==="function"?companionCareEvent(result,index):result;return typeof finaleEvent==="function"?finaleEvent(result,index):result}
