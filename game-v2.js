...
],inv:[],docs:["signal"],flags:{},missionRewards:{},history:[],stats:{battles:0,wins:0,enemies:0,loot:0,lootItems:{},fullSquadWins:0,criticals:0,retreats:0,refugeVisits:0,trades:0,creditsEarned:0,attacks:0,hits:0,misses:0,shots:0,damageDealt:0,damageTaken:0,medicineUsed:0,hpRestored:0,restHpRecovered:0,rests:0,skillsUsed:0,revives:0,defends:0,crafts:0,craftedItems:{},itemsUsed:{},disassembled:0,disassembleFailures:0,xpFromHits:0,xpFromCrafting:0,xpFromVictories:0,factionEarned:0,factionSpent:0,skillsUnlocked:0},seed:2130,ending:null,finished:false}}
...
function newGame(){state=fresh();pending=null;battleState=null;transferDraft=null;discardDraft=null;disassemblyState=null;npcDialogueState=null;archiveOpener=null;worldLoreOpener=null;clearInterval(lootInterval);clearInterval(disassemblyTimer);clearInterval(npcDialogueTimer);["titleScreen","start","gameIntro","worldLoreModal","battle","final","summary","refuge","profileModal","transferModal","discardModal","disassemblyModal","lootModal","logisticsModal","archiveModal","npcDialogueModal"].forEach(function(id){$(id).classList.add("hidden")});render();save();showGameIntro(0)}
