...
function newGame(){state=fresh();pending=null;battleState=null;archiveOpener=null;worldLoreOpener=null;clearInterval(lootInterval);["titleScreen","start","gameIntro","worldLoreModal","battle","final","summary","refuge","profileModal","transferModal","lootModal","archiveModal"].forEach(function(id){$(id).classList.add("hidden")});render();save();showGameIntro(0)}
