import {communityNetwork,conversation,placeHeader,contactCard,knownCommunityContacts} from './community.mjs?v=2-guzman';
import {dossier} from './dossier.mjs?v=2-guzman';
...
function contact(id){
 ...
 if(!c||!m)return;if(id==='guzman'&&E.guzmanMemory(world,'leones').length){openGuzman();return;}if(id==='beatriz'&&E.beatrizMemory(world,'libertadores').length){openBeatriz();return;}if(id==='adasme'&&E.returnStatus(world)){openReturn();return;}
