...
Para revisar: comparar el mismo encargo en A y B, filtrar por Centro/Norte, abrir su recorrido, volver a la ficha y repetir con Vista móvil. Elegir una dirección visual antes de integrar el bloque 2.
