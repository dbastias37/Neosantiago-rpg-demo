...
var introPages=[
  {chapter:"Prólogo · La superficie",title:"La ciudad que quedó",image:"backgrounds/day-alameda.webp",alt:"La Alameda entre ruinas y vegetación",location:"NeoSantiago · 2130",text:"Santiago ya no suena como antes. La naturaleza crece entre edificios vacíos y los semáforos siguen dando órdenes a calles desiertas.\n\nTras décadas de ruptura y control, la Gobernanza Mundial conserva su territorio protegido. La Red UNO vigila a quienes aún se mueven bajo el cielo."},
  {chapter:"Prólogo · Bajo tierra",title:"La ciudad de los Rotos",image:"backgrounds/station-ruins.webp",alt:"Refugios iluminados junto a las vías abandonadas del Metro",location:"Antigua Línea 1 · Los túneles",text:"Quienes rechazaron ese orden aprendieron a vivir bajo tierra. Las estaciones de la antigua Línea 1 se convirtieron en refugios; los relatos y los papeles conservaron lo que la ciudad estaba olvidando.\n\nLos llaman Rotos. Para seguir aquí, necesitan volver a la superficie: buscar alimento, recuperar herramientas y regresar sin revelar el camino a casa."},
  {chapter:"Prólogo · La transmisión",title:"Todavía estamos aquí",image:"backgrounds/antenna-core-room.webp",alt:"Equipos y señales encendidos en una sala de antenas",location:"Una voz dentro de la Red UNO",text:"Una voz humana ha despertado dentro de la red: «todavía estamos aquí». Alguien logró atravesar el silencio. Nadie en el refugio sabe quién.\n\nSara, Elías y Noa tienen tres días para encontrar el origen de la transmisión. Lo que descubran, y lo que decidan llevar de regreso, puede cambiar a su comunidad."},
  {chapter:"Tu expedición",title:"Cada paso deja huella",image:"backgrounds/day-station-entrance.webp",alt:"Una salida del Metro hacia la superficie",location:"Antes de abrir la compuerta",text:"Lee la escena y elige cómo actuar. Cada opción te indica qué arriesgas; cuando el desenlace sea incierto, verás las posibilidades antes de decidir.\n\nCuida al grupo y guarda espacio para lo que encuentres. Las fichas de Sara, Elías y Noa permiten revisar equipo, curar y fabricar. En combate, selecciona un enemigo y luego una acción. Elías te enseñará a usar el inhibidor al salir.\n\nLa partida se guarda automáticamente fuera de los enfrentamientos. Primero, Mara te ayudará a preparar la salida.",action:"Comenzar"},
  {chapter:"Mara, la Comerciante · Almacén",title:"Nada sale de la nada",image:"characters/mara-trader.webp",speaker:true,alt:"Mara, comerciante del Andén 4",location:"Andén 4 · El almacén de Mara",text:"«Antes de subir, vengan al almacén. Tengo un lote inicial para ustedes: recíbanlo primero, les dará suministros y fichas para prepararse.\n\n»Aquí pueden vender lo que traigan: elijan un objeto de su loot y pulsen Entregar para recibir fichas. Para comprar, elijan algo de mis reservas y pulsen Recibir; cuesta las fichas indicadas y necesita espacio en una mochila. Cada intercambio mueve una unidad.\n\n»Miren qué les falta. Afuera, una venda guardada puede valer más que una mochila llena.»",action:"Elegir actividad"}
];
