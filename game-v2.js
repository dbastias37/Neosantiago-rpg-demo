...
function switchProfile(currentIndex,nextIndex){
  if(battleState||!state.party[nextIndex]||nextIndex===currentIndex)return;closeTransferModal();renderProfile(nextIndex);var active=document.querySelector('[data-profile-switch="'+nextIndex+'"]');if(active)active.focus()
}
