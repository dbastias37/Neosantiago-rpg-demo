/* Optional review context. No interception of localStorage or production keys. */
(function(root){
  var variant=null;
  ...
  root.NeoBridgeContext=Object.freeze({variant:variant,key:function(key){return variant?'neosantiago.lab.bridge.'+variant+'.'+key:key}});
})(globalThis);
