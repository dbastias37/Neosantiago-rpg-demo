...
var branchDialogueDefs={
  ...
  varelaArchives:{npc:"elder",kicker:"Memoria del consejo",start:"start",nodes:{
    start:{lines:["Varela les hace sitio junto a la lámpara. Sara deja la hoja de los exiliados sobre la mesa. «Esto también lo tenían cuando nos pidieron seguir la señal». La anciana acerca el papel para leerlo.","«Sí. Y debimos explicárselo antes de mandarlos». Noa sigue de pie. Varela señala la silla libre, pero no insiste cuando ella no se sienta."],options:[
