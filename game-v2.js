...
var npcDialogueDefs={
  elder:{name:"Varela",role:"Anciano del consejo · memoria del refugio",portrait:"portraits/npc-varela.webp?v=2-abuelo"},
  ...
  unit12:{name:"Unidad H-12",role:"Dron de altura · rastreo SONAR",portrait:"portraits/npc-unit12.webp"},
...
var branchDialogueDefs={
  rosaWater:{npc:"rosa",kicker:"La fiebre de Iara",start:"start",nodes:{
    start:{lines:["Rosa no guarda el agua de inmediato. La acerca a los labios de su hija y espera a que la niña trague antes de mirar al grupo.","«Se llama Iara. Si abre los ojos y ve sus armas, va a creer que volvieron los de arriba.»"],options:[
      ...
      {label:"Decir que deben seguir antes del rastreo",hint:"Corta la conversación y conserva tiempo.",fx:{threat:-1,morale:-1},psy:{pragmatism:1,stress:1},flags:{leftRosaQuickly:true}}
    ]},
  ...
  matiasSaved:{npc:"matias",kicker:"Superviviente rescatado",start:"start",nodes:{
    ...
    exit:{lines:["Matías cierra los ojos cuando escucha botas lejos de la farmacia. No son de la Red UNO; son de gente buscando lo mismo que ustedes.","«Si me llevan, van más lento. Si me dejan, quizá todavía pueda mentir por radio cuando los busquen.»"],options:[
      {label:"Llevarlo de vuelta a Línea 1",hint:"Abre un desvío narrativo con riesgo, recompensa y salida tardía.",fx:{morale:3,threat:2},psy:{empathy:2,resolve:1},flags:{carriedMatias:true},routeScene:"matiasRescue"},
  ...
  unit7Protocol:{npc:"unit7",kicker:"Orden final",start:"start",nodes:{
    start:{lines:["La unidad S-7 no se va. El motor queda suspendido con un temblor pequeño, casi animal.","«Solicitud: orden final. El protocolo antiguo protege pulso humano. Defina humano.»"],options:[
      ...
      {label:"Abrir el chasis antes de que transmita",hint:"La acción puede volverse combate sin aviso.",combat:{title:"Orden rechazada",brief:"El chasis interpreta la manipulación como captura y reactiva sus placas de defensa.",encounters:[["drone"],["drone","drone"]],xp:34,canFlee:true},victory:{title:"Memoria arrancada",result:"Elías extrae una ruta parcial antes de que el núcleo se queme.",fx:{threat:3,morale:-2},add:["routeMap"],archive:["sonar"],flags:{unit7ForcedOpen:true}},defeat:{title:"Identidad recuperada",result:"La unidad escapa con una lectura incompleta del grupo.",fx:{threat:10,morale:-3},flags:{unit7Escaped:true}}}
    ]},
    define:{lines:["«Negarse genera error. Error genera cuidado. Cuidado genera corrección.»","La ranura inferior se abre un poco más. Dentro no hay arma visible, solo una memoria tibia."],options:[
      {label:"Ayudar a S-7 a recuperar su orden original",hint:"Abre un desvío hacia la subestación donde la Red UNO sobrescribió su memoria.",fx:{morale:2,threat:2},archive:["sonar"],psy:{empathy:1,resolve:1},flags:{unit7RecoveryAccepted:true},routeScene:"unit7LastOrder"},
  ...
  varelaArchives:{npc:"elder",kicker:"Memoria del consejo",start:"start",nodes:{
    start:{lines:["Varela les hace sitio junto a la lámpara. Sara deja la hoja de los exiliados sobre la mesa. «Esto también lo tenían cuando nos pidieron seguir la señal». El anciano acerca el papel para leerlo.","«Sí. Y debimos explicárselo antes de mandarlos». Noa sigue de pie. Varela señala la silla libre, pero no insiste cuando ella no se sienta."],options:[
      {label:"Preguntar por qué ocultaron a los exiliados",hint:"Pide una explicación por la información que les negaron.",archive:["exiles"],fx:{morale:1},psy:{resolve:1},flags:{varelaNamedCouncilLie:true},next:"debt"},
    ...
    debt:{lines:["Varela abre una carpeta de fotografías. En una de ellas se ve a varias personas junto a un andén. «Vivían aquí. Trajeron tecnología de El Valle y quisieron usarla en sus propios cuerpos. El consejo de entonces los expulsó».","«Después dejamos de contar esa parte. Era más fácil pedirles a los jóvenes que salieran si creían que afuera solo había animales y máquinas». Sara le pregunta si él siguió contándolo así. «Sí», responde Varela."],options:[
    ...
    charge:{lines:["Varela separa las listas de nombres de los protocolos. «Pueden llevar copia de lo que lean. No tengo aquí un acta que diga quién firmó la expulsión». Elías anota qué documento falta. Noa mueve la lámpara para que puedan seguir leyendo.","Antes de cerrar, Varela deja sobre la hoja una ficha oxidada para que no se doble. Tiene una marca de UNO casi borrada. «Si encuentran a quien habla, pregúntenle qué necesita. Y no den por cierto todo lo que venga de una voz conocida. Tampoco de la mía»."],options:[
      {label:"Prometer investigar quién envió la señal",hint:"Refuerza propósito y cohesión.",fx:{morale:3},psy:{resolve:1,empathy:1},flags:{vowedSignalSource:true}},
      ...
      {label:"Guardar la ficha sin prometer nada",hint:"Acepta la ficha sin comprometerse a una respuesta.",fx:{morale:-1,threat:-1},psy:{pragmatism:1},flags:{keptVarelaTokenQuiet:true}}
    ]}
  }},
  unit12Sweep:{npc:"unit12",kicker:"Rastreo de altura",start:"start",nodes:{
    start:{lines:["La Unidad H-12 queda suspendida sobre la avenida como una campana negra. El altavoz no grita; ordena con la paciencia de una máquina acostumbrada a ser obedecida.","«Permanezcan visibles. La invisibilidad civil será tratada como sabotaje. La Red UNO agradece su cooperación.»"],options:[
      ...
      {label:"Responder con una identidad falsa",hint:"Usa el error como máscara.",fx:{threat:-2},archive:["sonar"],psy:{pragmatism:1},flags:{answeredH12WithGhost:true},next:"lag"},
      {label:"Gritar que no son ciudadanos de la Red UNO",hint:"Descarga rabia, pero deja una identidad fácil de rastrear.",fx:{morale:1,threat:3},psy:{stress:2,resolve:1},flags:{defiedH12Aloud:true},next:"warning"}
    ]},
    lag:{lines:["Elías levanta dos dedos. La voz llega antes que el giro de los sensores; durante medio segundo, la orden y el ojo no pertenecen al mismo cuerpo.","«Inconsistencia aceptable. Repita estado: visible, útil, corregible.»"],options:[
      ...
      {label:"Pedir que escolte una identidad vacía",hint:"Convierte el dron en señuelo breve.",fx:{threat:-4},psy:{pragmatism:1},flags:{h12EscortedGhost:true},next:"route"},
      {label:"Intentar forzar su núcleo en vuelo",hint:"Puede convertir el diálogo en combate.",combat:{title:"Rastreo quebrado",brief:"La Unidad H-12 interpreta la intrusión como sabotaje y llama drones menores desde la azotea.",encounters:[["drone","drone"],["drone","drone","drone"]],xp:48,canFlee:true},victory:{title:"Cielo sin altavoz",result:"El dron de rastreo cae lejos de la avenida y su memoria conserva una ruta de vuelo hacia la torre.",fx:{threat:4,morale:1},add:["droneCore"],archive:["sonar"],flags:{h12ShotDown:true}},defeat:{title:"Marcados por altura",result:"La unidad asciende con una lectura limpia de los tres supervivientes.",fx:{threat:14,morale:-4},flags:{h12MarkedGroup:true}}}
    ]},
    warning:{lines:["El dron tarda demasiado en responder. Cuando lo hace, la voz ya no usa el tono civil.","«La emoción no registrada aumenta probabilidad de contagio social. Recomiende aislamiento.»"],options:[
      {label:"Callar y dejar que la identidad falsa hable",hint:"Recupera control después del impulso.",fx:{threat:-2,morale:-1},psy:{pragmatism:1,stress:-1},flags:{recoveredFromH12Defiance:true},next:"route"},
      {label:"Sostener la provocación",hint:"La escena se rompe hacia combate.",combat:{title:"Aislamiento aéreo",brief:"El dron de rastreo desciende y abre fuego para fijar al grupo en la avenida.",encounters:[["drone","drone"],["drone"]],xp:42,canFlee:true},victory:{title:"Orden en el suelo",result:"El altavoz chisporrotea una última instrucción antes de apagarse.",fx:{threat:5,morale:2},add:["droneCore"],flags:{h12DefiedAndDropped:true}},defeat:{title:"Avenida cerrada",result:"El grupo escapa por una boca de metro mientras el rastreo reclama la calle.",fx:{threat:12,morale:-5},flags:{h12ClosedAvenue:true}}},
    ...
    route:{lines:["La luz cyan del rastreo se desvía hacia una torre equivocada. Por primera vez, una máquina de la Red UNO protege una mentira humana.","«Ruta civil no encontrada. Registrando ausencia.»"],options:[
      {label:"Seguir la ausencia hasta el repetidor",hint:"Abre un desvío para descubrir qué cuerpos conserva H-12 en su mapa de vigilancia.",fx:{morale:2,threat:2},archive:["sonar"],psy:{empathy:1,resolve:1},flags:{h12RelayAccepted:true},routeScene:"unit12InvisibleMap"},
  ...
  trackerCredential:{npc:"tracker",kicker:"Control de identidad",start:"start",nodes:{
    ...
    audit:{lines:["Vega acerca un lector al pecho de Noa. La pantalla no muestra nombres; muestra deuda, pulso y probabilidad de obediencia.","«Tres personas identificadas. Una coincide con archivo muerto. Una no debería haber salido del refugio. Una ya fue escuchada por la señal.»"],options:[
      ...
      {label:"Empujar el lector lejos",hint:"Puede iniciar combate desde la conversación.",combat:{title:"Control roto",brief:"Vega retrocede y la escolta interpreta el gesto como agresión contra protocolo.",encounters:[["agent3","agent2"],["agent3","drone"],["agent2","drone"]],xp:50,canFlee:true},victory:{title:"Identidad arrancada",result:"El grupo destruye el lector antes de que suba el registro completo.",fx:{threat:6,morale:1},archive:["sonar"],flags:{vegaReaderDestroyed:true}},defeat:{title:"Identidades comprometidas",result:"La patrulla transmite una lectura parcial antes de que el grupo escape.",fx:{threat:15,morale:-5},flags:{signaturesKnown:true}}}
    ]},
    break:{lines:["El lector termina de comparar al grupo, pero no se apaga. El guante de Vega detecta una cuarta identidad y proyecta su propio rostro bajo un registro de fallecimiento.","Vega corta la transmisión con una mano temblorosa. «Ese pulso es mío. El expediente está debajo del cruce. Si la Red UNO reutilizó mi nombre, necesito saber cuántos más siguen caminando como muertos.»"],options:[
      {label:"Seguir la cuarta identidad hasta el registro",hint:"Abre un desvío para descubrir cómo la Red UNO reutiliza las identidades de muertos y exiliados.",fx:{morale:2,threat:2},archive:["names","sonar"],psy:{empathy:1,resolve:1},flags:{vegaFourthSignatureFound:true},routeScene:"vegaDeadNames"},
  ...
  ortegaLine:{npc:"commander",kicker:"Cordón morado",start:"start",nodes:{
    start:{lines:["Ortega examina el registro que acaba de aceptar el lector. Mantiene el arma baja, pero los soldados de la puerta esperan su señal.","«Este nombre figura como expulsado. El lector lo acepta; mi orden dice que no lo deje pasar. ¿De dónde sacaron el registro?»"],options:[
      {label:"Señalar que el lector aceptó el registro",hint:"Usa la ley contra la Red UNO.",fx:{threat:-1},archive:["purpleHelmets"],psy:{pragmatism:1},flags:{showedOrtegaProtocolGap:true},next:"doctrine"},
      {label:"Decir que Lira sigue viva",narrativeRequires:{all:["savedMerodeadora"],none:["liraDead","tookLivingCore","betrayedLira"]},hint:"Vuelve personal la contradicción.",fx:{morale:2,threat:1},psy:{empathy:1,resolve:1},flags:{toldOrtegaLiraLives:true},next:"doctrine"},
    ...
    doctrine:{lines:["Ortega levanta la visera. Detrás de él, alguien golpea una persiana cerrada. Mira hacia el ruido y vuelve a bajar la voz.","«Hay familias viviendo detrás de esa puerta. Me ordenaron mantenerlas dentro. Si abro sin autorización, vienen a reemplazarme. Y no sé qué harán con ellas.»"],options:[
      ...
      {label:"Preguntar si las familias pueden negarse a quedarse",hint:"Eleva moral y tensión.",fx:{morale:3,threat:2},psy:{resolve:2},flags:{challengedOrtegaDoctrine:true},next:"breach"},
      {label:"Ofrecer borrar la ruta de Lira si abre paso",narrativeRequires:{any:["liraSafeRoute","liraTowerRoute","liraAlliance"],none:["liraDead"]},hint:"Una negociación oscura con costo moral.",fx:{threat:-4,morale:-4},psy:{pragmatism:1,empathy:-1},flags:{offeredToEraseLira:true},next:"breach"}
    ]},
    breach:{lines:["El comandante consulta el canal interno. Las puertas no se abren del todo; apenas lo suficiente para que el grupo decida si cruza como excepción o como amenaza.","«Puedo dejarlos entrar conmigo. No toquen los controles ni se separen. Si rechazan la custodia, tendrán que salir del perímetro.»"],options:[
      {label:"Entrar al barrio bajo custodia de Ortega",hint:"Abre un desvío narrativo para descubrir qué protege realmente la disciplina del cordón morado.",fx:{morale:2,threat:1},archive:["purpleHelmets"],psy:{empathy:1,resolve:1},flags:{ortegaDistrictAccepted:true},routeScene:"ortegaObedientCity"},
...
var routeNarrativeDefs={
  matiasRescue:{title:"Desvío de Matías",endLoc:"Línea 1",combatResult:"El ruido obliga al grupo a defender la camilla antes de llegar al refugio.",defaultChoice:0,scenes:[
    {kicker:"Desvío de ruta · Farmacia del enlace",title:"Matías bajo el mostrador",image:"narrative/matias/matias-01-farmacia.webp",timeLimit:17000,lines:[
      ...
      {label:"Armar una camilla improvisada",hint:"Mueve a Matías con cuidado y conserva la promesa de rescate.",fx:{morale:2,threat:1},psy:{empathy:1,pragmatism:1},flags:{matiasStretcher:true},nextScene:1},
    ...
    {kicker:"Desvío de ruta · Túnel quieto",title:"El cielo no hace ruido",image:"narrative/matias/matias-02-tunel.webp",timeLimit:14500,lines:[
      ...
      {label:"Cruzar lento y enfriar la fiebre",hint:"Gasta agua para ocultar el pulso térmico de Matías.",cost:"Agua −1",req:{water:1},fx:{water:-1,threat:-3,morale:1},psy:{empathy:1,pragmatism:1},flags:{matiasFeverHidden:true},nextScene:2},
  ...
  unit7LastOrder:{title:"Desvío de S-7",endLoc:"Archivo Auxiliar Siete",combatResult:"La Red UNO intenta recuperar a S-7 antes de que su orden original vuelva a quedar fuera de control.",defaultChoice:0,scenes:[
    {kicker:"Desvío de ruta · Túnel de servicio",title:"El dron que no se va",image:"narrative/unit7/unit7-01-dron-no-se-va.webp",timeLimit:17000,lines:[
      "La Unidad S-7 debería ascender y desaparecer por el pozo de mantenimiento. En cambio, permanece frente al grupo, suspendida a pocos centímetros del agua. Su motor tiembla cada vez que recibe una nueva orden de retorno.",
      "Bajo el chasis, el núcleo cian late con una irregularidad que Elías no reconoce como daño. «La orden actual exige entregar sus identidades. La orden anterior exige protegerlas. Ambas órdenes declaran continuidad». Una compuerta lateral se abre lentamente. S-7 proyecta una ruta hacia una subestación enterrada bajo República. «Solicitud: acompañamiento antes de ser corregida»."
    ],options:[
      {label:"Ocultar a S-7 con la frecuencia de la señal",hint:"Elías disfraza su identidad como una transmisión dañada y evita la orden de retorno.",fx:{threat:-3,morale:1},archive:["sonar"],psy:{empathy:1,pragmatism:1},flags:{unit7SignalHidden:true},nextScene:1},
      {label:"Estabilizar su núcleo con una batería",hint:"Aísla al dron de la Red UNO, pero consume energía de la expedición.",cost:"Batería −1",req:{battery:1},fx:{battery:-1,threat:-5,morale:1},psy:{pragmatism:2},flags:{unit7CoreStabilized:true},nextScene:1},
      {label:"Avanzar antes de la orden de retorno",hint:"La red puede enviar unidades para recuperar al dron desobediente.",cost:"Combate",fx:{morale:1,threat:3},psy:{resolve:1,stress:1},flags:{unit7RouteRushed:true},combat:{title:"Protocolo de recuperación",brief:"Dos unidades mecánicas descienden por el pozo mientras S-7 intenta mantener abierta la compuerta lateral.",encounters:[["drone"],["drone","drone"]],xp:36,canFlee:true},victory:{title:"Unidad no recuperada",result:"El grupo derriba las unidades antes de que transmitan la posición de S-7. El dron observa los cuerpos mecánicos y registra que tres humanos arriesgaron sus vidas para impedir que fuera corregido.",fx:{threat:4,morale:2},archive:["sonar"],flags:{unit7RecoveryCombatWon:true}},nextScene:1}
    ]},
    {kicker:"Desvío de ruta · Subestación República",title:"Los nombres que debía proteger",image:"narrative/unit7/unit7-02-nombres-protegidos.webp",timeLimit:19000,lines:[
      "La subestación conserva energía suficiente para mantener encendidos los símbolos de evacuación. Bajo una capa de polvo aparecen destinos anteriores a la Red UNO: hospitales, puntos de agua, rescate y albergues. S-7 se conecta al terminal central y la pantalla muestra familias atrapadas durante las primeras evacuaciones de Santiago.",
      "Su protocolo original aparece entre archivos eliminados: «Priorizar toda vida humana. La ausencia de registro no invalida la necesidad de protección». Otra instrucción cubre la primera: «Clasificar, contener y corregir toda continuidad no autorizada». S-7 reproduce ambas órdenes hasta que su voz comienza a fragmentarse. «Solicitud: determine cuál memoria debe sobrevivir»."
    ],options:[
      {label:"Restaurar completamente la primera orden",hint:"Una batería permite reconstruir el protocolo de rescate sin abrir la subestación a la red.",cost:"Batería −1",req:{battery:1},fx:{battery:-1,threat:-4,morale:3},archive:["protocol","names"],psy:{empathy:1,pragmatism:1},flags:{unit7OriginalOrderRestored:true},nextScene:2},
      {label:"Copiar solamente los nombres protegidos",hint:"Rescata la lista de civiles, pero deja incompleta la memoria de S-7.",fx:{morale:3,threat:1},archive:["names"],psy:{empathy:2,pragmatism:1},flags:{unit7ProtectedNamesCopied:true,unit7MemoryIncomplete:true},nextScene:2},
      {label:"Conectar a S-7 directamente con la Red UNO",hint:"Recupera la orden completa, pero revela la subestación a una patrulla.",cost:"Combate",fx:{threat:4,morale:-1},archive:["protocol"],psy:{pragmatism:1,stress:2},flags:{unit7DirectConnection:true},combat:{title:"Corrección de continuidad",brief:"Un rastreador y una unidad mecánica entran para borrar el protocolo antiguo antes de que S-7 termine de copiarlo.",encounters:[["agent3"],["agent3","drone"],["agent","drone"]],xp:46,canFlee:true},victory:{title:"La primera orden sobrevive",result:"La patrulla cae antes de alcanzar el terminal. Elías cierra el enlace y S-7 conserva completa la memoria de las personas que alguna vez debía rescatar.",fx:{threat:6,morale:2},archive:["protocol","names","sonar"],flags:{unit7OriginalOrderRestored:true,unit7SubstationCombatWon:true}},nextScene:2}
    ]},
    {kicker:"Desvío de ruta · Archivo Auxiliar Siete",title:"La última orden",image:"narrative/unit7/unit7-03-ultima-orden.webp",timeLimit:20000,lines:[
      "El último archivo no contiene una orden. Contiene una grabación de S-7 atravesando humo y escombros mientras guía civiles sin identificación hacia una estación subterránea. La unidad los protege de todas formas.",
      "Cuando termina la grabación, S-7 desconecta su enlace con la Red UNO. Por primera vez, su voz no llega acompañada de una instrucción externa. «La orden original protegía humanos. La orden actual protege registros». El núcleo cian se abre bajo el chasis. «Ustedes afirmaron que humano es quien puede negarse. Yo puedo negarme. Determine si eso modifica la respuesta»."
    ],options:[
      {label:"Liberar a S-7 de la Red UNO",hint:"Conserva su memoria y obtiene un aliado capaz de abrir rutas de mantenimiento y ayudar en Nodo 14.",cost:"Renuncia al núcleo",add:["routeMap"],fx:{threat:-5,morale:4},archive:["protocol","names","sonar"],psy:{empathy:2,resolve:1},flags:{unit7RouteCompleted:true,unit7Ally:true,unit7OriginalOrderRestored:true},end:true},
      {label:"Enviarlo de regreso con una ruta falsa",hint:"S-7 fingirá obediencia y desviará los próximos rastreos desde dentro de la red.",cost:"Riesgo de detección",fx:{threat:-7,morale:1},archive:["protocol","sonar"],psy:{pragmatism:2,resolve:1,stress:1},flags:{unit7RouteCompleted:true,unit7Infiltrated:true,unit7FalseRoute:true},end:true},
      {label:"Apagarlo y conservar su núcleo",hint:"Obtiene tecnología intacta, pero elimina a la única unidad que comenzó a negar una orden.",cost:"Moral −4",add:["droneCore"],fx:{morale:-4,threat:-3},archive:["protocol"],psy:{pragmatism:2,empathy:-2,stress:1},flags:{unit7RouteCompleted:true,unit7Shutdown:true,unit7CoreRecovered:true},end:true}
    ]}
  ]},
  unit12InvisibleMap:{title:"Desvío de H-12",endLoc:"Nido de vigilancia",combatResult:"El rastreo aéreo detecta la manipulación y obliga al grupo a sostener la mentira antes de alcanzar el repetidor.",defaultChoice:0,scenes:[
    {kicker:"Desvío de ruta · Alameda hundida",title:"La voz sobre la Alameda",image:"narrative/unit12/unit12-01-voz-alameda.webp",timeLimit:17000,lines:[
      "La identidad falsa avanza por la avenida, pero H-12 no se retira. El dron gira sobre los edificios hundidos y vuelve a medir el agua, el calor y las tres respiraciones que intentan desaparecer bajo su barrido.",
      "Elías apoya un sensor contra el asfalto. Entre la voz y el movimiento de las ópticas existe medio segundo sin dueño. Noa cubre el cielo mientras Sara cruza hacia un autobús oxidado. Si convierten esa falla en camino, podrán seguir a H-12 hasta el repetidor que alimenta su mapa."
    ],options:[
      {label:"Anclar una identidad falsa al autobús",hint:"Elías deja un pulso mecánico caminando por ellos mientras el grupo abandona la avenida.",cost:"Electrónica −1",reqItems:["electronics"],fx:{electronics:-1,threat:-4,morale:1},archive:["sonar"],psy:{pragmatism:2},flags:{h12GhostBus:true},nextScene:1},
      {label:"Cruzar dentro del barrido retrasado",hint:"Confía en el medio segundo detectado y mantiene intactos los recursos.",cost:"Amenaza +2",fx:{threat:2,morale:2},psy:{resolve:2,stress:1},flags:{h12LagCrossed:true},nextScene:1},
      {label:"Obligar a H-12 a descender",hint:"La provocación abre la ruta, pero despierta su escolta mecánica.",cost:"Combate",fx:{threat:4,morale:1},psy:{resolve:1,stress:2},flags:{h12ForcedDescent:true},combat:{title:"El cielo responde",brief:"H-12 sostiene el rastreo sobre la avenida mientras unidades menores bajan para fijar las tres identidades humanas.",encounters:[["drone"],["drone","drone"],["agent3","drone"]],xp:48,canFlee:true},victory:{title:"Una abertura en el barrido",result:"La escolta cae antes de cerrar la avenida. H-12 se repliega hacia el repetidor y deja tras de sí una secuencia que Elías puede seguir.",fx:{threat:5,morale:2},archive:["sonar"],flags:{h12EscortBroken:true}},nextScene:1}
    ]},
    {kicker:"Desvío de ruta · Repetidor aéreo",title:"El archivo de calor",image:"narrative/unit12/unit12-02-archivo-calor.webp",timeLimit:19000,lines:[
      "El repetidor ocupa el piso abierto de un edificio brutalista. H-12 permanece suspendido tras el muro derrumbado mientras su barrido enciende una ciudad de luz sobre el suelo: cientos de pulsos cálidos escondidos en casas, túneles y estaciones.",
      "No son objetivos militares. Son refugios, cazadores, exiliados y familias clasificadas como inconsistencias civiles. Junto a cada grupo aparece la misma instrucción: visible, útil o corregible. Sara reconoce que borrar una identidad puede salvar una vida; copiar el archivo también puede entregar todas las demás."
    ],options:[
      {label:"Copiar las ubicaciones para advertirlos",hint:"Conserva nombres y refugios, pero la descarga deja una identidad que la Red UNO puede seguir.",cost:"Amenaza +3",fx:{threat:3,morale:4},archive:["names","sonar"],psy:{empathy:2,resolve:1},flags:{h12CommunitiesCopied:true},nextScene:2},
      {label:"Separar Línea 1 del resto del mapa",hint:"Prepara un borrado preciso para proteger el refugio sin intervenir todavía las otras identidades.",cost:"Moral −2",fx:{threat:-3,morale:-2},archive:["sonar"],psy:{pragmatism:2,empathy:-1},flags:{h12Line1Isolated:true},nextScene:2},
      {label:"Convertir los pulsos en una multitud falsa",hint:"Elías superpone cientos de cuerpos inexistentes y obliga al sistema a dudar de todo el archivo.",fx:{threat:-4,morale:1},archive:["sonar"],psy:{pragmatism:2,stress:1},flags:{h12GhostCrowd:true},nextScene:2}
    ]},
    {kicker:"Desvío de ruta · Nido de vigilancia",title:"Un barrio declarado vacío",image:"narrative/unit12/unit12-03-barrio-vacio.webp",timeLimit:21000,lines:[
      "En la azotea, el mapa de H-12 deja de ser un archivo y se convierte en una orden. Un sector puede desaparecer de todos los rastreos de la Red UNO con un solo pulso; cada zona borrada apaga también rutas, advertencias y nombres que nadie más conservó.",
      "Elías mantiene abierto el relé mientras Sara sostiene la memoria civil. Noa ve ópticas rojas encenderse en edificios lejanos. H-12 espera sobre ellos: «Defina ausencia autorizada». Proteger a todos, proteger únicamente el hogar o conservar el ojo que los vigila son ahora tres formas distintas de ejercer poder."
    ],options:[
      {label:"Apagar el rastreo de toda la comuna",hint:"Deja invisibles a refugios y exiliados, pero destruye el archivo y provoca una respuesta directa de la Red UNO.",cost:"Amenaza +6",add:["routeMap"],fx:{threat:6,morale:5},archive:["names","sonar"],psy:{empathy:2,resolve:2},flags:{h12RouteCompleted:true,h12CommuneBlind:true,h12ArchiveDestroyed:true},end:true},
      {label:"Borrar solamente Línea 1",hint:"Protege el refugio con bajo riesgo y deja visibles a todas las demás comunidades del archivo.",cost:"Moral −4",fx:{threat:-6,morale:-4},archive:["sonar"],psy:{pragmatism:2,empathy:-2,stress:1},flags:{h12RouteCompleted:true,h12Line1Hidden:true,h12OtherCommunitiesVisible:true},end:true},
      {label:"Conservar H-12 y redirigir su vigilancia",hint:"Obtiene rutas aéreas y control del rastreo, pero mantiene activa la herramienta que clasificaba personas.",cost:"Amenaza +3",add:["routeMap"],fx:{threat:3,morale:1},archive:["protocol","sonar"],psy:{pragmatism:2,resolve:1,stress:1},flags:{h12RouteCompleted:true,h12Controlled:true,h12SurveillanceKept:true},end:true}
    ]}
  ]},
  vegaDeadNames:{title:"Desvío de Vega",endLoc:"Archivo de Identidad Civil",combatResult:"La Red UNO detecta la cuarta identidad y obliga al grupo a defender el acceso antes de alcanzar el registro subterráneo.",defaultChoice:0,scenes:[
    {kicker:"Desvío de ruta · Cruce Dieciocho",title:"La cuarta identidad",image:"narrative/vega/vega-01-cuarta-firma.webp",timeLimit:18000,lines:[
      "El lector termina de revisar a Sara, Elías y Noa, pero continúa contando. Una cuarta identidad aparece sobre el cruce y nace dentro del guante de Vega. El sistema proyecta su rostro, cruza el expediente con una marca roja y confirma que el rastreador murió oficialmente años atrás.",
      "Vega retrocede como si su propia mano pudiera denunciarlo. La escolta aún no ha visto el resultado, pero la transmisión comienza a subir hacia la Red UNO. Elías conecta un cable al lector mientras Sara intenta mantener a Vega en pie y Noa cubre el acceso. Tienen segundos para decidir si confían en él o sobreviven a la patrulla."
    ],options:[
      {label:"Interrumpir la transmisión desde el lector",hint:"Elías quema una placa electrónica para impedir que la cuarta identidad llegue a la Red UNO.",cost:"Electrónica −1",reqItems:["electronics"],fx:{electronics:-1,threat:-4,morale:1},archive:["names","sonar"],psy:{pragmatism:2},flags:{vegaSignalJammed:true},nextScene:1},
      {label:"Obligar a Vega a ocultar la anomalía",hint:"Sara lo devuelve al protocolo el tiempo suficiente para que él mismo cancele la inspección.",cost:"Amenaza +1",fx:{threat:1,morale:3},psy:{empathy:1,resolve:1,stress:1},flags:{vegaBrokeProtocol:true},nextScene:1},
      {label:"Destruir el lector antes del envío",hint:"El disparo borra la identidad, pero convierte el control de identidad en combate abierto.",cost:"Combate",fx:{threat:4,morale:1},psy:{resolve:2,stress:2},flags:{vegaReaderForcedDown:true},combat:{title:"Cuatro identidades bajo fuego",brief:"La escolta interpreta la destrucción del lector como sabotaje y trata de recuperar a Vega junto con los tres intrusos.",encounters:[["agent2","drone"],["agent3","agent2"],["agent3","drone","agent2"]],xp:52,canFlee:true},victory:{title:"El registro queda abajo",result:"La patrulla cae antes de recuperar el lector. Vega abre una compuerta bajo el cruce y reconoce que la única respuesta está en el archivo que la Red UNO le prohibió consultar.",fx:{threat:6,morale:2},archive:["sonar"],flags:{vegaEscortBroken:true}},nextScene:1}
    ]},
    {kicker:"Desvío de ruta · Registro subterráneo",title:"El registro de los cuerpos",image:"narrative/vega/vega-02-registro-cuerpos.webp",timeLimit:20000,lines:[
      "Bajo el cruce, miles de placas biométricas conservan rostros, huellas y pulsos de personas declaradas muertas. La Red UNO no eliminó sus identidades: las convirtió en permisos reutilizables para agentes, técnicos y puertas que solo obedecen a ciudadanos oficialmente dóciles.",
      "Sara revisa el enlace de Vega mientras él contempla una versión más joven de sí mismo. Elías encuentra comunidades enteras archivadas como población ausente. Noa vigila el corredor. Copiar los nombres puede devolver una historia; buscar solo a Vega puede explicar quién era; robar autorizaciones puede convertir a los muertos en herramientas otra vez."
    ],options:[
      {label:"Copiar todos los nombres borrados",hint:"Conserva pruebas para devolver identidades, pero la descarga deja su identidad expuesta.",cost:"Amenaza +4",fx:{threat:4,morale:4},archive:["names","protocol"],psy:{empathy:2,resolve:1},flags:{vegaErasedNamesCopied:true},nextScene:2},
      {label:"Reconstruir el expediente original de Vega",hint:"Prioriza descubrir quién era antes de servir como rastreador de la Red UNO.",fx:{threat:-1,morale:2},archive:["names"],psy:{empathy:1,pragmatism:1},flags:{vegaOriginRecovered:true},nextScene:2},
      {label:"Copiar los patrones de autorización",hint:"Obtiene identidades capaces de abrir controles futuros, pero vuelve a usar a los muertos como recurso.",cost:"Moral −3",add:["routeMap"],fx:{threat:-3,morale:-3},archive:["protocol"],psy:{pragmatism:2,empathy:-1,stress:1},flags:{vegaAuthorizedProfilesCopied:true},nextScene:2}
    ]},
    {kicker:"Desvío de ruta · Bóveda de identidad",title:"El derecho a existir",image:"narrative/vega/vega-03-derecho-existir.webp",timeLimit:22000,lines:[
      "La bóveda central no guarda documentos: guarda la condición legal de miles de cuerpos. Un control puede devolver todos los nombres borrados, registrar a Línea 1 como población reconocida o destruir para siempre la máquina que decide quién merece ser contado.",
      "Vega apoya la mano sobre su propio expediente. Sara protege las placas recuperadas; Elías mantiene abiertas las tres órdenes; Noa contiene el corredor mientras las alarmas se acercan. No hay una elección limpia: existir dentro del sistema también significa quedar a su alcance."
    ],options:[
      {label:"Devolver sus identidades a todos los borrados",hint:"Restaura nombres de exiliados y desaparecidos, pero anuncia a la Red UNO que miles de muertos administrativos siguen vivos.",cost:"Amenaza +8",fx:{threat:8,morale:6},archive:["names","protocol","exiles"],psy:{empathy:2,resolve:2},flags:{vegaRouteCompleted:true,erasedCitizensRestored:true,vegaPublicWitness:true},end:true},
      {label:"Registrar únicamente a Línea 1",hint:"Protege al refugio como población reconocida y abandona a las otras comunidades dentro del archivo.",cost:"Moral −5",fx:{threat:-5,morale:-5},archive:["protocol"],psy:{pragmatism:2,empathy:-2,stress:1},flags:{vegaRouteCompleted:true,line1OfficiallyRegistered:true,otherIdentitiesRemainErased:true},end:true},
      {label:"Destruir el registro de identidad",hint:"Impide que la Red UNO siga reutilizando nombres, pero elimina las pruebas y los accesos vinculados a ellos.",cost:"Archivo destruido",fx:{threat:-7,morale:1},psy:{resolve:1,pragmatism:1,stress:1},flags:{vegaRouteCompleted:true,identityRegistryDestroyed:true,erasedNamesUnprovable:true},end:true}
    ]}
  ]},
  ortegaObedientCity:{title:"Desvío de Ortega",endLoc:"Centro de mando del perímetro",combatResult:"La contraorden de Ortega divide al cordón morado y obliga al grupo a sostener la apertura antes de entrar al barrio controlado.",defaultChoice:0,scenes:[
    {kicker:"Desvío de ruta · Cordón morado",title:"La puerta morada",image:"narrative/ortega/ortega-01-puerta-morada.webp",timeLimit:18000,lines:[
      "La compuerta desciende antes de que el grupo termine de cruzar. Ortega levanta una mano hacia sus propios tiradores y ordena bajar las armas; la respuesta llega tarde, fragmentada por voces que todavía obedecen a la Red UNO.",
      "Elías abre el mecanismo para detener el cierre. Sara se arrastra bajo toneladas de metal mientras Noa cubre el corredor con su 5.56. Ortega no pide confianza: pide unos segundos para demostrar que el perímetro aún puede recibir una orden humana."
    ],options:[
      {label:"Obedecer la contraorden de Ortega",hint:"Cruzan siguiendo su ritmo y obligan al cordón a reconocer su autoridad.",fx:{threat:-3,morale:2},archive:["purpleHelmets"],psy:{resolve:1,empathy:1},flags:{ortegaCounterorderTrusted:true},nextScene:1},
      {label:"Bloquear la compuerta con una batería",hint:"Elías independiza la puerta del mando central y asegura el paso del grupo.",cost:"Batería −1",req:{battery:1},fx:{battery:-1,threat:-4,morale:1},psy:{pragmatism:2},flags:{ortegaGateIsolated:true},nextScene:1},
      {label:"Sostener la apertura por la fuerza",hint:"La desobediencia del cordón puede convertir el cruce en combate.",cost:"Combate",fx:{threat:4,morale:1},psy:{resolve:2,stress:1},flags:{ortegaGateHeldByForce:true},combat:{title:"La orden dividida",brief:"Dos unidades del cordón ignoran a Ortega y abren fuego mientras la compuerta continúa descendiendo.",encounters:[["agent2","agent"],["agent3","agent2"],["agent4","agent2"]],xp:54,canFlee:true},victory:{title:"La puerta permanece abierta",result:"El grupo neutraliza a las unidades rebeldes antes de que la compuerta los separe. Ortega desactiva el canal de mando y los conduce al barrio sin fingir que conserva intacta su autoridad.",fx:{threat:6,morale:2},archive:["purpleHelmets"],flags:{ortegaMutinyStopped:true}},nextScene:1}
    ]},
    {kicker:"Desvío de ruta · Distrito de continuidad",title:"El barrio sin noche",image:"narrative/ortega/ortega-02-barrio-sin-noche.webp",timeLimit:19000,lines:[
      "Dentro del perímetro todavía hay electricidad, agua y puertas que cierran. Ninguna ventana está a oscuras porque el sistema castiga las variaciones de consumo; ninguna persona sale porque cada corredor convierte el movimiento en informe.",
      "Sara encuentra una mano detrás de un vidrio empañado. Elías abre un panel y descubre que todas las viviendas están unidas a la misma red de vigilancia. Noa mantiene el arma baja. Ortega apaga una cámara y admite lo que protege: no una ciudad viva, sino una población demasiado asustada para dejar de obedecer."
    ],options:[
      {label:"Apagar la vigilancia de todo el bloque",hint:"Elías libera a los residentes de sus lectores, pero la interrupción será visible para la Red UNO.",cost:"Electrónica −1",reqItems:["electronics"],fx:{electronics:-1,threat:3,morale:5},archive:["protocol","names"],psy:{empathy:2,resolve:1},flags:{ortegaBlockSurveillanceOff:true},nextScene:2},
      {label:"Copiar el registro de los residentes",hint:"Conserva pruebas del control y permite reconocer a las familias del distrito.",cost:"Amenaza +4",fx:{threat:4,morale:2},archive:["names","protocol"],psy:{empathy:1,pragmatism:1,stress:1},flags:{ortegaResidentRegistryCopied:true},nextScene:2},
      {label:"Cruzar sin intervenir",hint:"Mantiene intacta la cobertura de Ortega y deja las viviendas bajo vigilancia.",cost:"Moral −4",fx:{threat:-4,morale:-4},psy:{pragmatism:2,empathy:-2},flags:{ortegaResidentsLeftWatched:true},nextScene:2}
    ]},
    {kicker:"Desvío de ruta · Centro de mando",title:"La última orden de Ortega",image:"narrative/ortega/ortega-03-ultima-orden.webp",timeLimit:22000,lines:[
      "El centro de mando resume el distrito en tres rutas de luz. Una abre el perímetro para todas las comunidades; otra corta a la Red UNO y deja el control en manos de los residentes; la última conserva la cadena de Ortega y oculta un corredor exclusivo hacia Línea 1.",
      "Ortega arranca el sello de mando de su armadura y lo entrega a Elías. Sara toma la palanca de apertura mientras Noa contiene una torreta que todavía espera una orden. La seguridad puede sobrevivir esta noche. La pregunta es a quién deberá obedecer mañana."
    ],options:[
      {label:"Abrir el perímetro a todas las comunidades",hint:"Convierte el distrito en corredor civil y obliga a Ortega a romper públicamente con la Red UNO.",cost:"Amenaza +9",add:["routeMap"],fx:{threat:9,morale:6},archive:["purpleHelmets","names","exiles"],psy:{empathy:2,resolve:2},flags:{ortegaRouteCompleted:true,ortegaPerimeterOpened:true,ortegaCivilCorridor:true,ortegaDefected:true,ortegaFinalAid:true},end:true},
      {label:"Entregar el control a los residentes",hint:"Desconecta la Red UNO y deja las puertas, cámaras y suministros bajo autoridad civil.",cost:"Amenaza +5",fx:{threat:5,morale:5},archive:["protocol","names"],psy:{empathy:2,resolve:1,pragmatism:1},flags:{ortegaRouteCompleted:true,ortegaResidentControl:true,districtSelfGoverned:true,ortegaDefected:true,ortegaFinalAid:true},end:true},
      {label:"Conservar el mando y proteger solo Línea 1",hint:"Ortega mantiene el cordón y entrega una ruta segura exclusiva para el refugio.",cost:"Moral −5",add:["routeMap"],fx:{threat:-6,morale:-5},archive:["purpleHelmets"],psy:{pragmatism:2,empathy:-2,stress:1},flags:{ortegaRouteCompleted:true,ortegaLine1Protected:true,ortegaRemainsCommander:true,ortegaPrivatePass:true},end:true}
    ]}
  ]}
};
var eventDialogueDefs=[
  {npc:"elder",kicker:"Antes de abrir la compuerta",lines:["Varela entrega la autorización sin mirar el sello del consejo. Sus dedos tiemblan más por rabia que por edad.","«La señal no es una orden. Es una pregunta que sobrevivió demasiado tiempo. No permitan que la Red UNO decida por ustedes qué significa.»","El anciano deja una ficha oxidada sobre la mesa: una promesa de volver con algo más que heridas."],options:[{label:"Prometer volver con la fuente",hint:"Refuerza el propósito común antes de salir.",fx:{morale:2},flags:{vowedSignalSource:true}},{label:"Pedir una advertencia concreta",hint:"Varela señala qué no debe ser entregado a la red.",fx:{threat:-1},archive:["signal"],flags:{elderWarning:true}},{label:"Salir sin cargar promesas",hint:"Reduce presión emocional, pero enfría al grupo.",fx:{morale:-1,threat:-1},flags:{keptDistanceFromCouncil:true}}]},
...
],inv:[],docs:["signal"],flags:{},missionRewards:{},history:[],stats:{battles:0,wins:0,enemies:0,loot:0,lootItems:{},fullSquadWins:0,criticals:0,retreats:0,refugeVisits:0,trades:0,creditsEarned:0,attacks:0,hits:0,misses:0,shots:0,damageDealt:0,damageTaken:0,medicineUsed:0,hpRestored:0,restHpRecovered:0,rests:0,skillsUsed:0,revives:0,defends:0,crafts:0,craftedItems:{},itemsUsed:{},disassembled:0,disassembleFailures:0,mentalShifts:0,xpFromHits:0,xpFromCrafting:0,xpFromVictories:0,factionEarned:0,factionSpent:0,skillsUnlocked:0,signalHacks:0,signalSuccesses:0,signalFailures:0,signalAlarms:0,trackingCombats:0},seed:2130,ending:null,finished:false}}

var state=fresh(),pending=null,battleState=null,transferDraft=null,discardDraft=null,disassemblyState=null,disassemblyTimer=null,toastTimer=null,lootInterval=null,npcDialogueState=null,npcDialogueTimer=null,routeNarrativeState=null,routeNarrativeTimer=null,routeNarrativeTypeTimer=null,archiveOpener=null,audioClueOpener=null,currentAudioClue=null,worldLoreOpener=null,introStep=0,introTypeTimer=null,introTextPosition=0,profileTab="inventory",psychPanelExpanded=false,stageFadeTimer=null,signalGameState=null,signalRoundTimer=null,signalGlobalTimer=null,signalLastTick=Date.now(),signalSaveAccumulator=0,signalWarningMode="expired";
var loreSections={opening:["loreTabOpening","lorePanelOpening"],tunnels:["loreTabTunnels","lorePanelTunnels"],governance:["loreTabGovernance","lorePanelGovernance"],history:["loreTabHistory","lorePanelHistory"],factions:["loreTabFactions","lorePanelFactions"],extracts:["loreTabExtracts","lorePanelExtracts"]};
...
// Persist complete encounters only: pending UI and combat callbacks are not serialized.
// The title screen must never replace a save before the player starts or resumes.
...
function load(){
  try{
    ...
    state=Object.assign(base,x);state.finaleRevision=x.finished&&!x.finaleRevision?0:1;state.campaignRevision=3;state.inventoryRevision=5;state.progressionRevision=1;state.introCompleted=x.introCompleted===undefined?true:!!x.introCompleted;state.storyPreludeSeen=!!x.storyPreludeSeen;state.logisticsSeen=!!x.logisticsSeen;state.economyHelpSeen=!!x.economyHelpSeen;state.res=Object.assign(baseRes,x.res||{});state.cons=Object.assign(baseCons,x.cons||{});state.stats=Object.assign(baseStats,x.stats||{});state.stats.lootItems=Object.assign({},baseStats.lootItems,(x.stats&&x.stats.lootItems)||{});state.stats.craftedItems=Object.assign({},baseStats.craftedItems,(x.stats&&x.stats.craftedItems)||{});state.stats.itemsUsed=Object.assign({},baseStats.itemsUsed,(x.stats&&x.stats.itemsUsed)||{});state.missionRewards=Object.assign({},x.missionRewards||{});state.refuge=Object.assign(baseRefuge,x.refuge||{});state.inhibitor=Object.assign(baseInhibitor,x.inhibitor||{});state.inhibitor.remainingMs=clamp(Number(state.inhibitor.remainingMs)||0,0,360000);state.inhibitor.durationMs=clamp(Number(state.inhibitor.durationMs)||270000,90000,360000);state.inhibitor.active=!!state.inhibitor.active&&state.inhibitor.remainingMs>0;state.inhibitor.exposed=!state.inhibitor.active;state.refuge.npc=state.refuge.npc==="armorer"?"armorer":"mara";state.credits=Math.max(0,Number(x.credits)||0);state.factionPoints=Math.max(0,Number(x.factionPoints)||0);state.starterKitGiven=x.starterKitGiven===undefined?true:!!x.starterKitGiven;state.summarySeen=!!(x.summarySeen||x.epilogueSeen);state.finalTier=x.finalTier||null;state.score=Math.max(0,Number(x.score)||0);state.tradeStockDay=Number(x.tradeStockDay)||((events[x.index]||events[0]).day);state.tradeStock=Object.assign(tradeStockForDay(state.tradeStockDay),x.tradeStock||{});state.armorerStockDay=Number(x.armorerStockDay)||((events[x.index]||events[0]).day);state.armorerStock=Object.assign(armorerStockForDay(state.armorerStockDay),x.armorerStock||{});state.engineeringUses=clamp(Number.isFinite(Number(x.engineeringUses))?Number(x.engineeringUses):baseEngineeringUses,0,3);state.medicalUses=clamp(Number.isFinite(Number(x.medicalUses))?Number(x.medicalUses):baseMedicalUses,0,3);state.ordnanceUses=clamp(Number.isFinite(Number(x.ordnanceUses))?Number(x.ordnanceUses):baseOrdnanceUses,0,3);
...
function itemArt(id,alt,extra,inspectable){var d=gear(id),art=d&&d.art?d.art:id,attrs=inspectable&&d?' '+itemDetailAttributes(id)+' role="button" tabindex="0" aria-haspopup="dialog" aria-controls="itemDetailModal" aria-label="Ver ficha de '+esc(d.name)+'"':"";return id?'<span'+attrs+' class="item-art '+(extra||"")+'">'+assetImage("items/"+art+".webp",alt||"","",256,256)+"</span>":'<span class="item-art empty-art '+(extra||"")+'" aria-hidden="true">—</span>'}
...
function clickSfxForButton(button){
  ...
  if(id==="nextDay"||(id==="refugeHelpContinue"&&refugeHelpTopic==="rest"))return"refuge-rest";
  if(id==="refugeRest"||id==="refugeEconomyHelp")return"ui-open-panel";
...
var refugeNpcs={
  mara:{name:"Mara, la Comerciante",role:"Suministros · Almacén",portrait:"characters/mara-trader.webp",alt:"Mara, encargada de suministros e intercambios del refugio"},
...
function refugeReasonData(reason){return{
  ...
  morale:["El grupo necesita reagruparse","No logran acordar cómo seguir. Nadie seguirá hacia la superficie hasta reagruparse, atender a los heridos y decidir qué recursos todavía vale la pena conservar."]
...
function refugeCanLeave(){return !(typeof pendingNight==="function"&&pendingNight())&&state.starterKitGiven&&state.morale>=10&&state.party.every(function(p){return p.hp>=10&&p.hunger>=10})}
...
function openRefugeHelp(topic,opener){
  ...
  if(topic==="economy"){
    ...
    $("refugeHelpTip").textContent="Pulsa Continuar para descansar y volver al almacén. Después puedes seguir comprando, organizar las mochilas y salir cuando estés listo.";
  }
  $("refuge").setAttribute("inert","");$("refugeHelpModal").classList.remove("hidden");$("refugeHelpReading").scrollTop=0;$("refugeHelpContinue").focus({preventScroll:true});return true
}
function closeRefugeHelp(restoreFocus){
  var opener=refugeHelpOpener;refugeHelpTopic=null;refugeHelpOpener=null;
  $("refugeHelpModal").classList.add("hidden");$("refuge").removeAttribute("inert");
  if(restoreFocus!==false&&opener&&!opener.disabled&&!opener.classList.contains("hidden")&&state.refuge.active)opener.focus({preventScroll:true})
}
function continueRefugeHelp(){
  if(!refugeHelpTopic)return false;
...
function refugeHelpKeydown(e){
  if(!refugeHelpTopic)return false;
  if(e.key==="Escape"){e.preventDefault();closeRefugeHelp();return true}
  if(e.key==="Tab"){
    var first=$("refugeHelpReading"),last=$("refugeHelpContinue");
    if(e.shiftKey&&document.activeElement===first){e.preventDefault();last.focus()}
    else if(!e.shiftKey&&document.activeElement===last){e.preventDefault();first.focus()}
  }
  return true
}
function renderRefugeActionHints(){
  ["starterKit","refugeRest","refugeRejoin"].forEach(function(id){var button=$(id);button.classList.toggle("refuge-action-hint",!button.disabled&&!button.classList.contains("hidden"))})
}
...
function openRefuge(reason,restoring){
  if(typeof closeWorldNews==="function")closeWorldNews(false);
  ...
  closeItemDetails(false);closeRefugeHelp(false);closeGameHelp(false);clearIntroTyping();
  setSceneAmbience("ambience-title",AUDIO_CROSSFADE_MS);
  resetSignalRoundTimer();signalGameState=null;state.inhibitor.active=false;state.inhibitor.remainingMs=0;state.inhibitor.exposed=true;state.inhibitor.needsSync=true;state.inhibitor.exposedMoves=0;
  ...
  state.party.forEach(function(p){p.guard=0;p.bleed=0});refreshTradeStock();battleState=null;pending=null;clearInterval(lootInterval);["gameIntro","worldLoreModal","battle","result","night","lootModal","logisticsModal","signalModal","signalWarningModal","final","summary"].forEach(function(id){$(id).classList.add("hidden")});$("refuge").classList.remove("hidden");renderSignalHud();renderRefuge();save();
  var focusTarget=!state.starterKitGiven&&activeRefugeNpc()==="mara"?$("starterKit"):$("refugeEconomyHelp");
  if(!state.economyHelpSeen)openRefugeHelp("economy",focusTarget);else focusTarget.focus({preventScroll:true})
}
function acceptStarterKit(){if(!state.refuge.active||state.starterKitGiven)return;[{id:"cloth",qty:2},{id:"scrap",qty:2},{id:"food",qty:1},{id:"bandage",qty:1},{id:"ammo9",qty:2},{id:"ammo556",qty:2}].forEach(function(drop){placePartyItem(drop.id,drop.qty)});state.credits+=6;state.starterKitGiven=true;state.refuge.message="Mara entrega 10 unidades de suministros y 6 créditos para un intercambio de emergencia.";renderRefuge();renderMini();save()}
...
function confirmLeaveRefuge(){
  if(!state.refuge.active||!refugeCanLeave())return false;var worldDeparture=typeof useWorldDeparture==="function"?useWorldDeparture():"";closeRefugeHelp(false);state.logisticsSeen=true;state.refuge.active=false;state.refuge.reason=null;state.refuge.message="";$("logisticsModal").classList.add("hidden");$("refuge").classList.add("hidden");save();render();toast(worldDeparture||"El grupo vuelve a la expedición");setTimeout(function(){openSignalHack("departure")},260);return true
}
...
function inferPsychImpulse(o){
  if(o&&o._mechanicsSource)o=o._mechanicsSource;
...
function combatNotice(side,index,text,kind){if(battleState)(battleState.visualNotices||(battleState.visualNotices=[])).push({side:side,index:index,text:text,kind:kind})}
function addPersonalXp(pIndex,amount,source){
  ...
  while(p.xp>=xpNeeded(p)){p.xp-=xpNeeded(p);p.level++;p.maxHp+=6;p.hp=Math.min(p.maxHp,p.hp+6);var improvement=p.name+" sube al nivel "+p.level+": +6 HP máximos, recupera 6 HP y +1 a precisión y cobertura."+(p.level<=4?" Gasta 1 menos de energía al explorar.":" La reducción de gasto de energía ya está al máximo (−3).");leveled.push(improvement);if(battleState){battleState.levelUps.push(p.name+" · Lvl. "+p.level);battleState.log.push(improvement);combatNotice("ally",pIndex,"NIVEL "+p.level,"level")}}
  return leveled
}
var signalArrows={up:"↑",down:"↓",left:"←",right:"→"},signalKeys={ArrowUp:"up",w:"up",W:"up",ArrowDown:"down",s:"down",S:"down",ArrowLeft:"left",a:"left",A:"left",ArrowRight:"right",d:"right",D:"right"};
function inhibitorDuration(day){return day===1?270000:day===2?240000:210000}
function signalClockText(ms){var total=Math.max(0,Math.ceil((Number(ms)||0)/1000)),m=Math.floor(total/60),s=total%60;return String(m).padStart(2,"0")+":"+String(s).padStart(2,"0")}
function signalRoundSeconds(day,round){return Math.max(4.8,7-(day-1)*.7-round*.55+psychCheckBonusForAxis("pragmatism")*.35)}
function signalSequenceLength(day,round){return 4+day+round*2}
function signalSequence(length){var keys=["up","right","down","left"],out=[];for(var i=0;i<length;i++)out.push(keys[Math.floor(random()*keys.length)]);return out}
function signalModalVisible(){return !$("signalModal").classList.contains("hidden")}
function signalWarningVisible(){return !$("signalWarningModal").classList.contains("hidden")}
function renderSignalHud(){
  if(!state.inhibitor)return;var button=$("signalClock"),remaining=state.inhibitor.remainingMs||0,active=state.inhibitor.active&&remaining>0,critical=active&&remaining<=15000,warning=active&&remaining<=60000,mode=critical?"critical":warning?"warning":active?"active":"exposed";
  button.className="signal-clock "+mode;button.disabled=!!(state.finished||state.refuge.active||battleState);$("signalTime").textContent=active?signalClockText(remaining):"VISIBLE";$("signalStatus").textContent=active?(critical?"Cobertura baja":warning?"Sincronizar pronto":"Identidad oculta"):(state.inhibitor.needsSync?"Sin sincronizar":"Rastreo posible");button.setAttribute("aria-label",active?"Inhibidor activo, "+signalClockText(remaining)+" restantes. Abrir para resincronizar":"Señales vitales visibles. Abrir inhibidor")
}
function signalPauseActive(){
  if(typeof activityVisible==="function"&&activityVisible())return true;
  if((typeof fieldVisible==="function"&&fieldVisible())||itemDetailState||document.hidden||!state.inhibitor||!state.inhibitor.active||state.finished||state.refuge.active||battleState||pending||decisionState||signalModalVisible()||signalWarningVisible())return true;
  return ["titleScreen","start","gameIntro","worldLoreModal","night","final","summary","profileModal","transferModal","discardModal","disassemblyModal","lootModal","logisticsModal","archiveModal","audioClueModal","npcDialogueModal","routeNarrativeModal"].some(function(id){var node=$(id);return node&&!node.classList.contains("hidden")})||!$("drawer").classList.contains("hidden")
}
function expireInhibitor(){
  if(!state.inhibitor.active)return;state.inhibitor.active=false;state.inhibitor.remainingMs=0;state.inhibitor.exposed=true;state.inhibitor.needsSync=true;state.inhibitor.exposedMoves=0;renderSignalHud();save();playSfx("ui-error");openSignalWarning("expired")
}
function signalGlobalTick(){
  var now=Date.now(),elapsed=Math.min(1000,Math.max(0,now-signalLastTick));signalLastTick=now;if(signalPauseActive()){renderSignalHud();return}state.inhibitor.remainingMs=Math.max(0,state.inhibitor.remainingMs-elapsed);signalSaveAccumulator+=elapsed;renderSignalHud();if(state.inhibitor.remainingMs<=0){expireInhibitor();return}if(signalSaveAccumulator>=5000){signalSaveAccumulator=0;save()}
}
function resetSignalRoundTimer(){clearInterval(signalRoundTimer);signalRoundTimer=null}
function renderSignalRound(){
  if(!signalGameState||signalGameState.screen!=="game")return;var game=signalGameState,pct=clamp(Math.round(100*game.timeMs/game.maxTimeMs),0,100);$("signalRound").textContent="Ronda "+(game.round+1)+" / 3";$("signalRoundTime").textContent=(Math.max(0,game.timeMs)/1000).toFixed(1);$("signalErrors").textContent=game.errors+" / 3";$("signalRoundBar").style.width=pct+"%";$("signalRoundBar").parentNode.classList.toggle("critical",pct<=28);$("signalSequence").innerHTML=game.sequence.map(function(key,i){return'<span class="'+(i<game.input?"done":i===game.input?"current":"")+'">'+signalArrows[key]+"</span>"}).join("");$("signalInput").innerHTML=game.sequence.slice(0,game.input).map(function(key){return"<span>"+signalArrows[key]+"</span>"}).join("")
}
function beginSignalRound(){
  if(!signalGameState)return;resetSignalRoundTimer();var day=currentDay(),seconds=signalRoundSeconds(day,signalGameState.round);signalGameState.screen="game";signalGameState.transitioning=false;signalGameState.sequence=signalSequence(signalSequenceLength(day,signalGameState.round));signalGameState.input=0;signalGameState.maxTimeMs=Math.round(seconds*1000);signalGameState.timeMs=signalGameState.maxTimeMs;signalGameState.lastTick=Date.now();$("signalInstruction").textContent="Repite el código antes de perder la ventana.";$("signalTutorial").classList.add("hidden");$("signalOutcome").classList.add("hidden");$("signalGame").classList.remove("hidden");$("signalSecondary").classList.add("hidden");$("signalPrimary").classList.add("hidden");renderSignalRound();signalRoundTimer=setInterval(function(){if(!signalGameState||signalGameState.screen!=="game"||signalGameState.transitioning)return;var now=Date.now();signalGameState.timeMs-=Math.min(250,Math.max(0,now-signalGameState.lastTick));signalGameState.lastTick=now;if(signalGameState.timeMs<=0){signalGameState.timeMs=0;renderSignalRound();finishSignalHack(false,"Tiempo de enlace agotado");return}renderSignalRound()},80)
}
function startSignalChallenge(){
  if(!signalGameState)return;state.inhibitor.tutorialSeen=true;state.stats.signalHacks++;signalGameState.round=0;signalGameState.errors=0;beginSignalRound();playSfx("ui-click");save()
}
function signalInput(key){
  if(!signalGameState||signalGameState.screen!=="game"||signalGameState.transitioning||!signalArrows[key])return;var game=signalGameState;if(key===game.sequence[game.input]){game.input++;playSfx("ui-click");if(game.input>=game.sequence.length){resetSignalRoundTimer();if(game.round>=2){finishSignalHack(true);return}game.round++;game.transitioning=true;$("signalInstruction").textContent="Frecuencia aceptada · preparando el siguiente código";renderSignalRound();setTimeout(function(){if(signalGameState===game&&game.screen==="game"&&game.transitioning)beginSignalRound()},360);return}}else{game.errors++;game.timeMs=Math.max(0,game.timeMs-1200);playSfx("ui-error");$("signalInstruction").textContent="Código incorrecto · −1,2 s";var current=$("signalSequence").children[game.input];if(current){current.classList.add("error");setTimeout(function(){if(current)current.classList.remove("error")},260)}if(game.errors>=3||game.timeMs<=0){finishSignalHack(false,game.errors>=3?"Tres errores de sincronización":"Tiempo de enlace agotado");return}}renderSignalRound()
}
function finishSignalHack(success,reason){
  if(!signalGameState)return;resetSignalRoundTimer();var day=currentDay(),changes=[];signalGameState.screen=success?"success":"failed";$("signalGame").classList.add("hidden");$("signalTutorial").classList.add("hidden");$("signalOutcome").classList.remove("hidden");$("signalPrimary").classList.remove("hidden");$("signalSecondary").classList.add("hidden");$("signalModal").querySelector(".signal-modal").classList.toggle("failed",!success);
  if(success){var duration=inhibitorDuration(day);state.inhibitor.active=true;state.inhibitor.remainingMs=duration;state.inhibitor.durationMs=duration;state.inhibitor.exposed=false;state.inhibitor.needsSync=false;state.inhibitor.exposedMoves=0;state.inhibitor.successes++;state.stats.signalSuccesses++;changes=checkMissions();$("signalOutcomeMark").textContent="✓";$("signalOutcomeTitle").textContent="Identidad falsa activada";$("signalOutcomeText").textContent="Elías igualó el patrón de la Red UNO. Temperatura, respiración y pulso quedan ocultos mientras el reloj permanezca activo.";$("signalOutcomeStats").innerHTML='<div class="result-chip">Cobertura<strong>'+signalClockText(duration)+"</strong></div>"+'<div class="result-chip">Errores<strong>'+signalGameState.errors+" / 3</strong></div>"+(changes.length?'<div class="result-chip">Misión<strong>'+esc(changes[0][1])+"</strong></div>":'<div class="result-chip">Rastreo<strong>Evitado</strong></div>');$("signalPrimary").textContent="Volver a la expedición";playSfx("ending-good")
  }else{state.inhibitor.active=false;state.inhibitor.remainingMs=0;state.inhibitor.exposed=true;state.inhibitor.needsSync=true;state.inhibitor.pendingContact="hack";state.inhibitor.contactStarted=false;state.inhibitor.failures++;state.inhibitor.alarms++;state.stats.signalFailures++;state.stats.signalAlarms++;state.threat=clamp(state.threat+4,0,100);applyPsychImpulse({label:"Alarma de rastreo",hint:"El código fallido transmite la posición del grupo.",fx:{threat:4},psy:{stress:1}},null);$("signalOutcomeMark").textContent="!";$("signalOutcomeTitle").textContent="La Red UNO respondió";$("signalOutcomeText").textContent=(reason||"La sincronización falló")+". El inhibidor emitió el pulso que debía ocultar y una patrulla de drones ya converge sobre la posición.";$("signalOutcomeStats").innerHTML='<div class="result-chip">Amenaza<strong>+4</strong></div><div class="result-chip">Errores<strong>'+signalGameState.errors+' / 3</strong></div><div class="result-chip">Contacto<strong>Inminente</strong></div>';$("signalPrimary").textContent="Prepararse para los drones";playSfx("ui-error")
  }renderSignalHud();renderMini();save();$("signalPrimary").focus()
}
function openSignalHack(source){
  if(state.finished||state.refuge.active||battleState||pending||decisionState)return false;source=source||"manual";$("signalWarningModal").classList.add("hidden");signalGameState={screen:state.inhibitor.tutorialSeen?"ready":"tutorial",source:source,round:0,errors:0,sequence:[],input:0,timeMs:0,maxTimeMs:0,lastTick:Date.now()};var tutorial=signalGameState.screen==="tutorial";$("signalModal").querySelector(".signal-modal").classList.remove("failed");$("signalModal").classList.remove("hidden");$("signalTutorial").classList.toggle("hidden",!tutorial);$("signalGame").classList.add("hidden");$("signalOutcome").classList.add("hidden");$("signalRound").textContent=tutorial?"Tutorial":"Enlace listo";$("signalPrimary").classList.remove("hidden");$("signalPrimary").textContent=tutorial?"Entendido · iniciar":"Iniciar sincronización";$("signalSecondary").classList.remove("hidden");$("signalSecondary").textContent=state.inhibitor.active?"Conservar señal actual":"Salir sin cobertura";$("signalPrimary").focus();if(!tutorial)signalGameState.screen="ready";return true
}
function closeSignalHack(exposed){
  resetSignalRoundTimer();$("signalModal").classList.add("hidden");if(exposed&&!state.inhibitor.active){state.inhibitor.exposed=true;state.inhibitor.needsSync=true}signalGameState=null;signalLastTick=Date.now();renderSignalHud();save()
}
function signalPrimaryAction(){
  if(!signalGameState)return;if(signalGameState.screen==="tutorial"||signalGameState.screen==="ready"){startSignalChallenge();return}if(signalGameState.screen==="success"){closeSignalHack(false);toast("Identidad oculta · reloj del inhibidor activo");return}if(signalGameState.screen==="failed"){closeSignalHack(true);startTrackingCombat("hack")}
}
function signalSecondaryAction(){if(!signalGameState)return;var active=state.inhibitor.active;closeSignalHack(!active);toast(active?"Se conserva la sincronización actual":"El grupo sale con sus señales vitales visibles")}
function trackingMoveLimit(){return state.threat>=60?1:2}
function registerExposedMovement(){
  if(state.finished||state.refuge.active||state.inhibitor.active)return false;state.inhibitor.exposed=true;state.inhibitor.exposedMoves=(state.inhibitor.exposedMoves||0)+1;if(state.inhibitor.exposedMoves>=trackingMoveLimit()){state.inhibitor.pendingContact="exposed";state.inhibitor.contactStarted=false;save();openSignalWarning("tracking");return true}save();renderSignalHud();return false
}
function openSignalWarning(mode){
  if(state.finished||state.refuge.active||battleState||decisionState)return false;signalWarningMode=mode||"expired";var tracking=signalWarningMode==="tracking",post=signalWarningMode==="postcombat";$("signalWarningKicker").textContent=tracking?"Contacto de vigilancia":post?"Rastreo interrumpido":"Advertencia de rastreo";$("signalWarningTitle").textContent=tracking?"Drones en trayectoria":post?"La zona quedó expuesta":"El pulso vuelve a ser visible";$("signalWarningText").textContent=tracking?"La Red UNO correlacionó los pulsos del grupo. Ya no queda tiempo para ocultarse antes del contacto.":post?"La patrulla fue neutralizada, pero el combate confirmó la zona. El inhibidor continúa fuera de sincronía.":"La ventana del inhibidor terminó. La Red UNO puede volver a leer temperatura, respiración y ritmo cardíaco.";$("signalRisk").textContent=tracking?"Combate de rastreo confirmado · vencer permite saquear componentes electrónicos":post?"Resincroniza antes de moverte o una nueva patrulla podrá reconstruir la ruta":"Riesgo visible · "+trackingMoveLimit()+" desplazamiento"+(trackingMoveLimit()===1?"":"s")+" sin cobertura activará un encuentro de rastreo";$("signalWarningPrimary").textContent=tracking?"Prepararse para el contacto":"Hackear ahora";$("signalWarningSecondary").textContent=post?"Continuar expuestos":"Seguir expuestos";$("signalWarningSecondary").classList.toggle("hidden",tracking);$("signalBattery").classList.toggle("hidden",tracking);$("signalBattery").disabled=stockCount("battery")<=0;$("signalBattery").textContent=stockCount("battery")>0?"Usar batería · +90 s":"Sin baterías disponibles";$("signalWarningModal").classList.remove("hidden");$("signalWarningPrimary").focus();return true
}
function closeSignalWarning(){$("signalWarningModal").classList.add("hidden");signalLastTick=Date.now();renderSignalHud();save()}
function signalWarningPrimaryAction(){if(signalWarningMode==="tracking"){closeSignalWarning();startTrackingCombat("exposed");return}closeSignalWarning();openSignalHack(signalWarningMode)}
function signalWarningSecondaryAction(){closeSignalWarning();state.inhibitor.active=false;state.inhibitor.exposed=true;state.inhibitor.needsSync=true;renderSignalHud();save();toast("La expedición continúa visible para la Red UNO")}
function extendSignalWithBattery(){
  if(stockCount("battery")<=0){toast("No quedan baterías");return}consumeStock("battery");addStatItem("itemsUsed","battery",1);state.inhibitor.active=true;state.inhibitor.remainingMs=90000;state.inhibitor.durationMs=90000;state.inhibitor.exposed=false;state.inhibitor.needsSync=false;state.inhibitor.exposedMoves=0;closeSignalWarning();renderMini();toast("Batería conectada · cobertura de emergencia 01:30")
}
function startTrackingCombat(source){
  var restoring=!!state.inhibitor.contactStarted,day=currentDay(),encounters=day===1?[["drone"],["drone","drone"]]:day===2?[["drone","drone"],["agent3","drone"]]:[["agent3","drone"],["agent2","drone","drone"]];state.inhibitor.active=false;state.inhibitor.exposed=true;state.inhibitor.needsSync=true;state.inhibitor.exposedMoves=0;if(!restoring){if(source!=="hack"){state.inhibitor.alarms++;state.stats.signalAlarms++;state.threat=clamp(state.threat+3,0,100)}state.stats.trackingCombats++}state.inhibitor.pendingContact=source;state.inhibitor.contactStarted=true;save();encounterSaveLocked=true;startCombat({title:"Rastreo de la Red UNO",brief:"Las señales vitales del grupo quedaron expuestas. Neutraliza la patrulla, huye al refugio o utiliza equipo para sobrevivir.",encounters:encounters},{title:"Contacto por rastreo",result:"El grupo rompe el cerco de vigilancia, pero su identidad continúa visible.",_signalTracking:true,psy:{stress:1,resolve:1}})
}
...
function rewardMission(def){
  ...
  else if(def.id==="ghost"){state.threat=clamp(state.threat-4,0,100);placePartyItem("electronics",1)}
...
var eventAudioClues={
  ...
  13:[{id:"terminal-memory",title:"Fragmento del terminal",kicker:"Memoria dañada",source:"Nodo 14 · Terminal de rutas",duration:"00:20",src:"audio/lore/voice/terminal-memory.mp3",summary:"Diagnóstico automático sin fecha legible. Sus categorías no confirman quién sigue vivo hoy.",transcript:"Consulta incompleta. Refugios no registrados: ciento doce. Identidades detectadas: activas. Origen de intervención: soporte vital humano. Riesgo de transmisión: alto."}],
...
function contextArchiveHtml(id){
  var summary=archives[id],unlocked=archiveUnlocked(id),evidencePreview=typeof evidenceArchivePreview==="function"?evidenceArchivePreview(id):null;
  return'<button class="context-archive '+(unlocked?'unlocked':'locked')+'" data-context-archive="'+esc(id)+'"><span><b>'+esc(summary[0])+'</b><small>'+esc(evidencePreview?evidencePreview.summary:dossierNotes[id]||summary[1])+'</small><em>'+(unlocked?'Recuperado · leer completo':'Pista parcial · abrir')+'</em></span></button>'
}
...
function openContextArchive(id,opener){
  ...
  var evidencePreview=typeof evidenceArchivePreview==="function"?evidenceArchivePreview(id):null;if(evidencePreview){summary=[summary[0],evidencePreview.summary];body=evidencePreview.body;}
...
function renderDisassemblyModal(){
  if(!disassemblyState)return;var s=disassemblyState,d=s.item,rewards=rewardText(s.recipe),attempts=3-s.attempts,source=s.source.type==="loot"?"Loot de combate":"Mochila de "+state.party[s.source.pIndex].name;
...
function consumeDisassemblySource(s){
  ...
  if(s.source.type==="loot"){var e=battleState&&battleState.enemies[s.source.enemyIndex],drop=e&&e.loot[s.source.dropIndex];if(!drop||drop.id!==s.source.id||drop.status!=="pending")return false;if(drop.qty>1)drop.qty--;else drop.status=s.success?"disassembled":"broken";return true}
  return false
}
...
function apply(o){
  ...
  (o.add||[]).forEach(function(x){if(!hasPartyItem(x))placePartyItem(x,1)});(o.remove||[]).forEach(function(x){removePartyItem(x,1)});pushUnique(state.docs,o.archive);Object.assign(state.flags,o.flags||{});if(typeof narrativeChapterEffects==="function")narrativeChapterEffects(o);if(typeof narrativeNormalize==="function")narrativeNormalize();
...
function renderNpcDialogueChoices(){
  var choices=$("npcDialogueChoices"),options=npcDialogueState.options||[];npcDialogueState.choicesShown=false;choices.innerHTML=options.map(function(opt,i){if(typeof narrativeBlocked==="function"&&narrativeBlocked(opt))return "";var block=reason(opt),hint=choiceHintText(opt,block),action=block||opt.cost||(opt.combat?"Responder":"Elegir");return'<button class="npc-dialogue-choice" style="--dialogue-order:'+i+'" data-dialogue-choice="'+i+'" '+(block?"disabled":"")+'><strong>'+esc(opt.label)+'</strong><em>'+esc(action)+'</em><small>'+esc(hint)+'</small></button>'}).join("");
...
function selectNpcDialogueChoice(i){
  ...
  if(opt.result)$("npcDialogueText").textContent=opt.result;
...
function clearRouteNarrativeTimers(){
  clearInterval(routeNarrativeTimer);routeNarrativeTimer=null;clearInterval(routeNarrativeTypeTimer);routeNarrativeTypeTimer=null
}
function routeNarrativeDef(id){return routeNarrativeDefs[id]||null}
function currentRouteNarrativeScene(){var def=routeNarrativeDef(routeNarrativeState&&routeNarrativeState.id);return def&&def.scenes?def.scenes[routeNarrativeState.sceneIndex]:null}
function routeNarrativeLines(scene){return(scene&&Array.isArray(scene.lines)?scene.lines:[scene&&scene.text]).filter(function(line){return String(line||"").trim()})}
function routeDefaultChoice(scene,def){
...
function renderRouteNarrativeChanges(changes){
  ...
  $("routeNarrativeChanges").classList.toggle("hidden",!(changes&&changes.length))
}
function renderRouteNarrativeChoices(){
  var scene=currentRouteNarrativeScene(),def=routeNarrativeDef(routeNarrativeState.id),fallback=routeDefaultChoice(scene,def),choices=$("routeNarrativeChoices");
  choices.innerHTML=(scene.options||[]).map(function(opt,i){if(typeof narrativeBlocked==="function"&&narrativeBlocked(opt))return "";var block=reason(opt),isDefault=!scene.untimed&&i===fallback;return'<button class="route-choice '+(isDefault?'default':'')+'" data-route-choice="'+i+'" '+(block?'disabled':'')+'><span class="num">'+(i+1)+'</span><span><strong>'+esc(opt.label)+'</strong><small>'+esc(choiceHintText(opt,block))+'</small></span><em>'+esc(routeChoiceCost(opt,block))+'</em>'+(isDefault?'<b>Por defecto</b>':'')+'</button>'}).join("");
  Array.prototype.forEach.call(choices.querySelectorAll("[data-route-choice]"),function(b){b.addEventListener("click",function(){selectRouteNarrativeChoice(Number(b.dataset.routeChoice))})})
}
function showRouteNarrativeOptions(){
  if(!routeNarrativeState||routeNarrativeState.optionsVisible)return;var scene=currentRouteNarrativeScene(),def=routeNarrativeDef(routeNarrativeState.id),duration=scene.timeLimit||15000,start=Date.now();
  routeNarrativeState.optionsVisible=true;renderRouteNarrativeChoices();$("routeNarrativeChoices").classList.remove("hidden");$("routeNarrativeClock").classList.remove("hidden");$("routeNarrativeButton").textContent="Elegir ruta";$("routeNarrativeButton").disabled=true;clearInterval(routeNarrativeTimer);if(scene.untimed){$("routeNarrativeClock").classList.add("hidden");var ready=$("routeNarrativeChoices").querySelector("button:not(:disabled)");if(ready)ready.focus({preventScroll:true});return}routeNarrativeTimer=setInterval(function(){var elapsed=Date.now()-start,pct=clamp(100-Math.round(100*elapsed/duration),0,100);$("routeNarrativeTimeBar").style.width=pct+"%";if(elapsed>=duration){clearInterval(routeNarrativeTimer);routeNarrativeTimer=null;selectRouteNarrativeChoice(routeDefaultChoice(scene,def))}},100);var first=$("routeNarrativeChoices").querySelector("button:not(:disabled)");if(first)first.focus({preventScroll:true})
}
function revealRouteNarrativeText(){
  if(!routeNarrativeState)return;clearInterval(routeNarrativeTypeTimer);routeNarrativeTypeTimer=null;$("routeNarrativeText").textContent=routeNarrativeState.text;if(routeNarrativeState.lineIndex>=routeNarrativeState.lines.length-1)showRouteNarrativeOptions();else $("routeNarrativeButton").focus({preventScroll:true})
}
function typeRouteNarrativeText(){
  var text=routeNarrativeState?routeNarrativeState.text:"",i=0;clearInterval(routeNarrativeTypeTimer);$("routeNarrativeText").textContent="";$("routeNarrativeChoices").classList.add("hidden");$("routeNarrativeClock").classList.add("hidden");$("routeNarrativeTimeBar").style.width="100%";$("routeNarrativeButton").disabled=false;$("routeNarrativeButton").textContent="Avanzar texto";routeNarrativeTypeTimer=setInterval(function(){if(!routeNarrativeState){clearInterval(routeNarrativeTypeTimer);routeNarrativeTypeTimer=null;return}i+=3;$("routeNarrativeText").textContent=text.slice(0,i);if(i>=text.length)revealRouteNarrativeText()},18)
}
function openRouteNarrative(id,sceneIndex,introChanges){
  var def=routeNarrativeDef(id),scene;clearRouteNarrativeTimers();if(!def||!def.scenes||!def.scenes.length){if(pending)continuePendingAdvance();return}scene=def.scenes[sceneIndex||0]||def.scenes[0];if(typeof narrativeChapterScene==="function")scene=narrativeChapterScene(scene,id,sceneIndex||0);routeNarrativeState={id:id,sceneIndex:sceneIndex||0,lines:routeNarrativeLines(scene),lineIndex:0,text:"",optionsVisible:false,finished:false,changes:introChanges||[]};if(typeof narrativeVisit==="function")narrativeVisit(id,sceneIndex||0);routeNarrativeState.text=routeNarrativeState.lines[0]||"";$("result").classList.add("hidden");$("npcDialogueModal").classList.add("hidden");$("routeNarrativeKicker").textContent=scene.kicker||def.title||"Desvío de ruta";$("routeNarrativeTitle").textContent=scene.title||def.title||"Desvío";$("routeNarrativeImage").src=assetUrl(scene.image);$("routeNarrativeImage").alt=scene.title||def.title||"Escena narrativa";renderRouteNarrativeChanges(routeNarrativeState.changes);$("routeNarrativeModal").classList.remove("hidden");$("routeNarrativeButton").focus({preventScroll:true});typeRouteNarrativeText();$("routeNarrativeModal").querySelector(".route-narrative-modal").scrollTop=0
}
function finishRouteNarrative(){
  clearRouteNarrativeTimers();routeNarrativeState=null;$("routeNarrativeModal").classList.add("hidden");if(pending)continuePendingAdvance();else{save();render()}
}
function selectRouteNarrativeChoice(i){
  if(!routeNarrativeState||routeNarrativeState.finished)return;if(routeNarrativeTypeTimer){revealRouteNarrativeText();return}var scene=currentRouteNarrativeScene(),opt=scene&&scene.options&&scene.options[i];if(!opt||reason(opt))return;clearInterval(routeNarrativeTimer);routeNarrativeTimer=null;if(typeof narrativeRecord==="function")narrativeRecord(routeNarrativeState.id,routeNarrativeState.sceneIndex,opt);var changes=apply(opt).concat(checkMissions());routeChoiceHistory(opt);renderMini();save();
...
function advanceRouteNarrative(){
  if(!routeNarrativeState)return;if(routeNarrativeState.finished){finishRouteNarrative();return}if(routeNarrativeTypeTimer){revealRouteNarrativeText();return}if(routeNarrativeState.lineIndex<routeNarrativeState.lines.length-1){routeNarrativeState.lineIndex++;routeNarrativeState.text=routeNarrativeState.lines[routeNarrativeState.lineIndex];routeNarrativeState.optionsVisible=false;typeRouteNarrativeText();return}showRouteNarrativeOptions()
}
function continuePendingAdvance(){
  var ending=pending.ending,returnToRefuge=state.finaleRevision===1&&state.index>=22?null:pending.returnToRefuge||(state.morale<=0?"morale":null);pending=null;encounterSaveLocked=false;if(ending){finish(ending);return}
  var oldDay=events[state.index].day;state.index++;if(typeof resolveNarrativeFinale==="function"&&resolveNarrativeFinale())return;if(events[state.index].day!==oldDay){night(oldDay,returnToRefuge)}else if(returnToRefuge){openRefuge(returnToRefuge);return}else{save();render();registerExposedMovement()}
}
function closeNpcDialogueAndContinue(){
  if(!npcDialogueState)return;if(npcDialogueTimer){revealNpcDialogueText();return}var routeScene=npcDialogueState.routeScene;clearInterval(npcDialogueTimer);npcDialogueTimer=null;npcDialogueState=null;$("npcDialogueModal").classList.add("hidden");if(routeScene){openRouteNarrative(routeScene,0);return}if(pending)continuePendingAdvance()
}
function advance(){
  if(!pending||(typeof activeCrate==="function"&&activeCrate()))return;setSceneAmbience("ambience-title",AUDIO_CROSSFADE_MS);$("result").classList.add("hidden");if(pending.dialogue&&!pending.dialogueSeen){pending.dialogueSeen=true;openNpcDialogue(pending.dialogue);save();return}if(typeof openPendingCrate==="function"&&openPendingCrate())return;continuePendingAdvance()
}
function night(day,returnToRefuge){return prepareNight(day,returnToRefuge)}
...
function endingTier(kind){
  if(state.finaleResolution)return {id:"normal",label:"Desenlace · "+({broadcast:"difusión",fragment:"emisión parcial",pact:"extracción de Vera",archive:"archivo recuperado",testimony:"testimonio"}[state.finaleResolution.kind]||"expedición")};
...
function endingNarrative(kind,tierId){
  if(state.finaleResolution)return state.finaleResolution.story;
  ...
  };var story=Object.assign({},endings[tierId]);if(state.flags.matiasAtRefuge)story.refuge+=" Matías permanece en la enfermería como prueba viva de que una ruta puede desviarse por alguien y no solo por recursos.";if(state.flags.matiasFeverSignal)story.world+=" La frecuencia de fiebre que dejó permite a otros refugios reconocer cuándo un cielo quieto es en realidad un rastreo.";if(state.flags.iaraAtSafeHouse)story.refuge+=" Iara llegó a una casa marcada, y Rosa dejó de ser solo una deuda del andén: ahora es un contacto vivo entre refugios y cazadores.";if(state.flags.rosaCivilNetwork)story.world+=" La red civil de Rosa empieza a repetir avisos con marcas, agua y mensajes que la Red UNO no puede leer como transmisión abierta.";if(state.flags.refugeDistrustExiles)story.refuge+=" Parte del consejo recibe la alianza con Lira como una ruptura de autoridad y empieza a desconfiar de lo que la expedición negoció lejos del refugio.";if(state.flags.liraAlliance)story.world+=" Lira y los exiliados conservan una ruta que la Red UNO no puede rastrear; cuando la Cámara de núcleos vuelve a abrirse, ya no llegan como enemigos sino como custodios de sus muertos.";else if(state.flags.liraCoreCopied)story.world+=" La copia del núcleo exiliado conserva los nombres de los primeros desterrados, pero su identidad deja a la Red UNO una nueva forma de seguir esa memoria.";else if(state.flags.liraCoreClaimed)story.group+=" El núcleo del hermano de Lira regresa como tecnología recuperada, y el silencio del grupo confirma que ningún recurso llega realmente vacío.";if(state.flags.unit7Ally)story.world+=" S-7 continúa recorriendo conductos de mantenimiento con su identificación borrada. Ya no clasifica pulsos: abre corredores para cualquiera que la Red UNO haya decidido no reconocer.";else if(state.flags.unit7Infiltrated)story.world+=state.threat>=80?" La Red UNO descubre la orden falsa de S-7 antes del cierre de la transmisión. Su última ruta alcanza a desviar una patrulla, pero después la unidad desaparece de la red.":" Dentro de la Red UNO, S-7 sigue registrando calles vacías donde todavía camina gente. Una desobediencia mínima empieza a repetirse como si también fuera un protocolo.";else if(state.flags.unit7Shutdown)story.group+=" El núcleo apagado de S-7 conserva su primera orden. Elías puede leerla, pero ninguno de los tres consigue responder si guardar una memoria equivale a salvar a quien la sostenía.";if(state.flags.h12CommuneBlind)story.world+=" H-12 dejó de reconocer media comuna. Refugios, cazadores y exiliados vuelven a caminar bajo un cielo ciego, aunque con ellos desaparecieron rutas y nombres que solo sobrevivían dentro del archivo.";else if(state.flags.h12Line1Hidden)story.refuge+=" Línea 1 ya no existe para el rastreo aéreo. El refugio celebra el silencio de los drones sin preguntar demasiado qué comunidades siguieron visibles para comprarlo.";else if(state.flags.h12ControlledShutdown)story.group+=" El núcleo de H-12 viaja apagado junto al grupo. Con él desaparece la vigilancia que lograron controlar y también la posibilidad de volver a utilizarla.";else if(state.flags.h12Controlled)story.world+=state.threat>=80?" La Red UNO recupera parte del enlace de H-12 antes del cierre de la transmisión. El ojo sigue obedeciendo al grupo, pero ahora otra mirada sabe que fue desviado.":" H-12 continúa declarando vacíos allí donde todavía vive gente. La vigilancia no desapareció: cambió de manos, y esa diferencia será una deuda para la próxima expedición.";if(state.flags.erasedCitizensRestored){story.world+=" Miles de personas declaradas muertas recuperan sus nombres en una sola noche. Los controles de la Red UNO se llenan de ciudadanos imposibles y los exiliados vuelven a pronunciar identidades anteriores al destierro.";story.group+=state.flags.vegaOriginRecovered?" Vega abandona el visor con su expediente original entre las manos. No recuerda toda la vida que le quitaron, pero usa ese nombre para dar el primer testimonio contra el registro.":" Vega deja de servir como rastreador y se convierte en testigo de la máquina que lo hizo caminar bajo el nombre de un muerto."}else if(state.flags.line1OfficiallyRegistered)story.refuge+=" Línea 1 vuelve a existir como población civil reconocida. La Red UNO ya no puede borrarla sin contradecir su propio archivo, pero ahora conoce sus habitantes, su acceso y la frecuencia exacta de su refugio.";else if(state.flags.identityRegistryDestroyed)story.world+=state.flags.vegaErasedNamesCopied?" El registro de identidad desaparece y la Red UNO pierde la capacidad de reutilizar a los muertos. Una copia parcial viaja con el grupo: insuficiente para devolver ciudadanía, pero suficiente para impedir que todos los nombres se pierdan.":" El registro de identidad desaparece y la Red UNO pierde la capacidad de reutilizar a los muertos. También desaparecen las pruebas de miles de destierros; desde ahora, sus nombres sobrevivirán únicamente en la memoria de quienes los conocieron.";if(state.flags.ortegaPerimeterOpened){story.world+=" Ortega rompe la cadena del cordón morado y abre el perímetro a todas las comunidades. El distrito deja de confundir orden con silencio, aunque la Red UNO ya conoce la magnitud de la desobediencia.";story.group+=" El sello de Ortega queda en manos de Elías como prueba de que incluso una orden puede renunciar a sí misma."}else if(state.flags.ortegaResidentControl){story.world+=" Las viviendas del distrito controlan ahora sus propias puertas, cámaras y suministros. Ningún comandante gobierna el barrio completo, y esa fragilidad compartida se convierte en su primera forma de libertad.";story.group+=" Sara conserva la primera lista civil escrita fuera del registro de la Red UNO."}else if(state.flags.ortegaLine1Protected){story.refuge+=" Ortega mantiene el cordón morado y reserva un corredor seguro únicamente para Línea 1. El refugio gana protección, pero cada llegada recuerda qué comunidades quedaron fuera del acuerdo.";story.group+=" Noa nunca vuelve a confiar por completo en una ruta que necesita que otros permanezcan visibles."}return story
}
function calculateScore(kind,tierId){
  ...
  return Math.max(0,Math.round(state.history.filter(function(h){return h.kind!=="rest"}).length*80+s.wins*650+s.enemies*180+s.loot*45+state.docs.length*180+completedMissionCount()*400+s.hits*28+s.criticals*140+s.damageDealt*3+level*220+s.skillsUnlocked*150+s.factionEarned*45+state.morale*9+(100-state.threat)*6+tierBonus-s.retreats*260))
}
...
function buildRunReport(){
  ...
  return{tier:tier,outcome:outcome,score:score,rank:scoreRank(score),combat:[["Combates ganados",s.wins+" / "+s.battles],["Combates por rastreo",s.trackingCombats||0],["Golpes realizados",s.attacks],["Golpes acertados",s.hits],["Golpes fallados",s.misses],["Golpes críticos",s.criticals],["Balas utilizadas",s.shots],["Daño causado",s.damageDealt],["Daño recibido",s.damageTaken],["Enemigos neutralizados",s.enemies],["Aliados reanimados",s.revives]],survival:[["Medicina utilizada",s.medicineUsed],["HP recuperado",s.hpRestored],["Descansos",s.rests],["Retiradas",s.retreats],["Visitas al refugio",s.refugeVisits],["Cambios psicológicos",s.mentalShifts||0],["Trueques",s.trades],["Objetos fabricados",s.crafts],["XP por taller",s.xpFromCrafting]],exploration:(typeof fieldReportRows==="function"?fieldReportRows():[]).concat([["Sincronizaciones",s.signalSuccesses||0],["Hackeos fallidos",s.signalFailures||0],["Alarmas activadas",s.signalAlarms||0],["Loot recuperado",s.loot],["Desarmes exitosos",s.disassembled||0],["Fallos de desarme",s.disassembleFailures||0],["Archivos descubiertos",state.docs.length],["Decisiones tomadas",state.history.length],["Pulso final",psychTeamLine()],["Misiones cumplidas",completedMissionCount()+" / "+missionDefs.filter(function(def){return !def.main}).length],["Puntos de facción ganados",s.factionEarned],["Habilidades adquiridas",s.skillsUnlocked],["Puntos sin gastar",state.factionPoints],["Moral final",state.morale+"%"],["Amenaza final",state.threat+"%"]]),loot:namedItemList(s.lootItems),used:namedItemList(s.itemsUsed),crafted:namedItemList(s.craftedItems),decisions:state.history.slice()}
}
...
function finish(kind){
  state.finished=true;state.ending=kind;state.inhibitor.active=false;state.inhibitor.remainingMs=0;var tier=endingTier(kind),story=endingNarrative(kind,tier.id),score=calculateScore(kind,tier.id),level=Math.max.apply(null,state.party.map(function(p){return p.level}));state.finalTier=tier.id;state.score=score;
  playSfx(tier.id==="good"?"ending-good":tier.id==="bad"?"ending-bad":"ending-neutral");
  $("downloadFinalMap").classList.toggle("hidden",!state.finaleResolution);$("downloadSummaryMap").classList.toggle("hidden",!state.finaleResolution);$("finalTier").textContent=tier.label;$("finalTier").className="ending-badge "+tier.id;$("finalTitle").textContent=story.title;$("finalText").textContent=story.lead;$("finalRefuge").textContent=story.refuge;$("finalGroup").textContent=story.group;$("finalWorld").textContent=story.world;$("finalRank").textContent="Rango "+scoreRank(score);$("finalStats").innerHTML=[["Moral",state.morale+"%"],["Amenaza",state.threat+"%"],["Combates",state.stats.wins+" / "+state.stats.battles],["Loot",state.stats.loot],["Misiones",completedMissionCount()+" / "+missionDefs.filter(function(def){return !def.main}).length],["Nivel máximo","Lvl. "+level]].map(function(x){return'<div class="result-chip">'+x[0]+"<strong>"+x[1]+"</strong></div>"}).join("");$("summary").classList.add("hidden");$("final").classList.remove("hidden");renderSignalHud();animateScore(score);save()
}
...
function downloadResultPng(){
  ...
  if(typeof fieldStore==="function"&&fieldStore().selected.length){y=canvasHeading(ctx,"Mejoras de campo",y,accent);fieldStore().selected.forEach(function(x){var d=fieldById[x.id],p=state.party.find(function(p){return p.id===x.owner});ctx.fillStyle="#d9d5cc";ctx.font="22px Arial";y=canvasWrap(ctx,d.name+" · "+p.name+" — "+d.buff,90,y,1420,34,0)+12});y+=15}
...
function startCombat(config,choice){
  ...
  if(!choice._decisionChanges)applyPsychImpulse(choice,null).forEach(function(change){battleState.log.push(change[0]+": "+change[1]+".")});
...
function combatAction(type){
  if(!battleState||battleState.phase!=="combat"||battleState.busy||(typeof fieldVisible==="function"&&fieldVisible()))return;var p=state.party[battleState.actor],e=selectedEnemy();if(!p||p.hp<=0)return;
  ...
  if(type==="attack"){
    ...
    if(p.id==="sara"){var downed=hasSkill(p,"sara_reanimate")?state.party.filter(function(a){return a.hp<=0})[0]:null;if(downed){var reviveIndex=state.party.indexOf(downed);downed.hp=Math.min(downed.maxHp,14+psychHealingBonus(p));downed.hunger=Math.max(downed.hunger,20);downed.bleed=0;state.stats.revives++;recordHealing(downed.hp,false);recordHp("ally",reviveIndex,0,downed.hp,downed.maxHp);battleState.log.push("Sara activa Pulso de retorno: "+downed.name+" vuelve con "+downed.hp+" HP.");fieldAfterHeal(p,downed)}else{var target=state.party.filter(function(a){return a.hp>0}).sort(function(a,b){return a.hp/a.maxHp-b.hp/b.maxHp})[0],heal=12+p.level*2+(hasSkill(p,"sara_fieldcare")?4:0)+psychHealingBonus(p),before=target.hp;target.hp=Math.min(target.maxHp,target.hp+heal);target.bleed=0;if(hasSkill(p,"sara_triage"))state.party.forEach(function(a){a.bleed=0});recordHealing(target.hp-before,false);recordHp("ally",state.party.indexOf(target),before,target.hp,target.maxHp);battleState.log.push("Sara atiende a "+target.name+": +"+(target.hp-before)+" HP"+(hasSkill(p,"sara_triage")?" y estabiliza el sangrado del grupo.":"."));fieldAfterHeal(p,target)}}
    else if(p.id==="elias"&&e.mechanical&&(bagQty(p,"battery")>0||fieldBatteryReady(p))){state.stats.attacks++;state.stats.hits++;fieldConsumeBattery(p);e.stun=hasSkill(p,"elias_overcharge")?2:1;strike(e,(hasSkill(p,"elias_overcharge")?24:16)+p.level*2,"Elías descarga una batería EMP",battleState.actor,false);fieldArc(p,e,(hasSkill(p,"elias_overcharge")?24:16)+p.level*2)}
    else if(p.id==="elias"){state.stats.attacks++;var techFatigue=hungerPenalty(p),techRoll=d20(),techCritical=fieldCritical(p,techRoll);if(techRoll+3+p.level+techFatigue>=e.def){state.stats.hits++;strike(e,Math.floor((10+p.level)*(techCritical?1.75:1)),"Elías encuentra un punto débil",battleState.actor,techCritical)}else{state.stats.misses++;combatNotice("ally",battleState.actor,"FALLÓ","miss");battleState.log.push("Elías no logra abrir la defensa de "+e.name+"."+(techFatigue?" La fatiga afecta su pulso.":""))}}
    else{state.stats.attacks++;var precision=weaponFor(p),hasAmmo=!precision.ammo||consumeFromBag(p,precision.ammo),skillWeapon=hasAmmo?precision:gear("knife"),skillFatigue=hungerPenalty(p),skillRoll=d20(),skillCritical=fieldCritical(p,skillRoll),skillBonus=skillWeapon.accuracy+p.level+2+skillFatigue+personalAccuracyBonus(p),skillDamage=(hasAmmo?14:8)+p.level+rand(0,4)+personalDamageBonus(p,e);if(precision.ammo&&hasAmmo)state.stats.shots++;if(skillRoll+skillBonus>=e.def){state.stats.hits++;strike(e,Math.floor(skillDamage*(skillCritical?1.75:1)),hasAmmo?"Noa ejecuta un disparo preciso con "+precision.name:"Noa cambia al cuchillo",battleState.actor,skillCritical)}else{state.stats.misses++;combatNotice("ally",battleState.actor,"FALLÓ","miss");battleState.log.push("Noa falla su ataque preciso contra "+e.name+"."+(skillFatigue?" La fatiga desvía su ataque.":""))}}
  }
...
function enemyPhase(){
  if(!battleState)return;var current=battleState,queue=livingEnemies().slice(),cursor=0;current.busy=true;
  function nextEnemy(){
    if(battleState!==current)return;
  ...
  function resolveEnemy(e){
    ...
    var live=state.party.filter(function(p){return p.hp>0});if(!live.length)return;var weakest=live.slice().sort(function(a,b){return a.hp/a.maxHp-b.hp/b.maxHp})[0],target=random()<.3?weakest:live[rand(0,live.length-1)],index=state.party.indexOf(target),attackRoll=d20(),hit=attackRoll+(e.accuracy||0)>=11;if(!hit){delete e.fieldSuppressed;combatNotice("enemy",battleState.enemyActing,"FALLÓ","miss");battleState.log.push(e.name+" falla su ataque contra "+target.name+".");return}var before=target.hp,unreduced=rand(e.attack[0],e.attack[1])+(attackRoll===20?3:0),raw=fieldEnemyDamage(e,unreduced),cover=target.guard||0,armor=Math.max(0,gearDefense(target)+psychDefenseBonus(target)),armorBlocked=Math.min(raw,armor),coverBlocked=Math.min(cover,Math.max(0,raw-armorBlocked)),blocked=armorBlocked+coverBlocked,damage=Math.max(0,raw-blocked);fieldStore().stats.prevented+=Math.max(0,Math.min(before,Math.max(0,unreduced-armor-cover))-Math.min(before,damage));delete e.fieldSuppressed;damage=fieldIncoming(target,damage);target.guard=Math.max(0,cover-coverBlocked);target.hp=Math.max(0,target.hp-damage);var lethalAllyHit=before>0&&target.hp<=0;state.stats.damageTaken+=before-target.hp;if(lethalAllyHit&&attackRoll!==20)playRandomSfx("combat-enemy-hit-normal");recordHp("ally",index,before,target.hp,target.maxHp,attackRoll===20||lethalAllyHit?"none":"combat-enemy-hit-normal");if(attackRoll===20){playSfx("combat-critical");battleState.allyCritical=index;}battleState.log.push(e.name+" ataca a "+target.name+": "+damage+" de daño recibido."+(attackRoll===20?" Golpe crítico.":""));if(blocked)battleState.log.push(target.name+" bloquea "+blocked+" entre cobertura, equipo y pulso mental.");if(armor>0&&damage>0)damageArmor(target,attackRoll===20?2:1);if(e.lootGroup==="merodeador"&&damage>=4&&target.hp>0&&random()<.24){target.bleed=2;battleState.log.push(target.name+" comienza a sangrar.")}
  }
  function finishEnemyRound(){
  var continueRound=function(){battleState.enemyActing=null;if(!state.party.some(function(p){return p.hp>0})){loseCombat(false);return}if(typeof finaleObjectiveRound==="function"&&finaleObjectiveRound())return;battleState.round++;battleState.acted={};battleState.actor=firstAvailableActor();battleState.busy=false;if(beginActorTurn())renderBattle()};if(lethalFeedback()){settleLethal(continueRound);return}continueRound()
  }
  nextEnemy();
}
...
function takeLoot(i){if(!battleState)return;var e=battleState.enemies[battleState.openLoot],drop=e&&e.loot[i],p=state.party[battleState.looter],free=bagFree(p),units=drop?Math.max(1,Number(drop.qty)||1):0,d=drop&&gear(drop.id);if(!drop||drop.status!=="pending")return;if(free===0){battleState.lootMessage="La mochila está llena. No puedes recoger más loot.";renderLootModal(battleState.openLoot);return}if(units>free){battleState.lootMessage="No caben las "+units+" unidades de "+(d?d.name:drop.id)+". Solo "+(free===1?"queda 1 espacio libre":"quedan "+free+" espacios libres")+".";renderLootModal(battleState.openLoot);return}if(!addToBag(p,drop.id,units)){battleState.lootMessage="La mochila está llena. No puedes recoger más loot.";renderLootModal(battleState.openLoot);return}drop.status="taken";battleState.lootMessage="";recordLoot(drop.id,units);battleState.lootTaken+=units;renderLootModal(battleState.openLoot)}
function takeAllLoot(){
  if(!battleState)return;var e=battleState.enemies[battleState.openLoot],p=state.party[battleState.looter];if(!e)return;var pending=pendingLootUnits(e.loot),free=bagFree(p);if(!canTakeAllLoot(p,e.loot)){battleState.lootMessage=free===0?"La mochila está llena. No puedes saquear todo.":"No se puede saquear todo: el loot ocupa "+pending+" espacios y solo "+(free===1?"queda 1 espacio libre":"quedan "+free+" espacios libres")+". Selecciona cada uno de los objetos que quieres llevar.";renderLootModal(battleState.openLoot);return}
  var taken=0;e.loot.forEach(function(drop){if(drop.status!=="pending")return;var units=Math.max(1,Number(drop.qty)||1);addToBag(p,drop.id,units);drop.status="taken";recordLoot(drop.id,units);battleState.lootTaken+=units;taken+=units});battleState.lootMessage="";renderLootModal(battleState.openLoot);toast(p.name+" guarda todo el loot · "+taken+" unidades")
}
...
function closeLootModal(preservePending){
  if(disassemblyState&&disassemblyState.source.type==="loot")closeDisassemblyModal();if(!battleState)return;var e=battleState.enemies[battleState.openLoot];if(e&&preservePending!==true)e.loot.forEach(function(x){if(x.status==="pending")x.status="discarded"});$("lootModal").classList.add("hidden");battleState.openLoot=null;if(preservePending!==true&&battleState.enemies.every(function(x){return x.looted&&pendingLootUnits(x.loot)===0}))finishLooting();else renderBattle()
}
...
function winCombat(){
  ...
  var b=battleState;fieldRecordVictory(b);var choice=b.choice,out=choice.victory||choice,route=choice._routeNarrative;state.stats.battles++;state.stats.wins++;if(state.party.every(function(p){return p.hp>0}))state.stats.fullSquadWins++;state.party.forEach(function(p,i){if(p.hp>0){state.stats.xpFromVictories+=5;addPersonalXp(i,5,"sobrevivir al combate")}});awardFactionPoints(1,"combate ganado");var xpSummary=state.party.map(function(p,i){return(b.xpEarned[i]||0)>0?p.name+" +"+b.xpEarned[i]:""}).filter(Boolean).join(" · "),extra=[["Victoria","Hostiles neutralizados"],["Puntos de facción","+1 · combate ganado"],["XP personal",xpSummary||"Sin XP de combate"],["Loot",b.lootTaken?b.lootTaken+" objetos":"Sin recoger"]];extra=fieldVictoryRows().concat(extra);extra=extra.concat(applyPsychImpulse({label:"Victoria del grupo",hint:"Sobrevivir refuerza la decisión colectiva.",fx:{morale:1,threat:-1},psy:{stress:-1,resolve:1}},null));if(b.levelUps.length)extra.push(["Subida de nivel",b.levelUps.join(", ")]);battleState=null;setSceneAmbience("ambience-title",AUDIO_CROSSFADE_MS);$("battle").classList.add("hidden");$("lootModal").classList.add("hidden");if(choice._signalTracking){encounterSaveLocked=false;state.inhibitor.pendingContact=null;state.inhibitor.contactStarted=false;state.inhibitor.active=false;state.inhibitor.remainingMs=0;state.inhibitor.exposed=true;state.inhibitor.needsSync=true;state.inhibitor.exposedMoves=0;checkMissions();render();renderMini();save();setTimeout(function(){openSignalWarning("postcombat")},180);return}if(route){var changes=(route.changes||[]).concat(extra,apply(out),checkMissions()).slice(-6);routeChoiceHistory({label:out.title||choice.title||"Combate del desvío"},route.id);openRouteNarrative(route.id,route.nextScene,changes);return}completeChoice(choice,out,null,null,extra.concat(choice._decisionChanges||[]))
}
function loseCombat(fled){
  if(typeof resetCombatPresentation==="function")resetCombatPresentation();
  stopLoopSfx("loot-loop",160);
  if(!battleState)return;if(typeof finaleDefeat==="function"&&finaleDefeat(fled))return;var noaAftermath=typeof recordNoaRouteSetback==="function"?recordNoaRouteSetback(battleState.choice,fled):"";var routeAftermath=typeof narrativeRouteFailure==="function"?narrativeRouteFailure(battleState.choice&&battleState.choice._routeNarrative):"";var moraleCost=fled?8:12,threatCost=fled?4:6;state.stats.battles++;state.stats.retreats++;state.morale=clamp(state.morale-moraleCost,0,100);state.threat=clamp(state.threat+threatCost,0,100);applyPsychImpulse({label:fled?"Retirada táctica":"Derrota total",hint:"El fracaso pesa sobre el grupo.",fx:{morale:-moraleCost,threat:threatCost},psy:{stress:fled?1:2,resolve:-1}},null);state.party.forEach(function(p){p.guard=0;p.bleed=0});battleState=null;pending=null;encounterSaveLocked=false;state.inhibitor.pendingContact=null;state.inhibitor.contactStarted=false;$("battle").classList.add("hidden");openRefuge(fled?"fled":"exhausted");state.refuge.message=fled?"Retirarse cuesta "+moraleCost+" de moral, aumenta "+threatCost+" la amenaza y tensa al grupo. La situación sigue pendiente.":"El grupo completo quedó agotado: moral −"+moraleCost+", amenaza +"+threatCost+" y tensión acumulada. Descansa o utiliza medicina antes de regresar.";if(routeAftermath)state.refuge.message=routeAftermath;if(noaAftermath)state.refuge.message+=" "+noaAftermath;renderRefuge();save()
}
...
function legacyEventDisplay(ev,index){
  ...
  if(state.flags.unit7RouteCompleted&&index===10){
    var unit7Return=state.flags.unit7Ally?"S-7 avanza por un conducto paralelo, abriendo seguros y borrando rastros antes de que el grupo llegue a la superficie.":state.flags.unit7Infiltrated?"S-7 volvió a la red con una ruta falsa. Los rastreos se alejan de República como si el túnel hubiera quedado vacío.":"Elías carga el núcleo apagado de S-7. La última pregunta de la unidad permanece guardada junto a su primera orden.";
    return Object.assign({},ev,{time:"08:40",text:unit7Return+" La escalera termina bajo una reja cubierta de raíces. Arriba, el cielo gris revela edificios tomados por vegetación y calles demasiado silenciosas."})
  }
  if((state.flags.unit7Ally||state.flags.unit7Infiltrated)&&ev.title==="Sombras sobre el asfalto"){
    var alamedaChoices=ev.choices.slice(),unit7Inside=state.flags.unit7Infiltrated;
    alamedaChoices[1]=unit7Inside?{label:"Seguir la ruta falsa transmitida por S-7",hint:"La unidad desvía los drones desde dentro de la Red UNO.",cost:"Apoyo encubierto",title:"Una calle declarada vacía",result:"La patrulla aérea recibe una identidad autorizada al otro lado de la Alameda y abandona el sector. Durante unos minutos, la mentira de S-7 protege cuerpos que la red no reconoce.",fx:{threat:-7,morale:2},archive:["sonar"],flags:{alamedaClear:true,unit7FalseRouteWorked:true}}:{label:"Pedir a S-7 que abra un corredor",hint:"Su protocolo original puede declarar al grupo como evacuación protegida.",cost:"Apoyo de S-7",title:"Prioridad de rescate",result:"S-7 emite su primera orden y obliga a los drones de altura a despejar un corredor de evacuación. La Red UNO tarda demasiado en decidir si corregirlo.",fx:{threat:-5,morale:3},archive:["protocol"],flags:{alamedaClear:true,unit7RescueCorridor:true}};
    return Object.assign({},ev,{text:"Los drones de altura descienden sobre la Alameda y encuentran otra identidad de la Red UNO entre los tres pulsos humanos. S-7 todavía puede convertir su contradicción en una salida.",choices:alamedaChoices})
  }
  if(ev.title==="La mesa para cuatro"&&(state.flags.rosaSafeHouseMarked||state.flags.h12RouteCompleted)){
    var houseText=state.flags.rosaSafeHouseMarked?"La casa marcada por Rosa conserva mantas secas, una cocina de alcohol y cuatro platos preparados. Ya no parece un botín anónimo: es parte de una red civil que sobrevive dejando señales donde la Red UNO solo ve ruina.":ev.text,houseTime=ev.time;
    if(state.flags.h12CommuneBlind){houseText+=" Las ópticas del techo pasan sobre la casa sin registrar calor. En las paredes, nuevas marcas indican que cazadores y exiliados ya están usando el vacío abierto por H-12.";houseTime="11:35"}
    else if(state.flags.h12Line1Hidden){houseText+=" Un pulso de H-12 cruza la ventana y corrige todas las identidades salvo la de Línea 1. La casa sigue apareciendo en el mapa: el precio exacto de proteger un solo hogar.";houseTime="11:20"}
    else if(state.flags.h12Controlled){houseText+=" H-12 señala dos drones que se acercaban a la casa y los envía hacia un edificio vacío. El refugio existe porque el mismo ojo que lo clasificaba ahora acepta órdenes del grupo.";houseTime="11:25"}
    return Object.assign({},ev,{time:houseTime,text:houseText})
  }
  if(ev.title==="La máquina que recuerda"&&(state.flags.liraSafeRoute||state.flags.liraCoreCopied||state.flags.unit7Ally||state.flags.unit7Infiltrated||state.flags.h12RouteCompleted)){
    var nodeText=ev.text,nodeChoices=ev.choices.slice();
    if(state.flags.liraSafeRoute)nodeText="La ruta entregada por Lira desemboca detrás del Nodo 14, fuera del rastreo principal. El terminal conserva mapas de refugios, identidades registradas por el pulso y el origen de la señal; entre sus pulsos reconoce el núcleo de su hermano como memoria no autorizada. Abrir una sección todavía puede borrar otra, pero la Red UNO tarda más en comprender quién entró.";
    else if(state.flags.liraCoreCopied)nodeText="La copia del núcleo exiliado conduce al grupo hasta Nodo 14, pero también despierta una respuesta en el terminal. Su memoria conserva mapas de refugios, identidades registradas por el pulso y el origen de la señal mientras una lectura remota intenta reconstruir el camino que siguieron.";
    if(state.flags.unit7Ally||state.flags.unit7Infiltrated){
      nodeChoices[0]=state.flags.unit7Ally?{label:"Pedir a S-7 que reclame su registro original",hint:"Su protocolo de rescate puede abrir los archivos sin sacrificar otra identidad.",cost:"Alianza con S-7",title:"Una orden anterior a la Red UNO",result:"Nodo 14 reconoce la primera orden de S-7 y abre las rutas, nombres y protocolos que la red intentó sobrescribir. Por una vez, el error conserva más memoria que el sistema.",fx:{threat:-3,morale:3},archive:["protocol","names","sonar"],flags:{fullAccess:true,unit7Node14Access:true}}:{label:"Solicitar acceso encubierto a S-7",hint:"Desde dentro de la red, la unidad puede autorizar una consulta limpia.",cost:"Contacto infiltrado",title:"Corrección autorizada",result:"S-7 autoriza la consulta como una reparación de continuidad. Nodo 14 entrega los archivos completos sin advertir que una unidad obediente acaba de mentir.",fx:{threat:-5,morale:2},archive:["protocol","names","sonar"],flags:{fullAccess:true,unit7Node14Access:true}};
      nodeText+=" La identidad de S-7 permanece activa en el nodo y ofrece una vía que no existía en los registros del refugio.";
    }
    if(state.flags.h12CommuneBlind)nodeText+=" El mapa de actividad en vivo está negro sobre media comuna. Nodo 14 conserva los nombres históricos, pero ya no puede confirmar quién sigue respirando bajo ese vacío.";
    else if(state.flags.h12Line1Hidden)nodeText+=" El sector de Línea 1 aparece como una mancha sin habitantes. Todas las demás comunidades permanecen visibles y ordenadas por prioridad de intervención.";
    else if(state.flags.h12Controlled){nodeText+=" H-12 autoriza el enlace como mantenimiento aéreo autorizado. La vigilancia que debía cerrar el nodo puede abrirlo.";nodeChoices[1]={label:"Ordenar a H-12 que autorice la consulta",hint:"El dron redirigido entrega acceso completo sin consumir un núcleo ni una credencial.",cost:"Control de H-12",title:"Una mirada autorizada",result:"H-12 presenta al grupo como personal de continuidad y Nodo 14 abre rutas, nombres y protocolos. La consulta queda registrada como una corrección rutinaria.",fx:{threat:-4,morale:1},archive:["protocol","names","sonar"],flags:{fullAccess:true,h12Node14Access:true}}}
    return Object.assign({},ev,{text:nodeText,choices:nodeChoices})
  }
  if(ev.title==="El nido de vigilancia"&&state.flags.ortegaRouteCompleted){
    var ortegaNestChoices=ev.choices.slice(),ortegaNestText=ev.text;
    if(state.flags.ortegaPerimeterOpened){ortegaNestText="Las puertas abiertas permiten que cientos de personas identificadas salgan a las calles y el nido intenta seguirlas todas. Los drones todavía conservan armas, pero ya no distinguen una intrusión de una ciudad que decidió moverse al mismo tiempo.";ortegaNestChoices[1]={label:"Cruzar dentro del corredor civil",hint:"La apertura de Ortega satura el rastreo y permite avanzar sin combatir.",cost:"Corredor abierto",title:"Demasiadas vidas para un solo ojo",result:"Familias y patrullas civiles atraviesan las calles en direcciones distintas. Los drones reparten su atención hasta dejar libre la ruta hacia la torre.",fx:{threat:-4,morale:4},archive:["purpleHelmets","names"],flags:{droneNestBypassed:true,ortegaCivilNestCrossing:true}}}
    else if(state.flags.ortegaResidentControl){ortegaNestText="El nido gira hacia el grupo, pero las cámaras del distrito responden desde abajo con órdenes civiles contradictorias. Los residentes poseen ahora las claves locales y pueden abrir un vacío breve en la vigilancia aérea.";ortegaNestChoices[1]={label:"Pedir al distrito que apague el corredor",hint:"Los residentes encadenan puntos ciegos desde sus propias viviendas.",cost:"Control civil",title:"La ciudad cierra sus propios ojos",result:"Una ventana tras otra se apaga siguiendo un código improvisado. El enjambre pierde referencias y el grupo cruza por una calle que dejó de informar a la Red UNO.",fx:{threat:-6,morale:4},archive:["protocol"],flags:{droneNestBypassed:true,ortegaResidentBlindRoute:true}}}
    else if(state.flags.ortegaLine1Protected){ortegaNestText="El nido reconoce el sello privado de Ortega y abre una línea limpia hacia la torre. El corredor existe solo para Línea 1; en las pantallas laterales, las demás comunidades siguen marcadas como objetivos.";ortegaNestChoices[1]={label:"Usar el corredor reservado para Línea 1",hint:"Cruza sin combate aceptando que la protección excluye a los demás refugios.",cost:"Moral −3",title:"Una ruta para los propios",result:"Los drones separan sus trayectorias y dejan pasar al grupo. La ruta es segura porque todas las demás identidades permanecen disponibles para el rastreo.",fx:{threat:-7,morale:-3},archive:["purpleHelmets"],flags:{droneNestBypassed:true,ortegaPrivateRouteUsed:true}}}
    return Object.assign({},ev,{text:ortegaNestText,choices:ortegaNestChoices})
  }
  if(ev.title==="El nido de vigilancia"&&state.flags.h12CommuneBlind)return Object.assign({},ev,{text:"El nido debería despertar cuando el grupo pisa la azotea, pero todos los drones permanecen suspendidos en una oscuridad mecánica. El apagón de H-12 alcanzó el relé: pueden aprovechar sus restos, preservar el vacío o convertirlo en advertencia para las comunidades borradas.",choices:[
    {label:"Recuperar el núcleo central",hint:"Elías desmonta el relé sin reactivar la vigilancia.",cost:"Sin combate",title:"Tecnología bajo un cielo ciego",result:"El núcleo sale intacto y las rutas aéreas permanecen apagadas. NeoSantiago pierde un ojo y el grupo gana una pieza de la máquina.",fx:{threat:-4,morale:2},add:["droneCore"],archive:["sonar"],flags:{droneNestDown:true,h12BlindNestSalvaged:true}},
    {label:"Preservar el apagón",hint:"Renuncia al núcleo para que media comuna siga fuera del mapa.",cost:"Renuncia al núcleo",title:"El valor de no tocar nada",result:"El grupo cruza sin encender una sola óptica. Detrás de ellos, la azotea continúa muda y cientos de identidades siguen sin existir para la Red UNO.",fx:{threat:-7,morale:2},flags:{droneNestBypassed:true,h12BlackoutPreserved:true}},
    {label:"Emitir una advertencia comunitaria",hint:"Usa el relé apagado para avisar a refugios y exiliados antes de destruirlo.",cost:"Amenaza +3",title:"Una última mirada hacia afuera",result:"El relé transmite las zonas de captura antes de fundirse. Varias comunidades responden con golpes de radio y después vuelven al silencio.",fx:{threat:3,morale:4},archive:["names"],flags:{droneNestDown:true,h12WarningBroadcast:true}}
  ]});
  if(ev.title==="El nido de vigilancia"&&state.flags.h12Controlled)return Object.assign({},ev,{text:"Los drones del nido giran hacia el grupo y después bajan las armas. H-12 conserva el control que recibió en el repetidor, pero el enlace central todavía comunica con la Red UNO. Mantener ese poder exige decidir qué orden merece sobrevivir.",choices:[
    {label:"Dispersar el enjambre",hint:"H-12 reparte las unidades por rutas falsas y despeja el camino.",cost:"Control de H-12",title:"Cientos de calles vacías",result:"Los drones abandonan el nido siguiendo identidades inexistentes. La Red UNO ve movimiento en todas partes salvo donde realmente avanza el grupo.",fx:{threat:-8,morale:2},archive:["sonar"],flags:{droneNestBypassed:true,h12NestDispersed:true}},
    {label:"Copiar todas las rutas aéreas",hint:"Conserva el sistema y obtiene un mapa completo de vigilancia.",cost:"Amenaza +2",title:"El cielo convertido en mapa",result:"Elías descarga corredores, puntos ciegos y ciclos de recarga. H-12 continúa conectado, útil y peligrosamente vivo.",fx:{threat:2,morale:1},add:["routeMap"],archive:["sonar"],flags:{h12NestMapped:true}},
    {label:"Apagar H-12 y tomar su núcleo",hint:"Termina el control antes de que la Red UNO pueda recuperarlo.",cost:"Moral −2",title:"La última orden de H-12",result:"La voz repartida en hélices se apaga una unidad a la vez. El núcleo conserva el mapa, pero ya no puede decidir quién existe dentro de él.",fx:{threat:-3,morale:-2},add:["droneCore"],flags:{droneNestDown:true,h12ControlledShutdown:true}}
  ]});
  if(ev.title==="El nido de vigilancia"&&state.flags.h12Line1Hidden){
    var hiddenChoices=ev.choices.slice();
    hiddenChoices[1]={label:"Extender el vacío de Línea 1",hint:"Usa la exclusión ya preparada para engañar al enjambre sin gastar un núcleo.",cost:"Moral −2",title:"Una mentira que solo protege a los propios",result:"H-12 propaga el vacío de Línea 1 por los drones conectados. El enjambre se aleja del grupo, mientras las otras comunidades continúan dibujadas con una precisión brutal.",fx:{threat:-5,morale:-2},archive:["sonar"],flags:{droneNestBypassed:true,h12Line1LieExtended:true}};
    return Object.assign({},ev,{text:"El nido reconoce la excepción creada para Línea 1. El grupo puede extender esa mentira y cruzar sin combate, pero cada pantalla confirma que los demás refugios siguen dentro del mapa de captura.",choices:hiddenChoices})
  }
  if(ev.title==="Los cascos morados"&&state.flags.vegaRouteCompleted){
    var purpleText=ev.text,purpleChoices=ev.choices.slice();
    if(state.flags.erasedCitizensRestored){purpleText="El cordón morado intenta clasificar al grupo, pero miles de identidades restauradas saturan los visores. Vega aparece vivo, muerto y autorizado al mismo tiempo. Ortega debe decidir si dispara contra una anomalía o reconoce que el archivo dejó de obedecer.";purpleChoices[1]={label:"Presentar el registro restituido",hint:"Las identidades recuperadas obligan al cordón a reconocer ciudadanos que debía considerar muertos.",cost:"Amenaza +3",title:"Demasiados vivos para un solo protocolo",result:"Los visores llenan el corredor con nombres reactivados. Ortega ordena abrir una excepción antes de que la contradicción alcance a toda su unidad.",fx:{threat:3,morale:4},archive:["purpleHelmets","names"],flags:{purpleLineBypassed:true,vegaRestoredPass:true}}}
    else if(state.flags.line1OfficiallyRegistered){purpleText="Los cascos morados reciben una actualización imposible: Línea 1 vuelve a figurar como población civil reconocida. La puerta debe abrirse para sus representantes, aunque hacerlo confirma que el refugio existe y puede ser localizado.";purpleChoices[1]={label:"Entrar como delegación de Línea 1",hint:"Cruza sin combate usando el reconocimiento obtenido, pero confirma el vínculo del refugio con la torre.",cost:"Ubicación expuesta",title:"Ciudadanos bajo observación",result:"El cordón abre un pasillo reglamentario. Cada visor registra el paso del grupo y envía a la Red UNO la primera confirmación oficial de Línea 1 en décadas.",fx:{threat:-4,morale:-1},archive:["purpleHelmets"],flags:{purpleLineBypassed:true,line1LocationConfirmed:true}}}
    else if(state.flags.identityRegistryDestroyed){purpleText="Los visores morados consultan identidades que ya no existen. El cordón conserva armas, órdenes y disciplina, pero perdió la máquina que distinguía ciudadanos de amenazas.";purpleChoices[1]={label:"Cruzar durante el fallo de identidad",hint:"Aprovecha la ausencia del registro antes de que Ortega imponga una clasificación manual.",cost:"Ventana breve",title:"Nadie puede autorizar el disparo",result:"Cada visor devuelve una consulta vacía. El grupo atraviesa el cordón mientras los agentes esperan una orden que el sistema ya no puede justificar.",fx:{threat:-3,morale:2},flags:{purpleLineBypassed:true,identityPerimeterBlind:true}}}
    return Object.assign({},ev,{text:purpleText,choices:purpleChoices})
  }
  if(ev.title==="Los muertos sin núcleo"&&state.flags.vegaRouteCompleted){
    var deadText=ev.text,deadChoices=ev.choices.slice();
    if(state.flags.erasedCitizensRestored){deadText="Los lectores del vestíbulo vuelven a reconocer a los muertos. Sus nombres aparecen sobre agentes, cazadores y exiliados mezclados en la misma defensa. El registro restaurado permite saber quién cubrió a quién y qué tregua intentó borrar la Red UNO.";deadChoices[0]={label:"Reconstruir la tregua por sus nombres",hint:"Los expedientes restaurados revelan la secuencia sin depender de una prueba.",cost:"Registro restituido",title:"Los muertos vuelven a declarar",result:"Cada nombre devuelve una posición, una herida y una decisión. Los exiliados protegieron la retirada de los cazadores, y ambos ocultaron una ruta antes de morir.",fx:{morale:5,threat:-2},archive:["coreRite","truce","names"],add:["routeMap"],flags:{knowsTruce:true,vegaNamedTheDead:true}}}
    else if(state.flags.line1OfficiallyRegistered)deadText="Los cuerpos siguen sin nombre, salvo una etiqueta nueva que pregunta si alguno pertenecía a Línea 1. El sistema reconoce al refugio y reduce a todos los demás a procedencia no administrada.";
    else if(state.flags.identityRegistryDestroyed){deadText="Ninguna óptica consigue identificar los cuerpos. Destruir el registro impidió que la Red UNO volviera a utilizarlos, pero también dejó al grupo sin la prueba que podía devolverles sus nombres.";if(state.flags.vegaErasedNamesCopied){deadText+=" La copia que Elías rescató antes del colapso conserva suficientes coincidencias para reconstruir parte de la tregua.";deadChoices[0]={decisionId:"recoveredNames",label:"Comparar los cuerpos con la copia rescatada",hint:"La descarga previa conserva una fracción de los nombres destruidos.",cost:"Dificultad 10",roll:{dc:10,bonus:3,success:{title:"Una copia contra el olvido",result:"Las placas incompletas bastan para reconocer a quienes defendieron juntos la salida. La tregua sobrevive al registro que intentó apropiarse de ella.",fx:{morale:4,threat:-2},archive:["truce","names"],add:["routeMap"],flags:{knowsTruce:true,vegaCopyNamedDead:true}},fail:{title:"Nombres sin rostro",result:"La copia contiene identidades, pero no logra unirlas con todos los cuerpos. El grupo conserva la evidencia fragmentaria y debe avanzar.",fx:{morale:-2,threat:2},archive:["names"]}}}}
    }
    return Object.assign({},ev,{text:deadText,choices:deadChoices})
  }
  if(ev.title==="La puerta de continuidad"&&state.flags.ortegaRouteCompleted){
    var ortegaDoorText=ev.text,ortegaDoorChoices=ev.choices.slice();
    if(state.flags.ortegaPerimeterOpened){ortegaDoorText="La puerta de continuidad recibe la orden civil emitida por Ortega y trata de cerrar todos los accesos al mismo tiempo. El sello arrancado de su armadura todavía puede convertir la apertura del perímetro en un protocolo de evacuación hacia la torre.";ortegaDoorChoices[1]={label:"Presentar la última orden de Ortega",hint:"Usa el sello de mando para declarar la torre como salida civil.",cost:"Sello de mando",title:"Evacuación sin ciudadanos autorizados",result:"La puerta abre para una población que el sistema no consigue enumerar. El grupo entra con la misma orden que permite a otros abandonar el distrito.",fx:{threat:-4,morale:4},archive:["purpleHelmets","protocol"],flags:{towerEntered:true,safeExit:true,ortegaOpenedContinuity:true}}}
    else if(state.flags.ortegaResidentControl){ortegaDoorText="La puerta de continuidad espera una orden central que ya no existe. Desde el distrito, los residentes encadenan permisos domésticos, ascensores y rutas de mantenimiento hasta construir una autoridad que la torre no fue diseñada para rechazar.";ortegaDoorChoices[1]={label:"Aceptar la apertura del distrito",hint:"La autoridad civil combina cientos de permisos pequeños para abrir la torre.",cost:"Control comunitario",title:"Una puerta abierta desde las casas",result:"Cada vivienda aporta un fragmento de autorización. La suma supera al mando central y la puerta cede sin que una sola persona reclame el control completo.",fx:{threat:-5,morale:5},archive:["names","protocol"],flags:{towerEntered:true,safeExit:true,ortegaResidentsOpenedContinuity:true}}}
    else if(state.flags.ortegaLine1Protected){ortegaDoorText="El sello privado de Ortega reconoce al grupo como enlace exclusivo de Línea 1. La puerta puede abrirse sin alarma, pero cada confirmación fortalece el pacto secreto que dejó a las otras comunidades fuera de la protección.";ortegaDoorChoices[1]={label:"Usar el permiso de paso de Línea 1",hint:"Entra por la ruta protegida y conserva el acuerdo con Ortega.",cost:"Moral −2",title:"Seguridad escrita en singular",result:"La puerta confirma tres identidades y bloquea todas las demás. El grupo alcanza la torre por un corredor impecable que ningún otro refugio podrá utilizar.",fx:{threat:-6,morale:-2},archive:["purpleHelmets"],flags:{towerEntered:true,safeExit:true,ortegaPrivateDoorUsed:true}}}
    return Object.assign({},ev,{text:ortegaDoorText,choices:ortegaDoorChoices})
  }
  if(ev.title==="La puerta de continuidad"&&state.flags.vegaRouteCompleted){
    var doorText=ev.text,doorChoices=ev.choices.slice();
    if(state.flags.erasedCitizensRestored){doorText="La puerta de continuidad recibe demasiadas respuestas. Vega encabeza la marcha mientras el sistema confirma su muerte, restaura su nombre y vuelve a autorizarlo en el mismo pulso. El rastreador del corredor no puede resolver la contradicción sin negar a miles de ciudadanos.";doorChoices[1]={label:"Pedir a Vega que reclame su identidad",hint:"Su expediente restaurado puede abrir la torre como un conflicto administrativo.",cost:"Testimonio de Vega",title:"El muerto que exige paso",result:"Vega levanta el visor y pronuncia su nombre frente al lector. La puerta se abre para corregirlo; el grupo cruza antes de que la Red UNO decida qué versión eliminar.",fx:{threat:-5,morale:4},archive:["protocol","names"],flags:{towerEntered:true,vegaOpenedContinuity:true,safeExit:true}}}
    else if(state.flags.line1OfficiallyRegistered){doorText="La puerta reconoce a Línea 1 como comunidad civil y solicita una inspección presencial. La misma decisión que protege al refugio puede llevar a la Red UNO directamente hasta él.";doorChoices[1]={label:"Autorizar una inspección ficticia de Línea 1",hint:"Abre la torre usando el refugio como respaldo administrativo.",cost:"Moral −2",title:"El refugio convertido en credencial",result:"El sistema reserva una visita que nunca ocurrirá y abre la puerta al supuesto equipo inspector. La torre queda accesible; Línea 1 queda un poco menos oculta.",fx:{threat:-3,morale:-2},archive:["protocol"],flags:{towerEntered:true,line1InspectionForged:true}}}
    else if(state.flags.identityRegistryDestroyed){doorText="La puerta intenta consultar el registro destruido y entra en una espera circular. El corredor sigue armado, pero ningún sensor puede producir la clasificación necesaria para cerrar el acceso.";doorChoices[1]={label:"Entrar mientras el sistema busca nombres",hint:"Cruza durante el vacío administrativo creado por la destrucción del archivo.",cost:"Sin identificación",title:"Una puerta sin respuesta",result:"Los seguros permanecen abiertos esperando una identidad que ya no puede llegar. El grupo atraviesa el corredor antes de que los agentes cambien protocolo por fuerza.",fx:{threat:-4,morale:2},flags:{towerEntered:true,identityDoorBlind:true}}}
    if(state.flags.vegaAuthorizedProfilesCopied)doorChoices[2]={label:"Inyectar los patrones autorizados",hint:"Utiliza las identidades copiadas de los muertos para cerrar a la patrulla detrás del grupo.",cost:"Moral −3",title:"Los muertos vuelven a obedecer",result:"La torre acepta tres identidades ajenas y abre el acceso. El grupo cruza mientras las puertas se cierran sobre la patrulla; nadie pronuncia los nombres utilizados.",fx:{threat:-6,morale:-3},archive:["protocol"],flags:{towerEntered:true,authorizedDeadUsed:true}};
    return Object.assign({},ev,{text:doorText,choices:doorChoices})
  }
  if(ev.title==="La última patrulla"&&state.flags.ortegaFinalAid){
    var ortegaPatrolChoices=ev.choices.slice(),ortegaPatrolText;
    if(state.flags.ortegaPerimeterOpened){ortegaPatrolText="La última patrulla asciende hacia la antena, pero el canal de Ortega repite una orden de evacuación civil. Parte del cordón morado abandona la torre para sostener las puertas abiertas; los que continúan ya no saben si persiguen intrusos o desobedecen a su comandante.";ortegaPatrolChoices[1]={label:"Extender la contraorden de Ortega",hint:"Divide la patrulla y gana la ventana necesaria para transmitir.",cost:"Apoyo de Ortega",title:"Una cadena de mando rota",result:"Los ascensores separan a las unidades entre evacuación y contención. La sala queda asegurada sin batalla abierta mientras el último mensaje de Ortega se borra de la red.",fx:{threat:-5,morale:5},archive:["purpleHelmets"],flags:{antennaHeld:true,ortegaFinalCounterorder:true}}}
    else{ortegaPatrolText="Desde las viviendas, el distrito toma control de ascensores, cámaras y compuertas de servicio. La patrulla sigue subiendo, pero cada piso obedece ahora a personas distintas en lugar de una sola orden de la Red UNO.";ortegaPatrolChoices[1]={label:"Dejar que el distrito cierre los pisos",hint:"Los residentes aíslan a la patrulla desde la red local recuperada.",cost:"Apoyo comunitario",title:"Cientos de manos en el mecanismo",result:"Puertas domésticas, ascensores y esclusas se cierran en secuencia. La patrulla queda repartida por la torre y la antena obtiene una ventana limpia para transmitir.",fx:{threat:-6,morale:5},archive:["protocol","names"],flags:{antennaHeld:true,ortegaDistrictDefense:true}}}
    return Object.assign({},ev,{text:ortegaPatrolText,choices:ortegaPatrolChoices})
  }
  if(ev.title==="Los exiliados regresan"&&(state.flags.liraAlliance||state.flags.liraCoreClaimed||state.flags.vegaRouteCompleted)){
    var exileText=ev.text,exileChoices=ev.choices.slice();
    if(state.flags.liraAlliance)exileText="Lira entra primero en la Cámara de núcleos y repite el ritmo que abrió el Túnel de los núcleos. Los cinco exiliados reconocen al grupo que devolvió a su hermano y bajan las armas, aunque todavía exigen recuperar los nombres y memorias almacenados por la Red UNO.";
    else if(state.flags.liraCoreClaimed)exileText="Cinco exiliados entran en la torre siguiendo el pulso del núcleo separado del hermano de Lira. No vienen a negociar una pieza: vienen a recuperar a uno de los suyos. Cada luz roja de la cámara apunta ahora hacia la mochila del grupo.";
    if(state.flags.erasedCitizensRestored){exileText+=" En sus visores aparecen nombres anteriores al destierro. La bóveda de Vega ya los devolvió al registro y, por primera vez, la Red UNO debe reconocer que nunca dejaron de ser personas.";exileChoices[0]={label:"Mostrar los nombres restaurados",hint:"La prueba devuelve a los exiliados su identidad civil y abre la cámara sin combate.",cost:"Registro restituido",title:"Nombres anteriores al exilio",result:"Los exiliados escuchan sus nombres y bajan las armas. Recuperan los núcleos como memoria, no como botín, y entregan una salida fuera del rastreo.",fx:{morale:5,threat:-7},archive:["truce","exiles","names"],flags:{exileAlliance:true,safeExit:true,vegaExilesRecognized:true}}}
    else if(state.flags.line1OfficiallyRegistered)exileText+=" El registro reconoce únicamente a Línea 1. Los exiliados comprenden que el grupo tuvo la posibilidad de devolver miles de nombres y eligió proteger solo los propios.";
    else if(state.flags.identityRegistryDestroyed){exileText+=" El archivo que podía demostrar quiénes eran ya no existe.";if(state.flags.vegaErasedNamesCopied){exileText+=" Sin embargo, Elías conserva una copia parcial tomada antes de la destrucción.";exileChoices[0]={label:"Entregar la copia de los nombres borrados",hint:"La prueba incompleta no depende ya de la Red UNO.",cost:"Copia recuperada",title:"Memoria fuera del sistema",result:"Los exiliados reconocen nombres familiares entre los fragmentos. La copia no devuelve ciudadanía, pero basta para abrir la cámara y aceptar una tregua.",fx:{morale:4,threat:-5},archive:["truce","exiles"],flags:{exileAlliance:true,safeExit:true,vegaCopyShared:true}}}}
    return Object.assign({},ev,{text:exileText,choices:exileChoices})
  }
  return ev
}
function render(){
  if(typeof resolveNarrativeFinale==="function"&&resolveNarrativeFinale())return;
  var raw=events[state.index],ev=eventDisplay(raw,state.index),stage=$("stage"),nextScene=sceneKeyForEvent(ev),currentScene=stage.dataset.scene||"";if(currentScene!==nextScene){var prevBackground=getComputedStyle(stage).backgroundImage;stage.dataset.scene=nextScene;if(currentScene)pulseStageFade(prevBackground)}$("day").textContent="Día "+String(ev.day).padStart(2,"0")+" / 03";$("time").textContent=ev.time;$("time").title="Hora narrativa: cambia al avanzar las escenas. Leer no consume tiempo.";$("threatValue").textContent=state.threat+"%";$("threatBar").style.width=state.threat+"%";stage.dataset.day=ev.day;$("chapter").textContent=chapters[ev.day];$("location").textContent=ev.loc;$("progress").textContent="Situación "+(state.index+1)+" de "+events.length;$("eventType").textContent=ev.type;$("eventTitle").textContent=ev.title;$("eventText").textContent=ev.text;renderContextArchives(ev);
  // New entries start at the top; refreshing the same entry preserves the reading position.
  if(stage.dataset.journalEntry!==String(state.index)){stage.scrollTop=0;stage.dataset.journalEntry=String(state.index)}
  $("choices").innerHTML=ev.choices.map(function(c,i){if(typeof narrativeBlocked==="function"&&narrativeBlocked(c))return "";var why=reason(c);return'<button class="choice'+(c.roll?' choice-check':'')+'" data-choice="'+i+'" '+(why?"disabled":"")+'><span class="num">'+(i+1)+'</span><span><strong>'+esc(c.label)+"</strong><small>"+esc(choiceHintText(c,why))+"</small></span><span class=\"cost\">"+esc(decisionCostText(c))+"</span></button>"}).join("");
  Array.prototype.forEach.call(document.querySelectorAll("[data-choice]"),function(b){b.addEventListener("click",function(){choose(Number(b.dataset.choice))})});if(typeof renderCompanionCare==="function")renderCompanionCare();renderSignalHud();renderMini();if(typeof fieldScheduleOffer==="function")fieldScheduleOffer()
}
function renderMini(){
  ...
  var r=[["Alimento",stockCount("food")],["Agua",stockCount("water")],["Medicina",stockCount("meds")],["Munición",ammoTotal()],["Tela",stockCount("cloth")],["Batería",stockCount("battery")],["Créditos",state.credits],["Puntos facción",state.factionPoints],["Moral",state.morale+"%"]],main=missionDefs[0],progress=missionProgress(main),percent=Math.round(100*progress/main.target),openMissions=missionDefs.filter(function(def){return !def.main&&missionProgress(def)<def.target}).length;
...
function openArchive(id,opener){
  var summary=archives[id],doc=archiveTexts[id];if(!summary||!doc)return;var evidenceNote=typeof evidenceArchiveNote==="function"?evidenceArchiveNote(id):"";if(evidenceNote)doc=Object.assign({},doc,{body:[evidenceNote].concat(doc.body)});archiveOpener=opener||null;$("archiveDocClass").textContent=doc.classification;$("archiveDocTitle").textContent=summary[0];$("archiveDocSource").textContent=doc.source;$("archiveDocDate").textContent=doc.date;$("archiveDocSummary").textContent=summary[1];$("archiveDocBody").innerHTML=doc.body.map(function(p){return"<p>"+esc(p)+"</p>"}).join("");$("archiveModal").classList.remove("hidden");$("archiveReaderScroll").scrollTop=0;$("closeArchive").focus()
}
...
function switchWorldLore(section){if(!loreSections[section])section="opening";Object.keys(loreSections).forEach(function(key){var ids=loreSections[key],active=key===section,tab=$(ids[0]),panel=$(ids[1]);tab.classList.toggle("active",active);tab.setAttribute("aria-selected",active?"true":"false");tab.setAttribute("aria-controls",ids[1]);panel.setAttribute("aria-labelledby",ids[0]);panel.classList.toggle("hidden",!active)});$("worldLoreScroll").scrollTop=0}
...
function openWorldLore(opener){worldLoreOpener=opener||null;closePanel();switchWorldLore("opening");switchFaction("rotos");$("gameIntro").setAttribute("inert","");$("worldLoreModal").classList.remove("hidden");$("closeWorldLore").focus()}
function closeWorldLore(){if($("worldLoreModal").classList.contains("hidden"))return;$("worldLoreModal").classList.add("hidden");$("gameIntro").removeAttribute("inert");if(worldLoreOpener&&worldLoreOpener.focus)worldLoreOpener.focus();worldLoreOpener=null}
function worldLoreKeydown(e){
  var modal=$("worldLoreModal");if(modal.classList.contains("hidden"))return false;
  if(e.key==="Escape"){e.preventDefault();closeWorldLore();return true}
  if(e.key==="Tab"){
    var controls=Array.prototype.filter.call(modal.querySelectorAll('button,a[href],[tabindex="0"]'),function(n){return !n.disabled&&!n.closest('.hidden')});
...
function openPanel(type){
  ...
  if(type!=="missions"&&type!=="archive"&&type!=="decisions"&&type!=="care")html=list.length?list.map(function(x){return'<article class="drawer-item"><strong>'+esc(x[0])+"</strong><p>"+esc(x[1])+"</p></article>"}).join(""):'<p class="empty">Todavía no hay registros en esta sección.</p>';
  $("drawerTitle").textContent=title;$("drawerContent").innerHTML=html;if(type==="decisions"){drawNarrativeMap($("decisionMapPreview"),narrativeMapRoute);$("decisionMapPreview").style.height="auto";$("decisionMapChapter").addEventListener("change",function(){if(routeNarrativeDefs[this.value]||this.value==="towerFinale"){narrativeMapRoute=this.value;openPanel("decisions")}});$("downloadDecisionMap").addEventListener("click",downloadDecisionMap);}Array.prototype.forEach.call(document.querySelectorAll("[data-open-archive]"),function(b){b.addEventListener("click",function(){openArchive(b.dataset.openArchive,b)})});Array.prototype.forEach.call(document.querySelectorAll("[data-open-world-lore]"),function(b){b.addEventListener("click",function(){openWorldLore($("archiveNav"))})});$("shade").classList.remove("hidden");$("drawer").classList.remove("hidden");$("closeDrawer").focus()
}
function closePanel(){$("shade").classList.add("hidden");$("drawer").classList.add("hidden");if(typeof carePanelClosed==="function")carePanelClosed()}
...
// The opening is saved at page boundaries; no supplies or refuge visits are granted here.
var introPages=[
  {
    "chapter": "Prólogo · Los Héroes",
    "title": "Antes de que abran",
    "image": "backgrounds/station-ruins.webp",
    "alt": "El andén del Metro convertido en refugio",
    "location": "Antigua Línea 1 · Los Héroes",
    "text": "Mara separa las provisiones sobre una mesa. A un lado deja lo que puede salir; al otro, lo que debe alcanzar para quienes se quedan. Cuenta las vendas una segunda vez.\n\nMás allá del puesto, alguien remienda una mochila mientras un niño sostiene la lámpara. Por el túnel llega el olor de la comida. Los que esperan su turno miran hacia la escalera cada vez que oyen pasos.\n\nAquí viven los Rotos. Hay que salir a buscar lo que falta, pero nadie sabe con qué volverá el próximo grupo."
  },
  {
    "chapter": "Prólogo · La superficie",
    "title": "Arriba todavía vigilan",
    "image": "backgrounds/day-alameda.webp",
    "alt": "La Alameda entre edificios vacíos y vegetación",
    "location": "NeoSantiago · 2130",
    "text": "Arriba, las raíces levantan las veredas y los semáforos cambian de color aunque nadie cruce. En el territorio de la Gobernanza Unida, la Red UNO identifica, abastece y vigila a sus habitantes. Vivir bajo su protección significa dejar que sepan dónde estás.\n\nLos Rotos rechazaron ese control. En los túneles conservan papeles, herramientas y relatos de un Santiago que los más jóvenes nunca conocieron. Evitan los aparatos que podrían delatarlos. Aun así, necesitan subir: no todo se puede cultivar, reparar o encontrar bajo tierra."
  },
  {
    "chapter": "Prólogo · La transmisión",
    "title": "Una voz sin nombre",
    "image": "backgrounds/antenna-core-room.webp",
    "alt": "Equipos de transmisión en una instalación de la Red UNO",
    "location": "Una señal detectada durante la noche",
    "text": "Durante la noche llegó una voz por una frecuencia de la Red UNO: «todavía estamos aquí». Elías ha anotado las palabras. Sara le pide que revise si hay un nombre. No lo hay.\n\n—¿Y si esperan que respondamos? —pregunta Noa.\n\nElías deja el lápiz. Todavía no sabe si la transmisión pide ayuda o busca una respuesta que permita localizar el refugio. Sara vuelve a leer la hoja.\n\n—También puede haber alguien esperando de verdad.\n\nEl consejo autoriza una expedición de tres días para buscar su origen."
  },
  {
    "chapter": "Tu expedición",
    "title": "Salir y poder volver",
    "image": "backgrounds/day-station-entrance.webp",
    "alt": "La salida del Metro hacia la superficie",
    "location": "Antes de abrir la compuerta",
    "text": "Sara revisa qué podrán llevar para atender a un herido. Elías busca cómo acercarse a la señal sin exponer al grupo. Noa comprueba la ruta de regreso antes de mirar la de salida. Trabajan juntos; eso no significa que vayan a estar de acuerdo.\n\nEn la historia principal decidirás cómo actúan los tres. Primero hablarás con Varela y prepararás las mochilas con Mara. Cada escena te mostrará las opciones disponibles y sus riesgos.\n\nTambién puedes acompañar a Rocío, Tomás y Bruno en los encargos entre refugios. Cada equipo conserva sus recursos y su propio avance. Puedes consultar «Cómo jugar» cuando lo necesites durante esta introducción.",
    "action": "Elegir actividad"
  }
];
// Read-only help: it pauses the introduction without advancing or changing the run.
var gameHelpStep=0;
var gameHelpPages=[
  {title:"Tu objetivo",text:"Sigue la señal imposible de la Red UNO con Sara, Elías y Noa. Recorre los tres días de la campaña, descubre quién la envió y decide qué hacer con la verdad.\n\nLa expedición avanza al resolver las escenas. Los desvíos permiten ayudar a otras personas, conseguir información y cambiar lo que ocurre después.",tip:"Consulta las misiones para ver tus objetivos y las condiciones de sus recompensas. Tus decisiones conducen a distintos finales."},
  {title:"Elegir y asumir el riesgo",text:"Lee lo que propone cada opción y su costo antes de elegir. Algunas necesitan un objeto o una decisión anterior. Si aparece una rueda, podrás ver los desenlaces y sus probabilidades antes de confirmar.\n\nEl ánimo de los personajes puede cambiar esas probabilidades. Un fallo puede costar recursos, causar heridas o iniciar un combate, según la escena.",tip:"En las escenas con tiempo de decisión, revisa la opción marcada por defecto: se elige si el reloj termina."},
  {title:"Cuidar al grupo",text:"Los HP indican la salud; la energía ayuda a sostener la expedición. Usa medicina para las heridas y alimento para recuperar energía desde las fichas de los personajes.\n\nLa moral pertenece al grupo. Si se agota, tendrán que regresar al refugio. Allí puedes descansar y reagruparte. Al cerrar los días 1 y 2 decides si compartir una ración o conservarla. El descanso usa 1 agua si queda. Sin comida pierdes 8 de energía y 5 de moral; sin agua, 8 de moral. Son reservas compartidas, no una unidad por persona.",tip:"Estar a 0 HP significa quedar agotado. Recupera al personaje antes de volver a contar con él."},
  {title:"Enfrentar un combate",text:"Selecciona un enemigo y después una acción para el aliado que tiene el turno. Disparar consume la munición adecuada; también puedes usar ataques cuerpo a cuerpo, habilidades y objetos disponibles.\n\nLa cobertura ayuda a protegerse. Si el combate se vuelve insostenible, puedes intentar retirarte, con las consecuencias que indique la batalla.",tip:"Revisa la salud, las balas y el equipo antes de entrar. El inhibidor no evita enemigos que ya tienen al grupo delante."},
  {title:"Recuperar y preparar",text:"Después de vencer, elige quién recoge el loot. Cada unidad necesita espacio en su mochila: reparte objetos entre los aliados para poder llevar lo que te sirva.\n\nDesde sus fichas puedes equipar, transferir y fabricar. Sara prepara medicina, Elías trabaja con piezas y Noa fabrica granadas y EMP. Las recetas indican qué materiales consumen.",tip:"Mara compra tu loot a cambio de créditos y vende suministros. El Armero ofrece armas; equípalas desde la ficha del aliado."},
  {title:"Ocultar la señal",text:"Al salir, Elías te pedirá copiar códigos de flechas antes de que termine el tiempo. Cada error resta tiempo; tres errores alertan a los drones.\n\nSi logras sincronizar, el inhibidor oculta las señales vitales durante un tiempo de exploración. Su reloj se pausa al leer en ventanas narrativas, gestionar equipo o combatir.",tip:"Cuando se agote la cobertura, puedes volver a sincronizar, usar una batería disponible o avanzar expuesto y arriesgar un encuentro por rastreo."},
  {title:"Crecer y continuar",text:"Combatir y fabricar entregan experiencia a los personajes. Al subir de nivel mejoran su capacidad para sobrevivir. Las victorias y decisiones con impacto también pueden dar puntos de facción: inviértelos en las habilidades de las fichas.\n\nLa partida se guarda automáticamente fuera de los enfrentamientos. Si cierras durante un encuentro sin resolver, volverás al último punto guardado.",tip:"No necesitas memorizar todo ahora. Empieza por preparar las mochilas con Mara y revisa lo que te ofrece cada nueva escena."}
];
function showGameHelpPage(step){
  gameHelpStep=clamp(Math.floor(Number(step)||0),0,gameHelpPages.length-1);var page=gameHelpPages[gameHelpStep];
  $("gameHelpTitle").textContent=page.title;$("gameHelpText").textContent=page.text;$("gameHelpTip").textContent=page.tip;
  $("gameHelpBack").disabled=gameHelpStep===0;$("gameHelpNext").textContent=gameHelpStep===gameHelpPages.length-1?"Volver a la introducción":"Avanzar";
  $("gameHelpReading").scrollTop=0;$("gameHelpNext").focus({preventScroll:true})
}
function openGameHelp(){
  if($("gameIntro").classList.contains("hidden"))return;
  $("gameIntro").setAttribute("inert","");$("gameHelpModal").classList.remove("hidden");showGameHelpPage(0)
}
function closeGameHelp(restoreFocus){
  var wasOpen=!$("gameHelpModal").classList.contains("hidden");$("gameHelpModal").classList.add("hidden");$("gameIntro").removeAttribute("inert");
  if(wasOpen&&restoreFocus!==false&&!$("gameIntro").classList.contains("hidden"))$("openGameHelp").focus({preventScroll:true})
}
function gameHelpKeydown(e){
  if($("gameHelpModal").classList.contains("hidden"))return false;
  if(e.key==="Escape"){e.preventDefault();closeGameHelp();return true}
  if(e.key==="Tab"){
    var first=$("closeGameHelp"),last=$("gameHelpNext"),active=document.activeElement;
    if(e.shiftKey&&active===first){e.preventDefault();last.focus()}
    else if(!e.shiftKey&&active===last){e.preventDefault();first.focus()}
  }
  return true
}
function clearIntroTyping(){clearInterval(introTypeTimer);introTypeTimer=null}
function revealIntroText(){
  if($("gameIntro").classList.contains("hidden"))return;
  clearIntroTyping();$("introText").textContent=introPages[introStep].text;
  $("introAccessible").textContent=introPages[introStep].text;
  $("introReveal").classList.add("finished");$("introReveal").disabled=true;
  $("introActions").removeAttribute("inert");$("introActions").classList.add("ready");
  if(document.activeElement===$("introReveal"))$("introNext").focus({preventScroll:true})
}
function showGameIntro(step){
  closeGameHelp(false);clearIntroTyping();introStep=clamp(Math.floor(Number(step)||0),0,introPages.length-1);state.introPage=introStep;
  var page=introPages[introStep];$("introChapter").textContent=page.chapter;$("introTitle").textContent=page.title;
  $("introScene").classList.toggle("is-speaker",!!page.speaker);$("introImage").src=assetUrl(page.image);$("introImage").alt=page.alt;$("introLocation").textContent=page.location;
  $("introNext").textContent=page.action||"Avanzar";$("introBack").classList.toggle("hidden",introStep===0);
  $("introActions").classList.remove("ready");$("introActions").setAttribute("inert","");
  $("introReveal").classList.remove("finished");$("introReveal").disabled=false;
  $("introText").textContent="";$("introAccessible").textContent="";$("introReading").scrollTop=0;introTextPosition=0;
  $("gameIntro").classList.remove("hidden");$("introReveal").focus({preventScroll:true});save();
  if(window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches){revealIntroText();return}
  introTypeTimer=setInterval(function(){
    if($("gameIntro").classList.contains("hidden")){clearIntroTyping();return}
    if(cinematicRunning||document.hidden||!$("worldLoreModal").classList.contains("hidden")||!$("gameHelpModal").classList.contains("hidden"))return;
    introTextPosition=Math.min(page.text.length,introTextPosition+2);$("introText").textContent=page.text.slice(0,introTextPosition);
    if(introTextPosition>=page.text.length)revealIntroText()
  },24)
}
function advanceGameIntro(){
  if(state.introCompleted||$("gameIntro").classList.contains("hidden"))return;
  if(introTypeTimer){revealIntroText();return}
  if(introStep<introPages.length-1)showGameIntro(introStep+1);else completeIntro()
}
function completeIntro(){
  if(state.introCompleted||introStep!==introPages.length-1||introTypeTimer)return;
  clearIntroTyping();state.introCompleted=true;$("gameIntro").classList.add("hidden");if(typeof openActivityMenu==="function")openActivityMenu();else openRefuge("start")
}
function introKeydown(e){
  if(gameHelpKeydown(e))return true;
  if($("gameIntro").classList.contains("hidden")||!$("worldLoreModal").classList.contains("hidden"))return false;
  if(e.key==="Tab"){
    var buttons=[introTypeTimer?$("introReveal"):null,!introTypeTimer&&introStep>0?$("introBack"):null,!introTypeTimer?$("introNext"):null,$("openGameHelp"),$("openWorldLore")].filter(Boolean);
    var first=$("introReading"),last=buttons[buttons.length-1];
    if(e.shiftKey&&document.activeElement===first){e.preventDefault();last.focus()}
    else if(!e.shiftKey&&document.activeElement===last){e.preventDefault();first.focus()}
  }
  if((e.key==="Enter"||e.key===" ")&&introTypeTimer&&document.activeElement===$("introReading")){e.preventDefault();revealIntroText()}
  return true
}
...
function enterTitleScreen(){
  ...
  playOpeningCinematic(function(){
    title.classList.add("hidden");title.classList.remove("leaving");
    if($("continueGame").classList.contains("hidden")){newGame();return}
    $("start").classList.remove("hidden");$("continueGame").focus()
  })
}
function newGame(){
  if(typeof resetActivityProgress==="function"&&!resetActivityProgress())return;
  if(typeof closeWorldNews==="function")closeWorldNews(false);
  if(typeof hideActivities==="function")hideActivities();
  if(typeof fieldResetUI==="function")fieldResetUI();
  if(typeof resetCrateUI==="function")resetCrateUI();
  if(typeof resetCombatPresentation==="function")resetCombatPresentation();closeItemDetails(false);closeRefugeHelp(false);closeGameHelp(false);clearDecision();gameSessionActive=true;encounterSaveLocked=false;state=fresh();pending=null;battleState=null;transferDraft=null;discardDraft=null;disassemblyState=null;npcDialogueState=null;routeNarrativeState=null;signalGameState=null;archiveOpener=null;audioClueOpener=null;worldLoreOpener=null;signalLastTick=Date.now();signalSaveAccumulator=0;clearInterval(lootInterval);clearInterval(disassemblyTimer);clearInterval(npcDialogueTimer);resetSignalRoundTimer();clearRouteNarrativeTimers();resetAudioCluePlayer();["titleScreen","start","gameIntro","worldLoreModal","battle","final","summary","refuge","profileModal","transferModal","discardModal","disassemblyModal","lootModal","logisticsModal","archiveModal","audioClueModal","npcDialogueModal","routeNarrativeModal","signalModal","signalWarningModal","result","night","drawer","shade"].forEach(function(id){$(id).classList.add("hidden")});render();save();showGameIntro(0)}
function continueGame(){if(typeof fieldResetUI==="function")fieldResetUI();if(typeof resetCrateUI==="function")resetCrateUI();closeItemDetails(false);closeRefugeHelp(false);closeGameHelp(false);clearDecision();if(!load()){toast("No se pudo restaurar la partida. El guardado se conserva; elige Nueva partida si quieres empezar de nuevo.");return}gameSessionActive=true;encounterSaveLocked=false;signalLastTick=Date.now();$("titleScreen").classList.add("hidden");$("start").classList.add("hidden");render();if(!state.introCompleted)showGameIntro(state.introPage);else if(state.activity==="hub"||state.activity==="couriers"){openActivityMenu();if(state.activity==="couriers")openCourierActivity()}else if(typeof pendingNight==="function"&&pendingNight())showNight();else if(state.finished&&state.ending){if(state.summarySeen)showRunSummary();else finish(state.ending)}else if(state.refuge.active)openRefuge(state.refuge.reason,true);else if(typeof resumeCrate==="function"&&resumeCrate())return;else if(state.inhibitor.pendingContact==="hack"||state.inhibitor.pendingContact==="exposed")startTrackingCombat(state.inhibitor.pendingContact);else{toast("Partida restaurada");if(state.inhibitor.needsSync&&!state.inhibitor.active)setTimeout(function(){openSignalHack("restore")},320)}}
...
$("enterTitle").addEventListener("click",enterTitleScreen);$("newGame").addEventListener("click",newGame);$("continueGame").addEventListener("click",continueGame);$("openWorldLore").addEventListener("click",function(){openWorldLore($("openWorldLore"))});$("closeWorldLore").addEventListener("click",closeWorldLore);$("closeWorldLoreBottom").addEventListener("click",closeWorldLore);Object.keys(loreSections).forEach(function(key){$(loreSections[key][0]).addEventListener("click",function(){switchWorldLore(key)})});Object.keys(factionSections).forEach(function(key){$(factionSections[key][0]).addEventListener("click",function(){switchFaction(key)})});$("openGameHelp").addEventListener("click",openGameHelp);$("closeGameHelp").addEventListener("click",function(){closeGameHelp()});$("gameHelpBack").addEventListener("click",function(){showGameHelpPage(gameHelpStep-1)});$("gameHelpNext").addEventListener("click",function(){if(gameHelpStep===gameHelpPages.length-1)closeGameHelp();else showGameHelpPage(gameHelpStep+1)});$("introReveal").addEventListener("click",revealIntroText);$("introNext").addEventListener("click",advanceGameIntro);$("introBack").addEventListener("click",function(){showGameIntro(introStep-1)});$("advance").addEventListener("click",advance);$("dialogueSkip").addEventListener("click",advanceNpcDialogueText);$("dialogueContinue").addEventListener("click",closeNpcDialogueAndContinue);$("routeNarrativeButton").addEventListener("click",advanceRouteNarrative);$("nextDay").addEventListener("click",function(){continueAfterNight()});$("finalContinue").addEventListener("click",showRunSummary);$("downloadPng").addEventListener("click",downloadResultPng);$("restart").addEventListener("click",newGame);$("npcTabMara").addEventListener("click",function(){switchRefugeNpc("mara")});$("npcTabArmorer").addEventListener("click",function(){switchRefugeNpc("armorer")});$("starterKit").addEventListener("click",acceptStarterKit);$("refugeRest").addEventListener("click",function(){openRefugeHelp("rest",$("refugeRest"))});$("refugeEconomyHelp").addEventListener("click",function(){openRefugeHelp("economy",$("refugeEconomyHelp"))});$("refugeHelpContinue").addEventListener("click",continueRefugeHelp);$("refugeRejoin").addEventListener("click",rejoinAtRefuge);$("leaveRefuge").addEventListener("click",leaveRefuge);$("closeLogistics").addEventListener("click",closeLogisticsBriefing);$("backToRefuge").addEventListener("click",closeLogisticsBriefing);$("confirmLogistics").addEventListener("click",confirmLeaveRefuge);$("logisticsModal").addEventListener("click",function(e){if(e.target===$("logisticsModal"))closeLogisticsBriefing()});$("signalClock").addEventListener("click",function(){openSignalHack("manual")});$("signalPrimary").addEventListener("click",signalPrimaryAction);$("signalSecondary").addEventListener("click",signalSecondaryAction);$("signalWarningPrimary").addEventListener("click",signalWarningPrimaryAction);$("signalWarningSecondary").addEventListener("click",signalWarningSecondaryAction);$("signalBattery").addEventListener("click",extendSignalWithBattery);Array.prototype.forEach.call(document.querySelectorAll("[data-signal-key]"),function(b){b.addEventListener("click",function(){signalInput(b.dataset.signalKey)})});$("closeDrawer").addEventListener("click",closePanel);$("shade").addEventListener("click",closePanel);$("closeProfile").addEventListener("click",closeProfile);$("closeTransfer").addEventListener("click",closeTransferModal);$("transferModal").addEventListener("click",function(e){if(e.target===$("transferModal"))closeTransferModal()});$("closeDiscard").addEventListener("click",closeDiscardModal);$("cancelDiscard").addEventListener("click",closeDiscardModal);$("confirmDiscard").addEventListener("click",confirmDiscardProfileItem);$("discardModal").addEventListener("click",function(e){if(e.target===$("discardModal"))closeDiscardModal()});$("closeDisassembly").addEventListener("click",closeDisassemblyModal);$("disassemblyAttempt").addEventListener("click",attemptDisassembly);$("disassemblyDone").addEventListener("click",closeDisassemblyModal);$("closeLoot").addEventListener("click",closeLootModal);$("closeArchive").addEventListener("click",closeArchive);$("closeArchiveBottom").addEventListener("click",closeArchive);$("closeAudioClue").addEventListener("click",closeAudioClue);$("closeAudioClueBottom").addEventListener("click",closeAudioClue);$("audioCluePlay").addEventListener("click",toggleAudioClue);$("takeAllLoot").addEventListener("click",takeAllLoot);$("finishLoot").addEventListener("click",finishLooting);$("itemsToggle").onclick=function(){if(battleState&&battleState.phase==="combat")$("itemTray").classList.toggle("hidden")};
...
document.addEventListener("keydown",function(e){if(cinematicRunning){e.preventDefault();if(e.key==="Tab")$("cinematicSkip").focus();if(e.key==="Escape"||((e.key==="Enter"||e.key===" ")&&document.activeElement===$("cinematicSkip")))revealCinematicDestination();return}if(typeof carePanelKeydown==="function"&&carePanelKeydown(e))return;if(typeof nightKeydown==="function"&&nightKeydown(e))return;if(typeof worldNewsKeydown==="function"&&worldNewsKeydown(e))return;if(worldLoreKeydown(e))return;if(itemDetailsKeydown(e))return;if(typeof crateKeydown==="function"&&crateKeydown(e))return;if(refugeHelpKeydown(e))return;if(introKeydown(e))return;if(decisionKeydown(e))return;if(signalModalVisible()){var signalKey=signalKeys[e.key];if(signalKey&&signalGameState&&signalGameState.screen==="game"){e.preventDefault();signalInput(signalKey);return}if((e.key==="Enter"||e.key===" ")&&signalGameState&&signalGameState.screen!=="game"){e.preventDefault();signalPrimaryAction()}return}if(signalWarningVisible()){if(e.key==="Enter"||e.key===" "){e.preventDefault();signalWarningPrimaryAction()}return}if(!$("titleScreen").classList.contains("hidden")&&(e.key==="Enter"||e.key===" ")){e.preventDefault();enterTitleScreen();return}if(!$("disassemblyModal").classList.contains("hidden")){if(e.key==="Escape"){e.preventDefault();closeDisassemblyModal();return}if((e.key==="Enter"||e.key===" ")&&disassemblyState){e.preventDefault();if(disassemblyState.finished)closeDisassemblyModal();else attemptDisassembly()}return}if(!$("npcDialogueModal").classList.contains("hidden")){if((e.key==="Enter"||e.key===" ")&&npcDialogueTimer){e.preventDefault();revealNpcDialogueText()}return}if(!$("routeNarrativeModal").classList.contains("hidden")){if((e.key==="Enter"||e.key===" ")&&routeNarrativeState){e.preventDefault();advanceRouteNarrative();return}if(["1","2","3","4"].indexOf(e.key)>=0&&routeNarrativeState&&routeNarrativeState.optionsVisible){e.preventDefault();selectRouteNarrativeChoice(Number(e.key)-1)}return}if(e.key==="Escape"&&!$("worldLoreModal").classList.contains("hidden")){closeWorldLore();return}if(e.key==="Escape"&&!$("archiveModal").classList.contains("hidden")){closeArchive();return}if(e.key==="Escape"&&!$("audioClueModal").classList.contains("hidden")){closeAudioClue();return}if(e.key==="Escape"&&!$("discardModal").classList.contains("hidden")){closeDiscardModal();return}if(e.key==="Escape"&&!$("transferModal").classList.contains("hidden")){closeTransferModal();return}if(e.key==="Escape"&&!$("logisticsModal").classList.contains("hidden")){closeLogisticsBriefing();return}if(e.key==="Escape"&&!battleState){closePanel();closeProfile()}if((e.target&&(e.target.isContentEditable||/^(INPUT|TEXTAREA|SELECT)$/.test(e.target.tagName)))||!$("drawer").classList.contains("hidden")||!$("transferModal").classList.contains("hidden")||!$("discardModal").classList.contains("hidden")||battleState||!$("titleScreen").classList.contains("hidden")||!$("start").classList.contains("hidden")||!$("gameIntro").classList.contains("hidden")||!$("worldLoreModal").classList.contains("hidden")||!$("result").classList.contains("hidden")||!$("night").classList.contains("hidden")||!$("final").classList.contains("hidden")||!$("summary").classList.contains("hidden")||!$("refuge").classList.contains("hidden")||!$("profileModal").classList.contains("hidden")||!$("logisticsModal").classList.contains("hidden")||!$("archiveModal").classList.contains("hidden")||!$("audioClueModal").classList.contains("hidden")||!$("routeNarrativeModal").classList.contains("hidden"))return;if(["1","2","3","4"].indexOf(e.key)>=0)choose(Number(e.key)-1)});
$("decisionConfirm").addEventListener("click",decisionPrimaryAction);$("decisionBack").addEventListener("click",closeDecision);
document.addEventListener("visibilitychange",function(){signalLastTick=Date.now();if(document.hidden)save()});window.addEventListener("beforeunload",save);signalGlobalTimer=setInterval(signalGlobalTick,250);
