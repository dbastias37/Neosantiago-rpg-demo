...
function eventDisplay(ev,index){
  ...
  if(ev.title==="La máquina que recuerda"&&(state.flags.liraSafeRoute||state.flags.liraCoreCopied||state.flags.unit7Ally||state.flags.unit7Infiltrated)){
    var nodeText=ev.text,nodeChoices=ev.choices;
