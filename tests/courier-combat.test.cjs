...
async function battle(saved){
 ...
 if(!world){for(let seed=0;seed<100;seed++){world=E.advance(data,E.start(data,E.createWorld(data,{seed}),'adasme-01'));if(world.run.pending.category==='hostile')break;}world=E.choose(data,world,'fight');}
