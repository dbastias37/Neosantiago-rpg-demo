...
function normalizeCompanionCommitments(){
 ...
 if(ledger.version!==1||r!==null&&(!r||typeof r!=="object"||Array.isArray(r)))throw Error("Registro de acuerdos inválido");if(typeof normalizeNoaRoute==="function")normalizeNoaRoute();if(typeof normalizeEvidence==="function")normalizeEvidence();if(typeof normalizeVeraTrade==="function")normalizeVeraTrade();if(!r)return;
