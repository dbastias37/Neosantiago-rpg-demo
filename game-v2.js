...
function showGameIntro(step){
  ...
  introTypeTimer=setInterval(function(){
    ...
    if(document.hidden||!$("worldLoreModal").classList.contains("hidden")||!$("gameHelpModal").classList.contains("hidden"))return;
...
function enterTitleScreen(){
  ...
  title.classList.add("hidden");title.classList.remove("leaving");$("start").classList.remove("hidden");(!$("continueGame").classList.contains("hidden")?$("continueGame"):$("newGame")).focus()
}
function newGame(){
