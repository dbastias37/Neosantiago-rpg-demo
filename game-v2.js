...
var state=fresh(),pending=null,battleState=null,transferDraft=null,discardDraft=null,toastTimer=null,lootInterval=null,archiveOpener=null,worldLoreOpener=null,introStep=0,profileTab="inventory";
...
function closeProfile(){closeTransferModal();closeDiscardModal();$('profileModal').classList.add('hidden');if(state.refuge.active)renderRefuge()}
